...
import { t } from "./shield-check-DyBVQKTu.js";
import { t as n } from "./shield-off-BftSXi-0.js";
import { ct as r } from "./index-CMlkpObp.js";
var i = e();
function a({ viewTarget: e, setViewTarget: a, handleToggleBan: o }) {
  return (0, i.jsx)(`div`, {
      ...
      children: [
        (0, i.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, i.jsx)(`button`, {
              ...
              children: (0, i.jsx)(r, { className: `h-5 w-5` }),
            }),
          ],
        }),
        (0, i.jsxs)(`div`, {
              ...
              children: [
                e.avatarUrl
                  ...
                  : (0, i.jsx)(`div`, {
                      ...
                      children: (e.displayName ?? `J`).slice(0, 2).toUpperCase(),
                    }),
                (0, i.jsxs)(`div`, {
                  children: [
                    (0, i.jsx)(`h4`, {
                      className: `text-lg font-bold text-slate-900`,
                      children: e.displayName ?? `Unnamed Journalist`,
                    }),
                    (0, i.jsx)(`p`, { className: `text-sm text-slate-500`, children: e.email }),
                    (0, i.jsx)(`span`, {
                      className: `mt-2 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-semibold ${e.active ? `bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200` : `bg-red-50 text-red-700 ring-1 ring-red-200`}`,
                      children: e.active ? `Active Partner` : `Suspended`,
                    }),
                  ],
                }),
              ],
              ...
              children: [
                (0, i.jsxs)(`div`, {
                  children: [
                    ...
                    (0, i.jsx)(`code`, {
                      ...
                      children: e.journalistId || `Not assigned`,
                    }),
                  ],
                }),
                (0, i.jsxs)(`div`, {
                ...
                (0, i.jsxs)(`div`, {
                  children: [
                    ...
                    (0, i.jsxs)(`span`, {
                      className: `mt-1 block text-slate-700 font-medium`,
                      children: [e.articlesPublished, ` articles`],
                    }),
                  ],
                }),
                (0, i.jsxs)(`div`, {
        ...
        (0, i.jsxs)(`div`, {
          ...
          children: [
            (0, i.jsx)(`button`, {
              onClick: () => o(e),
              className: `inline-flex items-center gap-1.5 rounded-lg border px-3.5 py-1.5 text-xs font-semibold transition-colors ${e.active ? `border-amber-200 bg-amber-50 text-amber-800 hover:bg-amber-100` : `border-emerald-200 bg-emerald-50 text-emerald-800 hover:bg-emerald-100`}`,
              children: e.active
                ? (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)(n, { className: `h-4 w-4 text-amber-600` }),
                      ` Suspend Account`,
                    ],
                  })
                : (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)(t, { className: `h-4 w-4 text-emerald-600` }),
                      ` Activate Account`,
                    ],
                  }),
            }),
...
export { a as JournalistProfileModal };
