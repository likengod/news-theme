...
import { t as i } from "./react-dom-OZoo14Og.js";
import { t as a } from "./invariant-DEEwAagU.js";
import { n as o, r as s } from "./utils-DBC8gD4z.js";
import { t as c } from "./useRouter-qlf10565.js";
function l(e) {
  return e[e.length - 1];
}
function u(e) {
...
function m(e) {
  for (let t in e) if (f.call(e, t)) return !0;
  return !1;
}
...
function v(e) {
  ...
  for (let n of t) if (!p.call(e, n)) return !1;
...
function S(e, t, n) {
  ...
  if (Array.isArray(e) && Array.isArray(t)) {
    ...
    for (let r = 0, i = e.length; r < i; r++) if (!S(e[r], t[r], n)) return !1;
    return !0;
  }
  if (y(e) && y(t)) {
    let r = n?.ignoreUndefined ?? !0;
    if (n?.partial) {
      for (let i in t) if ((!r || t[i] !== void 0) && !S(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t) if ((!r || t[o] !== void 0) && (a++, a > i || !S(e[o], t[o], n))) return !1;
    return i === a;
  }
  return !1;
}
...
function te(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    r = ``,
    i;
  for (; (i = t.exec(e)) !== null; ) ((r += D(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += D(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function P(e, t, n, r, i, a, o) {
      ...
      switch (((s = d + 1), a++, e[0])) {
        ...
        case 1: {
          ...
          if (h) o = h;
            ...
            let e = L(1, n.fullPath ?? n.from, f, p, m);
        ...
        case 3: {
          ...
          if (h) o = h;
            ...
            let e = L(3, n.fullPath ?? n.from, f, p, m);
  ...
  if (n.children) for (let r of n.children) P(e, t, r, s, i, a, o);
}
function se(e, t) {
...
function R(e, t) {
  let n = I(`/`),
    r = new Uint16Array(6);
  for (let t of e) P(!1, r, t, 1, n, 0);
  (F(n), (t.masksTree = n), (t.flatCache = M(1e3)));
}
function z(e, t) {
  e ||= `/`;
...
function ce(e, t, n, r, i) {
  ...
  return (
    o || ((o = I(`/`)), P(t, new Uint16Array(6), { from: e }, 1, o, 0), i.singleCache.set(a, o)),
    H(r, o, n)
  );
}
function le(e, t, n = !1) {
...
function de(e, t, n, r) {
  ...
  for (; s.length; ) {
    let n = s.pop(),
      { node: i, index: l, skipped: d, depth: f, statics: p, dynamics: m, optionals: h } = n,
    ...
    r && i.route && i.kind !== N && q(c, n) && (c = n);
    let v = l === o;
    if (
      v &&
      (i.route && (!a || i.kind === N || i.kind === 2) && q(u, n) && (u = n),
    ...
    if (i.wildcard)
      for (let e = i.wildcard.length - 1; e >= 0; e--) {
        ...
        if (!(r && (v || !(n.caseSensitive ? y : (b ??= y.toLowerCase())).startsWith(r)))) {
          if (a) {
            if (v) continue;
            let e = t.slice(l).join(`/`).slice(-a.length);
...
function _e({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  ...
  if (a) s = e.split(`/`);
    ...
    for (s = e.split(`/`); s.length > 1 && l(s) === ``; ) s.pop();
    let n = t.split(`/`);
  ...
  s.length > 1 && (l(s) === `` ? n === `never` && s.pop() : n === `always` && s.push(``));
  let c = Y(s.join(`/`)) || `/`;
...
function we({ children: e, fallback: t = null }) {
  return Te() ? (0, Ce.jsx)(Z.Fragment, { children: e }) : (0, Ce.jsx)(Z.Fragment, { children: t });
}
function Te() {
...
function Me(e, t, n = je) {
  ...
  return (0, Ae.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
var Ne = t(i(), 1);
function Pe(e, t) {
  let n = c(),
    ...
    ce = z.maskedLocation ? z.maskedLocation.publicHref : z.publicHref,
    le = z.maskedLocation ? z.maskedLocation.external : z.external,
    B = Z.useMemo(() => Ve(ce, le, n.history, C), [C, le, ce, n.history]),
    V = Z.useMemo(() => {
      if (B?.external) return ee(B.href, n.protocolAllowlist) ? void 0 : B.href;
      if (!He(u) && !(typeof u != `string` || u.indexOf(`:`) === -1))
        try {
          return (new URL(u), ee(u, n.protocolAllowlist) ? void 0 : u);
        } catch {}
    }, [u, B, n.protocolAllowlist]),
    H = Z.useMemo(() => {
      if (V) return !1;
      if (l?.exact) {
        if (!ge(R.pathname, z.pathname, n.basepath)) return !1;
      } else {
        let e = he(R.pathname, n.basepath),
          t = he(z.pathname, n.basepath);
        if (!(e.startsWith(t) && (e.length === t.length || e[t.length] === `/`))) return !1;
      }
      return (l?.includeSearch ?? !0) &&
        !S(R.search, z.search, { partial: !l?.exact, ignoreUndefined: !l?.explicitUndefined })
        ? !1
        : l?.includeHash
          ? I && R.hash === z.hash
          : !0;
    ...
    U = H ? (d(i, {}) ?? Ie) : Fe,
    W = H ? Fe : (d(a, {}) ?? Fe),
    ue = [T, U.className, W.className].filter(Boolean).join(` `),
    de = (w || U.style || W.style) && { ...w, ...U.style, ...W.style },
    [G, fe] = Z.useState(!1),
    K = Z.useRef(!1),
    q = e.reloadDocument || V ? !1 : (f ?? n.options.defaultPreload),
    J = p ?? n.options.defaultPreloadDelay ?? 0,
    Y = Z.useCallback(() => {
  ...
  (s(
    ...
    Be,
    { disabled: !!C || q !== `viewport` },
  ),
    Z.useEffect(() => {
      K.current || (!C && q === `render` && (Y(), (K.current = !0)));
    }, [C, Y, q]));
  let pe = (e) => {
    let t = e.currentTarget.getAttribute(`target`),
      r = x === void 0 ? t : x;
    if (!C && !We(e) && !e.defaultPrevented && (!r || r === `_self`) && e.button === 0) {
      (e.preventDefault(),
        (0, Ne.flushSync)(() => {
          fe(!0);
        }));
...
var Fe = {},
  ...
  ze = { "data-transitioning": `transitioning` },
  Q = new WeakMap(),
  Be = { rootMargin: `100px` },
  $ = (e) => (t) => {
    for (let n of e)
