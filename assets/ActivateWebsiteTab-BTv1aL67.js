...
import { t as s } from "./shield-alert-nwcqNZiD.js";
import { Bt as c, Ct as l, ct as u } from "./index-CMlkpObp.js";
import { t as d } from "./SettingsHelpers-nrY-Ajj-.js";
var f = r(`key`, [
    [
      `path`,
  ...
  m = e(n()),
  h = t();
function g({ isOpen: e, onClose: t }) {
  let [n, r] = (0, m.useState)(!1);
  return (
    (0, m.useEffect)(() => {
      try {
        let e = Intl.DateTimeFormat().resolvedOptions().timeZone;
        r(e === `Asia/Kolkata` || e === `Asia/Calcutta`);
      } catch {}
    }, []),
    e
      ? (0, h.jsx)(`div`, {
          ...
          children: (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`button`, {
                ...
                children: (0, h.jsx)(a, { className: `h-6 w-6` }),
              }),
              (0, h.jsxs)(`div`, {
                      ...
                      (0, h.jsxs)(`ul`, {
                        ...
                        children: [
                          (0, h.jsxs)(`li`, {
                            ...
                            children: [
                              (0, h.jsx)(l, { className: `h-5 w-5 shrink-0 text-emerald-500` }),
                              (0, h.jsx)(`span`, {
                          ...
                          (0, h.jsxs)(`li`, {
                            ...
                            children: [
                              (0, h.jsx)(u, { className: `h-5 w-5 shrink-0 text-slate-400` }),
                              (0, h.jsx)(`span`, {
                      ...
                      (0, h.jsxs)(`ul`, {
                        ...
                        children: [
                          (0, h.jsxs)(`li`, {
                            className: `flex items-start gap-3`,
                            children: [
                              (0, h.jsx)(l, { className: `h-5 w-5 shrink-0 text-emerald-400` }),
                              (0, h.jsx)(`span`, {
                          ...
                          (0, h.jsxs)(`li`, {
                            className: `flex items-start gap-3 opacity-50`,
                            children: [
                              (0, h.jsx)(u, { className: `h-5 w-5 shrink-0 text-slate-500` }),
                              (0, h.jsx)(`span`, {
...
function _({ s: e, update: t }) {
  let [n, r] = (0, m.useState)(e.licenseKey || ``),
    [a, l] = (0, m.useState)(!1),
    [u, _] = (0, m.useState)(!1),
    v = e.licenseKey && e.licenseKey.length > 10;
  return (0, h.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      v
        ? (0, h.jsxs)(`div`, {
            className: `rounded-xl border border-slate-200 bg-white shadow-sm px-6 py-6 flex flex-col xl:flex-row xl:items-center justify-between gap-6`,
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  (0, h.jsx)(`h3`, {
                    ...
                    children: `Software Activation`,
                  }),
                  (0, h.jsx)(`p`, {
                    className: `mt-1.5 text-sm text-slate-500`,
                    children: `Enter your license key to activate your website and unlock premium features or support.`,
                  }),
                ],
              }),
              (0, h.jsx)(`div`, {
                ...
                children: (0, h.jsxs)(`div`, {
                  className: `rounded-lg border border-emerald-200 bg-emerald-50 px-5 py-3.5 flex flex-wrap w-full xl:w-auto items-center justify-between gap-4 shadow-sm`,
                  children: [
                    (0, h.jsxs)(`div`, {
                      className: `flex items-center gap-3`,
                      children: [
                        (0, h.jsx)(i, { className: `h-5 w-5 text-emerald-600 shrink-0` }),
                        (0, h.jsxs)(`div`, {
                          className: `text-sm text-emerald-800 flex flex-wrap items-center gap-2`,
                          children: [
                            (0, h.jsx)(`strong`, {
                              className: `font-bold`,
                              children: `Website Activated`,
                            }),
                            (0, h.jsx)(`span`, {
                              className: `text-emerald-600 hidden sm:inline`,
                              children: ` — Your license key is valid.`,
                            }),
                            (e.licenseType || e.licenseRole) &&
                              (0, h.jsxs)(`div`, {
                                className: `flex items-center gap-1.5 ml-2`,
                                children: [
                                  e.licenseType &&
                                    (0, h.jsx)(`span`, {
                                      className: `rounded-full bg-emerald-200/50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-emerald-700`,
                                      children: e.licenseType,
                                    }),
                                  e.licenseRole &&
                                    (0, h.jsx)(`span`, {
                                      className: `rounded-full bg-emerald-700 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-emerald-50`,
                                      children: e.licenseRole,
                                    }),
                                ],
                              }),
                          ],
                    ...
                    (0, h.jsx)(`button`, {
                      onClick: () => {
                        (r(``), t(`licenseKey`, ``), t(`licenseType`, ``), t(`licenseRole`, ``));
                      },
              ...
              children: (0, h.jsxs)(`div`, {
                ...
                children: [
                              ...
                              (0, h.jsxs)(`button`, {
                                onClick: async () => {
                                  if (n.trim()) {
                                    ...
                                    try {
                                      let e = await fetch(
                                          `http://localhost:5173/api/license/verify`,
                                          {
                                            method: `POST`,
                                      ...
                                      try {
                                        ...
                                        throw Error(`Invalid response from license server`);
                                      }
                                      if (!e.ok) throw Error(r.error || `Failed to verify license`);
                                      if (r.success && r.license?.activated)
                                        (c.success(r.message || `License verified successfully`),
                                          t(`licenseKey`, n.trim()),
                                          r.license.licenseType &&
                                            t(`licenseType`, r.license.licenseType),
                                          r.license.role && t(`licenseRole`, r.license.role));
                                      else throw Error(r.error || r.message || `Invalid license`);
                                    } catch (e) {
                                      (c.error(e.message || `Could not connect to license server`),
                                        n.trim().startsWith(`DEMO-`) &&
                                          (c.success(`Demo mode activated locally.`),
                                          t(`licenseKey`, n.trim()),
                                          t(`licenseType`, `Demo`),
                                          t(`licenseRole`, `VIP`)));
                                    } finally {
                                ...
                                children: [
                                  u ? (0, h.jsx)(o, { className: `h-4 w-4 animate-spin` }) : null,
                                  u ? `Verifying...` : `Activate`,
                                ],
                              }),
                              (0, h.jsxs)(`button`, {
                                onClick: () => l(!0),
                                ...
                                children: [
                                  (0, h.jsx)(p, { className: `h-4 w-4 text-white` }),
                                  `Buy License`,
                                ],
                              }),
                            ],
                  ...
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsx)(s, { className: `h-5 w-5 text-amber-600 mt-0.5 shrink-0` }),
                      (0, h.jsxs)(`div`, {
                        children: [
                          (0, h.jsx)(`h4`, {
      ...
      (0, h.jsx)(g, { isOpen: a, onClose: () => l(!1) }),
    ],
  });
}
export { _ as ActivateWebsiteTab };
