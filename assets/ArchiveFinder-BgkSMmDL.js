...
import { Jt as t } from "./index-CMlkpObp.js";
var n = e();
function r() {
  let e = t();
      ...
      (0, n.jsxs)(`div`, {
        ...
        children: [
          (0, n.jsxs)(`select`, {
            ...
            children: [
              (0, n.jsx)(`option`, { value: ``, children: `Day` }),
              Array.from({ length: 31 }, (e, t) => t + 1).map((e) =>
                (0, n.jsx)(`option`, { value: String(e).padStart(2, `0`), children: e }, e),
              ),
            ],
          }),
          (0, n.jsxs)(`select`, {
            ...
            className: `w-full border border-border bg-background px-2 py-2 text-sm outline-none focus:border-foreground`,
            children: [
              (0, n.jsx)(`option`, { value: ``, children: `Month` }),
              [
                `Jan`,
                `Feb`,
                `Mar`,
                ...
                (0, n.jsx)(`option`, { value: String(t + 1).padStart(2, `0`), children: e }, e),
              ),
            ],
          }),
          (0, n.jsxs)(`select`, {
            ...
            className: `w-full border border-border bg-background px-2 py-2 text-sm outline-none focus:border-foreground`,
            children: [
              (0, n.jsx)(`option`, { value: ``, children: `Year` }),
              Array.from({ length: 16 }, (e, t) => 2026 - t).map((e) =>
                (0, n.jsx)(`option`, { value: String(e), children: e }, e),
              ),
            ],
          }),
        ],
