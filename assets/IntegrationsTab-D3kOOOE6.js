...
import { i as r, o as i, r as a, t as o } from "./SettingsHelpers-nrY-Ajj-.js";
var s = n(`git-branch`, [
      ...
      children: [
        (0, c.jsx)(o, {
          ...
          children: (0, c.jsx)(`div`, {
            className: `space-y-3`,
            children: l.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
          }),
        }),
        (0, c.jsx)(o, {
          title: `AI Providers`,
          ...
          children: (0, c.jsx)(`div`, {
            className: `space-y-3`,
            children: d.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
          }),
        }),
        (0, c.jsx)(o, {
          ...
          children: (0, c.jsx)(`div`, {
            ...
            children: m.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
          }),
        }),
        (0, c.jsxs)(o, {
          ...
          children: [
            (0, c.jsxs)(`div`, {
              ...
              children: [
                `Tip: choose the `,
                (0, c.jsx)(`strong`, { children: `HTML tag` }),
            ...
            (0, c.jsx)(`div`, {
              className: `grid gap-3 lg:grid-cols-2`,
              children: p.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
            }),
          ],
        }),
        (0, c.jsx)(o, {
          ...
          children: (0, c.jsx)(`div`, {
            className: `space-y-3`,
            children: u.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
          }),
        }),
        (0, c.jsx)(o, {
          ...
          children: (0, c.jsx)(`div`, {
            ...
            children: f.map((n) => (0, c.jsx)(r, { f: n, s: e, update: t }, n.key)),
          }),
        }),
        (0, c.jsxs)(o, {
          ...
          children: [
                ...
                (0, c.jsxs)(`div`, {
                  ...
                  children: [
                    (0, c.jsx)(`div`, {
                      ...
                      children: (0, c.jsx)(s, { className: `h-5 w-5 text-white` }),
                    }),
                    (0, c.jsxs)(`div`, {
                      children: [
                        (0, c.jsx)(`p`, {
              ...
              children: [
                (0, c.jsxs)(`div`, {
                  children: [
                    ...
                    (0, c.jsx)(`input`, {
                      value: e.gitRemoteUrl || `https://github.com/likengod/news-theme.git`,
                      placeholder: `https://github.com/likengod/news-theme.git`,
                      onChange: (e) => t(`gitRemoteUrl`, e.target.value),
                ...
                (0, c.jsxs)(`div`, {
                  children: [
                    ...
                    (0, c.jsx)(`input`, {
                      value: e.gitBranch || `main`,
                      placeholder: `main`,
                      onChange: (e) => t(`gitBranch`, e.target.value),
                ...
                (0, c.jsxs)(`div`, {
                  children: [
                    ...
                    (0, c.jsx)(`input`, {
                      type: `password`,
                      value: e.gitAccessToken || ``,
                      placeholder: `ghp_...`,
                      onChange: (e) => t(`gitAccessToken`, e.target.value),
                      className: `w-full rounded-md border border-slate-200 px-3 py-2 font-mono text-xs focus:border-slate-900 focus:outline-none`,
                      autoComplete: `off`,
                    }),
                    (0, c.jsx)(`p`, {
            ...
            (0, c.jsx)(i, {
              ...
              checked: e.gitAutoDeploy,
              onChange: (e) => t(`gitAutoDeploy`, e),
                  ...
                  children: [
                    (0, c.jsxs)(`li`, {
                      children: [
                        ...
                        (0, c.jsx)(`strong`, { children: `Save changes` }),
                        `.`,
                      ],
                    }),
                    (0, c.jsxs)(`li`, {
                    ...
                    (0, c.jsxs)(`li`, {
                      children: [
                        `Click `,
                        (0, c.jsx)(`strong`, { children: `Pull Latest` }),
                    ...
                    (0, c.jsxs)(`li`, {
                      children: [
                        `Click `,
                        (0, c.jsx)(`strong`, { children: `Build & Deploy` }),
                        ` to compile and deploy the production build.`,
                      ],
                    }),
                    (0, c.jsx)(`li`, {
                      children: `View deployment history and build logs right from the admin panel.`,
                    }),
                    (0, c.jsx)(`li`, {
                      children: `View deployment history and build logs right from the admin panel.`,
                    }),
