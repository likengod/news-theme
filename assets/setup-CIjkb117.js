...
import { t as o } from "./eye-off-BREVkIs3.js";
import { t as s } from "./eye-CvwOJwvW.js";
import { t as c } from "./shield-alert-nwcqNZiD.js";
import { Bt as l, C as u, Ct as d, S as f, ut as p } from "./index-CMlkpObp.js";
var m = i(`database`, [
...
function v() {
  let e = r(u),
    ...
    M = (e) => {
      k({ ...O, [e.target.name]: e.target.value });
    },
    N = (e) => {
      j({ ...A, [e.target.name]: e.target.value });
    };
  return (0, _.jsxs)(`div`, {
              ...
              children: (0, _.jsxs)(`div`, {
                ...
                children: [
                  (0, _.jsxs)(`div`, {
                    ...
                    children: [
                      (0, _.jsx)(`div`, {
                        className: `flex items-center justify-center h-8 w-8 rounded-full border ${n >= 1 ? `bg-amber-500 border-amber-500 text-slate-900` : `border-slate-600 text-slate-400`} font-bold text-sm`,
                        children: n > 1 ? (0, _.jsx)(d, { className: `h-4 w-4` }) : `1`,
                      }),
                      (0, _.jsx)(`span`, {
                  ...
                  (0, _.jsx)(`div`, { className: `flex-1 h-0.5 bg-slate-700 mx-4` }),
                  (0, _.jsxs)(`div`, {
                    className: `flex items-center`,
                    children: [
                      (0, _.jsx)(`div`, {
                        className: `flex items-center justify-center h-8 w-8 rounded-full border ${n >= 2 ? `bg-amber-500 border-amber-500 text-slate-900` : `border-slate-600 text-slate-400`} font-bold text-sm`,
                        children: n > 2 ? (0, _.jsx)(d, { className: `h-4 w-4` }) : `2`,
                      }),
                      (0, _.jsx)(`span`, {
                        className: `ml-2 text-sm font-medium text-slate-300`,
                  ...
                  (0, _.jsxs)(`div`, {
                    ...
                    children: [
                      (0, _.jsx)(`div`, {
                        className: `flex items-center justify-center h-8 w-8 rounded-full border ${n >= 3 ? `bg-amber-500 border-amber-500 text-slate-900` : `border-slate-600 text-slate-400`} font-bold text-sm`,
                        children: `3`,
                      }),
                      (0, _.jsx)(`span`, {
                        className: `ml-2 text-sm font-medium text-slate-300`,
                ...
                children: [
                  (0, _.jsxs)(`div`, {
                    children: [
                      (0, _.jsxs)(`h3`, {
                        ...
                        children: [
                          (0, _.jsx)(m, { className: `h-5 w-5 text-amber-500` }),
                          ` Connect Database`,
                        ],
                      }),
                      (0, _.jsx)(`p`, {
                  ...
                  (0, _.jsx)(`div`, {
                    ...
                    children: (0, _.jsx)(`button`, {
                      onClick: async () => {
                        if (!O.host || !O.port || !O.user || !O.database)
                          return l.error(`All database fields except password are required`);
                        y(!0);
                        try {
                          let t = await e({ data: O });
                          t.success
                            ? (l.success(`Database connected and verified successfully!`), i(2))
                            : l.error(t.error || `Connection failed. Double check credentials.`);
                        } catch (e) {
                          l.error(e.message || `Failed to query database server`);
                        } finally {
                          y(!1);
                        }
                      },
                      ...
                      children: v
                        ? (0, _.jsxs)(_.Fragment, {
                            children: [
                              (0, _.jsx)(a, { className: `h-4 w-4 animate-spin` }),
                              ` Verifying Connection & Database...`,
                            ],
                          })
                        : (0, _.jsxs)(_.Fragment, {
                            children: [
                              (0, _.jsx)(h, { className: `h-4 w-4` }),
                              ` Next: Test Connection & Proceed`,
                            ],
                          }),
                    }),
                  }),
                ...
                children: [
                  (0, _.jsxs)(`div`, {
                    children: [
                      (0, _.jsxs)(`h3`, {
                        className: `text-lg font-medium text-white flex items-center gap-2`,
                        children: [
                          (0, _.jsx)(p, { className: `h-5 w-5 text-amber-500` }),
                  ...
                  (0, _.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, _.jsx)(`button`, {
                        onClick: () => {
                          if (!A.displayName || !A.email || !A.password)
                            return l.error(`All administrator fields are required`);
                          if (A.password.length < 8)
                            return l.error(`Password must be at least 8 characters`);
                          if (A.password !== A.confirmPassword)
                            return l.error(`Passwords do not match`);
                          i(3);
                        },
                  ...
                  (0, _.jsxs)(`div`, {
                    children: [
                      (0, _.jsxs)(`h3`, {
                        className: `text-lg font-medium text-white flex items-center gap-2`,
                        children: [
                          (0, _.jsx)(c, { className: `h-5 w-5 text-amber-500` }),
                          ` Review & Install`,
                        ],
                      }),
                      (0, _.jsx)(`p`, {
                    ...
                    children: [
                      (0, _.jsxs)(`div`, {
                        children: [
                          ...
                          (0, _.jsxs)(`span`, {
                            className: `font-mono`,
                            children: [O.user, `@`, O.host, `:`, O.port, `/`, O.database],
                          }),
                        ],
                      }),
                      (0, _.jsxs)(`div`, {
                        children: [
                          ...
                          (0, _.jsx)(`span`, { className: `font-mono`, children: A.email }),
                        ],
                      }),
                      (0, _.jsxs)(`div`, {
                        children: [
                          ...
                          (0, _.jsx)(`span`, { children: A.displayName }),
                        ],
                      }),
                    ],
                  }),
                    ...
                    children: [
                      ...
                      (0, _.jsx)(`button`, {
                        onClick: async () => {
                          ...
                          x(!0);
                          try {
                            let e = await t({ data: { dbConfig: O, adminConfig: A } });
                            e.success
                              ? (l.success(`System installed successfully! Please log in.`),
                                setTimeout(() => {
                                  window.location.assign(`/auth`);
                                }, 1500))
                              : l.error(e.error || `Setup failed. Check database server.`);
                          } catch (e) {
                            l.error(e.message || `Unexpected setup error`);
                          } finally {
                            x(!1);
                          }
                        },
