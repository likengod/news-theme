...
import { t as i } from "./badge-check-YFvADS2B.js";
import { t as a } from "./circle-x-CvXoGSL4.js";
import { t as o } from "./loader-circle-3QDpCwJC.js";
import { t as s } from "./shield-check-DyBVQKTu.js";
import { t as c } from "./shield-off-BftSXi-0.js";
import { ft as l, ut as u, w as d } from "./index-CMlkpObp.js";
import { i as f } from "./journalist.functions-dwNZ1_v5.js";
import { n as p } from "./authorized-settings-DRMlDTKP.js";
var m = e(n()),
  h = t(),
  g = {
...
function _() {
  let e = r(f),
    [t, n] = (0, m.useState)(``),
    [i, c] = (0, m.useState)(!1),
    [u, p] = (0, m.useState)(null),
    [g, _] = (0, m.useState)(null),
    [y, b] = (0, m.useState)(!1),
    x = async (t) => {
      let n = t.trim();
      if (n) {
        (_(null), p(null), b(!1), c(!0));
        try {
          let t = await e({ data: { publicUserId: n } });
          t.found === !1 ? b(!0) : p(t);
        } catch (e) {
          _(e?.message ?? `Lookup failed`);
        } finally {
          c(!1);
        }
      }
        ...
        (0, h.jsxs)(`section`, {
          ...
          children: [
            (0, h.jsxs)(`span`, {
              ...
              children: [(0, h.jsx)(s, { className: `h-3.5 w-3.5` }), ` Trust Center`],
            }),
            (0, h.jsx)(`h1`, {
            ...
            (0, h.jsxs)(`p`, {
              ...
              children: [
                `Enter a reporter's `,
                (0, h.jsx)(`strong`, { children: `Journalist ID` }),
                ` (e.g. `,
                (0, h.jsx)(`code`, {
                ...
                `) or their 10-digit `,
                (0, h.jsx)(`strong`, { children: `User ID` }),
                ...
                (0, h.jsxs)(`div`, {
                  ...
                  children: [
                    (0, h.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, h.jsx)(`input`, {
                          ...
                          value: t,
                          onChange: (e) =>
                            n(e.target.value.replace(/[^A-Za-z0-9]/g, ``).slice(0, 16)),
                    ...
                    (0, h.jsxs)(`button`, {
                      ...
                      children: [
                        i
                          ? (0, h.jsx)(o, { className: `h-4 w-4 animate-spin` })
                          : (0, h.jsx)(s, { className: `h-4 w-4` }),
                        `Verify`,
                      ],
                    }),
                  ],
              ...
              children: [
                g &&
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsx)(a, { className: `mt-0.5 h-4 w-4 shrink-0` }),
                      (0, h.jsx)(`span`, { children: g }),
                    ],
                  }),
                y &&
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsx)(a, { className: `mx-auto h-8 w-8 text-amber-600` }),
                      (0, h.jsx)(`p`, {
...
function v({ data: e }) {
  let [t, n] = (0, m.useState)(p());
  ((0, m.useEffect)(() => {
    n(p());
  }, []),
    e.active);
  let r = g[e.role] ?? `Journalist`,
    a = (e.displayName ?? `News Theme Reporter`).toUpperCase(),
    o = !e.active,
    s = new Date(
      new Date(e.memberSince).getTime() + 3 * 365 * 24 * 60 * 60 * 1e3,
    ).toLocaleDateString(void 0, { day: `2-digit`, month: `short`, year: `numeric` }),
    l = o ? `SUSPENDED` : e.validTill || s;
  if (!e.verified)
    return (0, h.jsxs)(`div`, {
      className: `flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-5 shadow-sm`,
      children: [
        (0, h.jsx)(u, { className: `mt-0.5 h-5 w-5 shrink-0 text-slate-500` }),
        (0, h.jsxs)(`div`, {
          children: [
            (0, h.jsxs)(`p`, {
              className: `font-semibold text-slate-900`,
              children: [e.displayName ?? `This account`, ` is not an accredited journalist`],
            }),
            (0, h.jsxs)(`p`, {
              ...
              children: [
                ...
                ` `,
                (0, h.jsx)(`span`, { className: `font-medium`, children: r }),
  ...
  let d = e.journalistId ?? `NT-${e.publicUserId}`,
    f = typeof window < `u` ? window.location.origin : `https://northeasttimeline.com`,
    _ = `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(`${f}/verified-journalist?id=${d}`)}`;
  return (0, h.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`div`, {
                ...
                children: (0, h.jsx)(i, { className: `h-4.5 w-4.5 text-[#34c759]` }),
              }),
              (0, h.jsxs)(`p`, {
                className: `text-[10px] font-extrabold leading-tight tracking-wide text-white`,
                children: [
                  (0, h.jsx)(`span`, { className: `text-red-300`, children: `NORTHEAST` }),
                  (0, h.jsx)(`br`, {}),
                  `TIMELINE`,
                ],
              }),
          ...
          (0, h.jsx)(`div`, {
            ...
            children: e.avatarUrl
              ? (0, h.jsx)(`img`, {
                  src: e.avatarUrl,
                  alt: `Official press photo of accredited journalist ${a}`,
                  loading: `eager`,
                  fetchPriority: `high`,
                  decoding: `async`,
                ...
                children: [
                  ...
                  o
                    ? (0, h.jsxs)(`span`, {
                        ...
                        children: [
                          (0, h.jsx)(c, { className: `h-3.5 w-3.5 text-red-600` }),
                          ` Suspended`,
                        ],
                      })
                    : (0, h.jsxs)(`span`, {
                        ...
                        children: [
                          (0, h.jsx)(i, { className: `h-3.5 w-3.5 text-[#34c759]` }),
                          ` Verified`,
                        ],
                      }),
                ],
                ...
                children: [
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, h.jsx)(`div`, {
                        className: `mx-1 self-stretch border-l border-dashed border-red-400`,
                      }),
                      (0, h.jsxs)(`div`, {
                        className: `py-1 text-center`,
                        children: [
                  ...
                  (0, h.jsx)(`div`, { className: `border-t border-dashed border-red-400` }),
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, h.jsx)(`p`, {
                            className: `text-[8px] font-bold ${o ? `text-red-600 font-black uppercase` : `text-slate-600`}`,
                            children: l,
                          }),
                        ],
                      }),
                      (0, h.jsx)(`div`, {
                        className: `mx-0.5 self-stretch border-l border-dashed border-red-400`,
                      }),
                      (0, h.jsxs)(`div`, {
                        className: `py-1 text-center`,
                        children: [
                  ...
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (() => {
                        let n = e.address || t.officeAddress,
                          r = e.state || t.officeState || `Tripura`,
                          i = e.country || t.officeCountry || `India`,
                          a = e.pinCode || t.officePin,
                          o = [];
                        (n && o.push(n), r && o.push(r), i && o.push(i));
                        let s = `${o.join(`, `)}${a ? ` - ${a}` : ``}`,
                          c = `text-[8px] leading-tight`;
                        return (
                          s.length > 65
                            ? (c = `text-[7px] leading-none line-clamp-2`)
                            : s.length > 40 && (c = `text-[7.5px] leading-tight line-clamp-2`),
                          (0, h.jsx)(`p`, {
                            className: `mx-auto max-w-[215px] font-medium text-slate-700 ${c}`,
                            children: s,
                          })
                        );
                      })(),
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  (0, h.jsx)(`p`, { className: `text-red-600`, children: `Scan QR Code` }),
                  (0, h.jsx)(`p`, {
              ...
              (0, h.jsx)(`img`, {
                src: _,
                alt: `QR Code for verifying journalist ${a}`,
                loading: `eager`,
                decoding: `async`,
        ...
        children: [
                ...
                children: [
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, h.jsx)(`p`, {
                        className: `mt-0.5 truncate text-slate-600 ${(t.officePhone || e.phone || ``).length > 15 ? `text-[8.5px]` : `text-[10px]`}`,
                        children: t.officePhone || e.phone || `—`,
                      }),
                    ],
                  }),
                  (0, h.jsx)(`div`, {
                    className: `mx-1 self-stretch border-l border-dashed border-red-300`,
                  }),
                  (0, h.jsxs)(`div`, {
                    className: `py-1 text-center px-1`,
                    children: [
                      ...
                      (0, h.jsx)(`p`, {
                        className: `mt-0.5 truncate text-slate-600 ${(t.officeEmail || e.email || ``).length > 22 ? `text-[8.5px]` : `text-[10px]`}`,
                        children: t.officeEmail || e.email || `—`,
                      }),
                    ],
                  }),
                ],
              }),
              (0, h.jsx)(`div`, { className: `border-t border-dashed border-red-300` }),
              (0, h.jsxs)(`div`, {
                className: `grid grid-cols-[1fr_auto_1fr] items-center`,
                children: [
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, h.jsx)(`p`, {
                        className: `mt-0.5 truncate text-slate-600 ${(t.officeWebsite || `northeasttimeline.com`).length > 22 ? `text-[8.5px]` : `text-[10px]`}`,
                        children: t.officeWebsite || `northeasttimeline.com`,
                      }),
                    ],
                  }),
                  (0, h.jsx)(`div`, {
                  ...
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (() => {
                        let n = t.officeAddress || e.address || `College Road, Kailasahar`,
                          r = `text-[10px] leading-tight`;
                        return (
                          n.length > 50
                            ? (r = `text-[8px] leading-none line-clamp-2`)
                            : n.length > 25 && (r = `text-[8.5px] leading-tight line-clamp-2`),
                          (0, h.jsx)(`p`, { className: `mt-0.5 text-slate-600 ${r}`, children: n })
                        );
                      })(),
                    ],
                  }),
                ...
                children: [
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (() => {
                        let n = `${t.officeState || e.state || `Tripura`}, ${t.officeCountry || e.country || `India`}`;
                        return (0, h.jsx)(`p`, {
                          className: `mt-0.5 truncate text-slate-600 ${n.length > 20 ? `text-[8.5px]` : `text-[10px]`}`,
                          children: n,
                        });
                      })(),
                    ],
                  ...
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, h.jsx)(`p`, {
                        ...
                        children: t.officePin || e.pinCode || `799277`,
                      }),
                    ],
                  }),
                ],
          ...
          (() => {
            let e =
              ...
              n = t.cardDisclaimer || `Tampering or misuse of this card is a punishable offense.`,
              r = e.length + n.length,
              i = (e.match(/\n/g) || []).length + (n.match(/\n/g) || []).length,
              a = `text-[10px] leading-snug`;
            return (
              r > 220 || i >= 4
                ? (a = `text-[8px] leading-tight`)
                : (r > 140 || i >= 2) && (a = `text-[9px] leading-tight`),
              (0, h.jsxs)(`div`, {
                className: `px-5 pb-3 text-slate-600 ${a}`,
                children: [
                  (0, h.jsxs)(`p`, {
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`div`, { className: `mx-5 border-t-2 border-dashed border-red-500` }),
              (0, h.jsxs)(`div`, {
                className: `flex items-end justify-between px-5 pt-2 pb-2`,
                children: [
                  (0, h.jsx)(`img`, {
                    src: _,
                    alt: `Official verification QR code for journalist ${a}`,
                    loading: `lazy`,
                    decoding: `async`,
                    ...
                    children: [
                      t.signatureImageUrl
                        ? (0, h.jsx)(`img`, {
                            ...
                            alt: `Official authorized signature of ${t.signatureName || `Editor-in-Chief`}`,
                            loading: `lazy`,
                            decoding: `async`,
                        ...
                        : (0, h.jsx)(`p`, {
                            ...
                            children: t.signatureName || `Editor-in-Chief`,
                          }),
                      (0, h.jsx)(`div`, { className: `w-36 border-b border-slate-400` }),
                      (0, h.jsx)(`p`, {
                        className: `mt-1 text-[10px] font-black uppercase italic tracking-[0.16em] text-slate-900`,
                        children: t.signatureLabel || `AUTHORIZED SIGNATURE`,
                      }),
                    ],
                  }),
                ],
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsx)(`div`, { className: `flex-1 bg-red-600` }),
              (0, h.jsx)(`div`, { className: `flex-1 bg-[#1a2040]` }),
            ],
          }),
        ],
      }),
