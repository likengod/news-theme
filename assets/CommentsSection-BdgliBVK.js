...
import { i as a } from "./user-actions-tracker-_AV6ylmf.js";
import { t as o } from "./loader-circle-3QDpCwJC.js";
import { t as s } from "./message-square-DqTG6Ona.js";
import { Bt as c, q as l } from "./index-CMlkpObp.js";
import { i as u, r as d } from "./comments.functions-DXqNARpy.js";
var f = i(`calendar`, [
...
function y(e) {
  ...
  for (let e of t) {
    let t = e.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, ``);
    if (t && ((n[t] = (n[t] || 0) + 1), n[t] > 5)) return !0;
  }
  return !1;
}
function b({ articleSlug: e, articleTitle: t }) {
  let n = r(d),
    i = r(u),
    [_, b] = (0, p.useState)([]),
    [x, S] = (0, p.useState)(!0),
    ...
    [k, A] = (0, p.useState)(``),
    [j, M] = (0, p.useState)(!1),
    [N, P] = (0, p.useState)(null);
  (0, p.useEffect)(() => {
    l.auth.getSession().then(({ data: e }) => {
      e.session?.user && P(e.session.user.id);
    });
  }, []);
  let F = async () => {
    try {
      ...
      children: [
        (0, m.jsxs)(`div`, {
          ...
          children: [
            (0, m.jsxs)(`h3`, {
              ...
              children: [(0, m.jsx)(s, { className: `h-5 w-5` }), `Comments (`, _.length, `)`],
            }),
            (0, m.jsx)(`button`, {
              type: `button`,
              onClick: () => w((e) => !e),
              ...
              children: C ? `Cancel` : `Post Comment`,
            }),
          ],
        }),
        C &&
          (0, m.jsxs)(`form`, {
            onSubmit: async (n) => {
              ...
              let r = k.trim(),
                ...
                s = D.trim();
              if (!r || !o || !s) {
                c.error(`Please fill in all fields (Name, Email, and Comment).`);
                return;
              }
              if (v(r)) {
                c(
                  `YOU CAN'T POST THIS COMMENT, BECAUSE OUR ${h.toUpperCase()} DISABLED THIS FEATURE TO PROTECT FOR SCAMER SPAM AND PROMOTION.`,
                );
                return;
              }
              if (r.length < g) {
                c(
                  `Please ${o}, your comment is too short — it must be at least ${g} characters (currently ${r.length} characters).`,
                );
                return;
              }
              if (y(r)) {
                c(
                  `Please ${o}, your comment has been flagged. A single word cannot be repeated more than 5 times. Please submit a genuine comment.`,
                );
                return;
              }
              try {
                (M(!0),
                  await i({
                    data: { articleSlug: e, articleTitle: t, name: o, email: s, body: r },
                  }),
                  N && a(N, e),
                  c.success(
                ...
                c.error(e.message || `Failed to submit comment`);
              } finally {
                M(!1);
              }
            },
              ...
              (0, m.jsxs)(`div`, {
                ...
                children: [
                  (0, m.jsxs)(`span`, {
                    ...
                    children: [k.length, `/`, g, ` min characters (`, k.length, ` total)`],
                  }),
                  (0, m.jsxs)(`button`, {
                    type: `submit`,
                    disabled: j || !k.trim() || !T.trim() || !D.trim(),
                    ...
                    children: [
                      j && (0, m.jsx)(o, { className: `h-3 w-3 animate-spin` }),
                      `Submit Comment`,
                    ],
                  }),
                ],
        ...
        x
          ? (0, m.jsxs)(`div`, {
              ...
              children: [
                (0, m.jsx)(o, { className: `h-5 w-5 animate-spin mr-2` }),
                (0, m.jsx)(`span`, { className: `text-sm`, children: `Loading comments...` }),
              ],
            })
          : (0, m.jsxs)(`ul`, {
                          ...
                          children: (0, m.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, m.jsxs)(`span`, {
                                ...
                                children: [
                                  (0, m.jsx)(f, { className: `h-3 w-3 inline` }),
                                  ` `,
                                  e.date,
                                ],
                              }),
...
export { b as CommentsSection, b as default };
