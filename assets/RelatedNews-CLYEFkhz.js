...
import { l as u, o as d, t as f, u as p } from "./news-data-D07Mj5gy.js";
var m = e(n()),
  h = t(),
  g = [
    {
    ...
    { title: `Nvidia's Blackwell Surge Pushes Hyperscaler Capex to $320B`, img: a, kicker: `Tech` },
    {
    ...
    { title: `ECB Holds but Lagarde Opens Door to a Spring Move`, img: l, kicker: `Policy` },
  ];
function _({ currentSlug: e }) {
  let t = (0, m.useMemo)(() => g.filter((t) => d(t.title) !== e).slice(0, 4), [e]);
...
export { _ as RelatedNews, _ as default };
