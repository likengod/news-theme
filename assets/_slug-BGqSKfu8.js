...
import { t as a } from "./share-2-BrzAs-U1.js";
import { P as o, o as s, ut as c, w as l } from "./index-CMlkpObp.js";
import { t as u } from "./Advertisement-CYVLG1YH.js";
import { t as d } from "./Views-CepayK_z.js";
import { t as f } from "./ArchiveFinder-BgkSMmDL.js";
var p = e(n()),
  m = t(),
  h = {
...
function y() {
  let e = s.useLoaderData(),
    t = s.useSearch().page || 1,
    [n, y] = (0, p.useState)(() => i()),
    [b, x] = (0, p.useState)(!1);
  if (
    ((0, p.useEffect)(() => {
    ...
    (0, p.useEffect)(() => {
      if (n.festiveThemeEnabled === !1 || !n.topBarWeatherCustomText) {
        x(!1);
        return;
      }
      let e = (Number(n.topBarSwapDelay) || 5) * 1e3,
        t = setInterval(() => {
          x((e) => !e);
        }, e);
      return () => clearInterval(t);
    }, [n.festiveThemeEnabled, n.topBarWeatherCustomText, n.topBarSwapDelay]),
    !e)
  )
    return (0, m.jsx)(`div`, {
  ...
  let { category: S, featured: C, list: w, latest: T, totalPages: E = 1 } = e,
    D =
      n.festiveCategoryTitleGradient && h[n.festiveCategoryTitleGradient]
        ? {
            backgroundImage: h[n.festiveCategoryTitleGradient],
            WebkitBackgroundClip: `text`,
            WebkitTextFillColor: `transparent`,
            backgroundClip: `text`,
            display: `inline-block`,
          }
        : n.festiveCategoryTitleColor
          ? { color: n.festiveCategoryTitleColor }
          : void 0,
    O = !!(n.festiveThemeEnabled !== !1 && b && n.topBarWeatherCustomText),
    k = v[n.customAlertAnimationStyle || `slide-up`] || v[`slide-up`],
    A = {
      ...D,
      ...(O && n.customAlertFontFamily
        ? { fontFamily: g[n.customAlertFontFamily] || g.inter }
        : {}),
    };
  return (0, m.jsxs)(`div`, {
    className: `min-h-screen bg-background text-foreground`,
    children: [
      (0, m.jsx)(`style`, { dangerouslySetInnerHTML: { __html: _ } }),
      (0, m.jsx)(o, {}),
      (0, m.jsxs)(`main`, {
            ...
            children: [
              (0, m.jsxs)(`nav`, {
                ...
                children: [
                  ...
                  (0, m.jsx)(`span`, { className: `mx-1`, children: `/` }),
                  (0, m.jsx)(`span`, {
              ...
              (0, m.jsx)(
                `h1`,
                {
                  className: `font-serif text-5xl font-bold md:text-6xl ${D ? `` : `text-foreground`}`,
                  style: { ...A, ...k },
                  children: O ? n.topBarWeatherCustomText : S.name,
                },
                `${b ? `custom` : `default`}-${n.customAlertAnimationStyle}`,
              ),
              (0, m.jsx)(`p`, {
                  ...
                  `article`,
                  {
                    ...
                    children: [
                      ...
                      (0, m.jsxs)(`div`, {
                        ...
                        children: [
                          e.kickers.map((e) =>
                            (0, m.jsx)(`span`, { className: `text-foreground`, children: e }, e),
                          ),
                          (0, m.jsxs)(`span`, {
                        ...
                        children: [
                          (0, m.jsxs)(`div`, {
                            ...
                            children: [
                              (0, m.jsxs)(`span`, {
                                ...
                                children: [
                                  (0, m.jsx)(c, { className: `h-3 w-3 shrink-0` }),
                                  (0, m.jsx)(`span`, {
                          ...
                          (0, m.jsxs)(`button`, {
                            ...
                            onClick: (t) => {
                              (t.preventDefault(),
                                navigator.share
                                  ? navigator.share({ title: e.title, url: `/news/${e.slug}` })
                                  : (navigator.clipboard.writeText(
                                      window.location.origin + `/news/${e.slug}`,
                                    ),
                                    alert(`Link copied!`)));
                            },
                            ...
                            children: [(0, m.jsx)(a, { className: `h-3 w-3` }), `Share`],
                          }),
                        ],
                      }),
                    ],
              ...
              children: [
                ...
                (0, m.jsxs)(`aside`, {
                  ...
                  children: [
                    ...
                    (0, m.jsx)(u, { slot: `ad3`, aspectRatio: `3/4` }),
                    (0, m.jsx)(f, {}),
                  ],
                }),
              ],
            ...
            (0, m.jsxs)(`div`, {
              ...
              children: [
                (0, m.jsx)(r, {
                  to: `/$slug`,
                  params: { slug: S.slug },
                  search: { page: Math.max(1, t - 1) },
                  className: `rounded border border-border px-3 py-1.5 text-xs font-semibold uppercase tracking-wider ${t <= 1 ? `pointer-events-none opacity-40` : `hover:bg-muted text-foreground`}`,
                  children: `Prev`,
                }),
                Array.from({ length: E }, (e, t) => t + 1).map((e) =>
                  (0, m.jsx)(
                    r,
                    {
                      ...
                      params: { slug: S.slug },
                      search: { page: e },
                      className: `rounded px-3.5 py-1.5 text-xs font-bold transition-colors ${t === e ? `bg-foreground text-background font-black shadow-sm` : `border border-border text-foreground hover:bg-muted`}`,
                      children: e,
                    },
                    e,
                  ),
                ...
                (0, m.jsx)(r, {
                  to: `/$slug`,
                  params: { slug: S.slug },
                  search: { page: Math.min(E, t + 1) },
                  className: `rounded border border-border px-3 py-1.5 text-xs font-semibold uppercase tracking-wider ${t >= E ? `pointer-events-none opacity-40` : `hover:bg-muted text-foreground`}`,
                  children: `Next`,
                }),
              ],
            }),
