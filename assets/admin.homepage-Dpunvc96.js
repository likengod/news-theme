...
import { t as i } from "./rotate-ccw-B1_KblCN.js";
import { t as a } from "./save-DCSXhHjW.js";
import { Bt as o, It as s, Lt as c, Pt as l, Rt as u, St as d, zt as f } from "./index-CMlkpObp.js";
import { t as p } from "./switch-BYa5gnRW.js";
import { t as m } from "./label-ZyRtWLj_.js";
var h = r(`settings-2`, [
  ...
  g = e(n()),
  _ = t();
function v({ label: e, hint: t, value: n, showCategory: r, onChange: i, children: a }) {
  let [o, s] = (0, g.useState)(!1),
    [c, u] = (0, g.useState)(n.title),
    [f, p] = (0, g.useState)(n.color),
    [m, v] = (0, g.useState)(n.fontSize);
  (0, g.useEffect)(() => {
    (u(n.title), p(n.color), v(n.fontSize));
  }, [n.title, n.color, n.fontSize]);
  let y = (e) => {
      (u(e), i({ ...n, title: e }));
    },
    b = (e) => {
    ...
    children: [
      (0, _.jsxs)(`div`, {
        ...
        children: [
          (0, _.jsxs)(`div`, {
            children: [
              (0, _.jsx)(`p`, { className: `text-sm font-semibold text-slate-900`, children: e }),
              t && (0, _.jsx)(`p`, { className: `text-[11px] text-slate-500`, children: t }),
            ],
          }),
          (0, _.jsx)(`div`, {
            className: `hidden max-w-[180px] truncate font-bold uppercase tracking-[0.15em] sm:block`,
            style: { color: f, fontSize: `${Math.min(m, 14)}px` },
            title: c,
            children: c || `—`,
          }),
        ],
              ...
              r &&
                (0, _.jsxs)(`label`, {
                  ...
                  children: [
                    ...
                    (0, _.jsx)(`select`, {
                      value: n.category ?? `Auto (Latest)`,
                      onChange: (e) => i({ ...n, category: e.target.value }),
                      className: `h-9 w-full rounded-md border border-slate-200 bg-white px-2 text-sm focus:border-slate-900 focus:outline-none`,
                      children: l.map((e) => (0, _.jsx)(`option`, { value: e, children: e }, e)),
                    }),
                  ],
                }),
            ],
          }),
          a && (0, _.jsx)(`div`, { className: `pt-2 border-t border-slate-100`, children: a }),
          (0, _.jsxs)(`button`, {
            type: `button`,
            onClick: () => s((e) => !e),
            ...
            children: [
              (0, _.jsx)(h, { className: `h-3.5 w-3.5` }),
              o ? `Hide` : `Change`,
              ` heading style`,
              (0, _.jsx)(d, { className: `h-3.5 w-3.5 transition ${o ? `rotate-180` : ``}` }),
            ],
          }),
          o &&
            (0, _.jsxs)(`div`, {
                ...
                (0, _.jsxs)(`label`, {
                  ...
                  children: [
                    ...
                    (0, _.jsx)(`input`, {
                      ...
                      max: 64,
                      value: m,
                      onChange: (e) => x(Number(e.target.value) || 12),
...
function y({ config: e, onUpdate: t }) {
  return (0, _.jsxs)(`div`, {
    className: `space-y-3`,
    children: [
      (0, _.jsx)(v, {
        ...
        value: e.heroFeatured,
        showCategory: !0,
        onChange: (e) => t(`heroFeatured`, e),
              ...
              children: [
                ...
                (0, _.jsxs)(`div`, {
                  ...
                  children: [
                    (0, _.jsx)(p, {
                      id: `show-multiple`,
                      checked: e.heroFeatured.showMultiple !== !1,
                      onCheckedChange: (n) =>
                        t(`heroFeatured`, { ...e.heroFeatured, showMultiple: n }),
                    }),
                    (0, _.jsx)(m, {
                    ...
                    children: [
                      ...
                      (0, _.jsxs)(`div`, {
                        ...
                        children: [
                          (0, _.jsx)(p, {
                            id: `auto-slide`,
                            checked: e.heroFeatured.autoSlide !== !1,
                            onCheckedChange: (n) =>
                              t(`heroFeatured`, { ...e.heroFeatured, autoSlide: n }),
                          }),
                          (0, _.jsx)(m, {
                            htmlFor: `auto-slide`,
                            className: `text-xs font-semibold text-slate-700 cursor-pointer`,
                  ...
                  (0, _.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, _.jsx)(`input`, {
                        ...
                        min: `2`,
                        max: `30`,
                        value: e.heroFeatured.slideInterval ?? 5,
                        onChange: (n) =>
                          t(`heroFeatured`, {
                            ...e.heroFeatured,
                            slideInterval: parseInt(n.target.value) || 5,
                          }),
                  ...
                  (0, _.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, _.jsx)(`input`, {
                        ...
                        min: `2`,
                        max: `10`,
                        value: e.heroFeatured.slideCount ?? 3,
                        onChange: (n) =>
                          t(`heroFeatured`, {
                            ...e.heroFeatured,
                            slideCount: parseInt(n.target.value) || 3,
                          }),
                        className: `h-8 w-24 rounded-md border border-slate-200 px-3 text-sm focus:border-slate-900 focus:outline-none`,
                      }),
                    ],
      ...
      (0, _.jsx)(v, {
        ...
        value: e.heroTopStories,
        showCategory: !0,
        onChange: (e) => t(`heroTopStories`, e),
      }),
      (0, _.jsx)(v, {
        label: `Culture & Music row`,
        hint: `Culture section under the main hero grid`,
        value: e.heroCultureMusic,
        showCategory: !0,
        onChange: (e) => t(`heroCultureMusic`, e),
      }),
      (0, _.jsx)(v, {
      ...
      (0, _.jsx)(v, {
        ...
        value: e.heroPopular,
        showCategory: !0,
        onChange: (e) => t(`heroPopular`, e),
      }),
    ],
  });
}
function b({ columns: e, onUpdateColumn: t }) {
  return (0, _.jsx)(`div`, {
    ...
    children: e.map((e, n) =>
      (0, _.jsx)(
        ...
        {
          label: `Column ${n + 1}`,
          hint: `News column ${n + 1} on homepage`,
          value: e,
          showCategory: !0,
          onChange: (e) => t(n, e),
        },
        ...
        children: [
          (0, _.jsxs)(`label`, {
            ...
            children: [
              ...
              (0, _.jsxs)(`select`, {
                value: e.provider,
                onChange: (n) => t({ ...e, provider: n.target.value }),
                className: `h-9 w-full rounded-md border border-slate-200 bg-white px-2 text-sm focus:border-slate-900 focus:outline-none`,
                children: [
                  (0, _.jsx)(`option`, { value: `youtube`, children: `YouTube` }),
                  (0, _.jsx)(`option`, { value: `facebook`, children: `Facebook` }),
                ],
              }),
            ],
          }),
        ...
        ? (0, _.jsxs)(`label`, {
            ...
            children: [
              ...
              (0, _.jsx)(`input`, {
                ...
                value: e.youtubeChannelId,
                onChange: (n) => t({ ...e, youtubeChannelId: n.target.value }),
                className: `h-9 w-full rounded-md border border-slate-200 px-3 text-sm focus:border-slate-900 focus:outline-none`,
              }),
              (0, _.jsxs)(`span`, {
                className: `mt-1 block text-[11px] text-slate-500`,
                children: [
                  `From your YouTube Channel URL: youtube.com/channel/`,
                  (0, _.jsx)(`b`, { children: `UC…` }),
                ],
              }),
            ],
          })
        : (0, _.jsxs)(`label`, {
            ...
            children: [
              ...
              (0, _.jsx)(`input`, {
                ...
                value: e.facebookPageUrl,
                onChange: (n) => t({ ...e, facebookPageUrl: n.target.value }),
                className: `h-9 w-full rounded-md border border-slate-200 px-3 text-sm focus:border-slate-900 focus:outline-none`,
              }),
            ],
          }),
...
function S({ title: e, description: t, defaultOpen: n = !0, children: r }) {
  let [i, a] = (0, g.useState)(n);
    ...
    children: [
      (0, _.jsxs)(`button`, {
        ...
        children: [
          (0, _.jsxs)(`div`, {
            children: [
              (0, _.jsx)(`h2`, { className: `text-sm font-semibold text-slate-900`, children: e }),
              t && (0, _.jsx)(`p`, { className: `text-[11px] text-slate-500`, children: t }),
            ],
          }),
          (0, _.jsx)(d, {
            className: `h-4 w-4 text-slate-500 transition ${i ? `rotate-180` : ``}`,
          }),
        ],
      }),
      i && (0, _.jsx)(`div`, { className: `space-y-3 px-4 pb-4`, children: r }),
    ],
  });
}
function C() {
  let [e, t] = (0, g.useState)(s),
    [n, r] = (0, g.useState)(!1),
    [l, d] = (0, g.useState)(!0);
  (0, g.useEffect)(() => {
    (t(u()),
  ...
  let p = (e, n) => {
    ...
    m = (e, n) => {
      (t((t) => {
        let r = [...t.newsGridColumns];
        return ((r[e] = n), { ...t, newsGridColumns: r });
      }),
        r(!0));
    },
    h = () => {
      (f(e), r(!1), o.success(`Homepage updated and saved to MySQL database!`));
    };
  return (0, _.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
        ...
        children: [
          ...
          (0, _.jsxs)(`div`, {
            ...
            children: [
              (0, _.jsxs)(`button`, {
                onClick: () => {
                  (t(s), f(s), r(!1), o.success(`Reset to defaults`));
                },
                className: `inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50`,
                children: [(0, _.jsx)(i, { className: `h-4 w-4` }), `Reset`],
              }),
              (0, _.jsxs)(`button`, {
                onClick: h,
                disabled: !n,
                ...
                children: [(0, _.jsx)(a, { className: `h-4 w-4` }), n ? `Save changes` : `Saved`],
              }),
            ],
          }),
        ],
              ...
              children: [
                ...
                (0, _.jsxs)(`label`, {
                  ...
                  children: [
                    (0, _.jsx)(`input`, {
                      type: `checkbox`,
                      checked: e.showTicker ?? !0,
                      onChange: (e) => p(`showTicker`, e.target.checked),
                      className: `peer sr-only`,
                    }),
                    (0, _.jsx)(`div`, {
                      className: `peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-focus:outline-none`,
                    }),
                  ],
                }),
              ],
              ...
              children: [
                ...
                (0, _.jsxs)(`label`, {
                  ...
                  children: [
                    (0, _.jsx)(`input`, {
                      type: `checkbox`,
                      checked: e.showBreakingBar ?? !0,
                      onChange: (e) => p(`showBreakingBar`, e.target.checked),
                      className: `peer sr-only`,
                    }),
                    (0, _.jsx)(`div`, {
                      className: `peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-focus:outline-none`,
      ...
      (0, _.jsx)(S, {
        ...
        children: (0, _.jsx)(y, { config: e, onUpdate: p }),
      }),
      (0, _.jsx)(S, {
        ...
        children: (0, _.jsxs)(`div`, {
          ...
          children: [
            (0, _.jsx)(v, {
              ...
              value: e.heroOpinion,
              showCategory: !0,
              onChange: (e) => p(`heroOpinion`, e),
            }),
            (0, _.jsx)(v, {
              label: `Popular`,
              value: e.heroPopular,
              showCategory: !0,
              onChange: (e) => p(`heroPopular`, e),
            }),
          ],
        }),
      }),
      (0, _.jsx)(S, {
        ...
        defaultOpen: !1,
        children: (0, _.jsx)(x, { value: e.liveVideo, onChange: (e) => p(`liveVideo`, e) }),
      }),
      (0, _.jsx)(S, {
        title: `News grid (5 columns)`,
        description: `Each column feeds news from your chosen category.`,
        children: (0, _.jsx)(b, { columns: e.newsGridColumns, onUpdateColumn: m }),
      }),
      (0, _.jsx)(S, {
        ...
        children: (0, _.jsxs)(`div`, {
          ...
          children: [
            (0, _.jsx)(v, {
              ...
              value: e.watch,
              showCategory: !0,
              onChange: (e) => p(`watch`, e),
            }),
            (0, _.jsx)(v, {
              label: `Markets Magazine`,
              value: e.marketsMagazine,
              showCategory: !0,
              onChange: (e) => p(`marketsMagazine`, e),
            }),
          ],
        }),
      }),
      (0, _.jsx)(`div`, {
        ...
        children: (0, _.jsxs)(`button`, {
          ...
          children: [
            (0, _.jsx)(a, { className: `h-4 w-4` }),
            n ? `Save changes to MySQL` : `All saved`,
          ],
        }),
      }),
    ],
