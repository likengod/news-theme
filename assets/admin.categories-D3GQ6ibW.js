...
import { t as a } from "./chevron-left-DittOCGp.js";
import { t as o } from "./pencil-BiM_MtGb.js";
import { t as s } from "./plus-CmmBzNRy.js";
import { t as c } from "./trash-2-Ct1qNc1i.js";
import { At as l, Bt as u, Et as d, Mt as f, Ot as p, ft as m, xt as h } from "./index-CMlkpObp.js";
import { t as g } from "./CsvImportExport-U0PR6zVA.js";
var _ = e(n()),
  v = t();
function y({ categories: e, onEdit: t, onDelete: n }) {
  return (0, v.jsx)(`div`, {
      ...
      children: [
        (0, v.jsx)(`thead`, {
          ...
          children: (0, v.jsxs)(`tr`, {
            children: [
              (0, v.jsx)(`th`, { className: `px-5 py-3`, children: `Category` }),
              (0, v.jsx)(`th`, { className: `px-5 py-3`, children: `Slug` }),
              (0, v.jsx)(`th`, { className: `px-5 py-3`, children: `Description` }),
              (0, v.jsx)(`th`, { className: `px-5 py-3 text-right`, children: `Articles` }),
              (0, v.jsx)(`th`, { className: `px-5 py-3 text-right`, children: `Actions` }),
            ],
          }),
        }),
        (0, v.jsxs)(`tbody`, {
                      ...
                      children: (0, v.jsxs)(`div`, {
                        ...
                        children: [
                          (0, v.jsxs)(`button`, {
                            ...
                            children: [(0, v.jsx)(o, { className: `h-3 w-3` }), ` Edit`],
                          }),
                          (0, v.jsxs)(`button`, {
                            onClick: () => n(e),
                            ...
                            children: [(0, v.jsx)(c, { className: `h-3 w-3` }), ` Delete`],
                          }),
                        ],
                      }),
                    }),
...
function b() {
  let e = r(p),
    ...
    [C, w] = (0, _.useState)(!0),
    [T, E] = (0, _.useState)(``),
    [D, O] = (0, _.useState)(null),
    [k, A] = (0, _.useState)(1),
    [j, M] = (0, _.useState)(``),
    N = async () => {
      try {
        w(!0);
        let t = await e({ data: { q: j } });
        (b(t), j || S(t));
      } catch (e) {
        u.error(e.message || `Failed to load categories`);
      } finally {
        w(!1);
      }
    };
  ...
  let P = async (e) => {
      try {
        (w(!0), await o({ data: e }), u.success(`Categories imported successfully`), await N());
      } catch (e) {
        u.error(e.message || `Failed to import categories`);
      } finally {
        w(!1);
      }
    },
    F = Math.max(1, Math.ceil(c.length / 15)),
    I = Math.min(k, F),
    L = c.slice((I - 1) * 15, I * 15),
    R = async (e) => {
      if (!e.name.trim()) return u.error(`Category name is required`);
      try {
        (await t({ data: e }),
          u.success(D ? `Category updated` : `Category created`),
          O(null),
          E(``),
          N());
      } catch (e) {
        u.error(e.message || `Failed to save category`);
      }
    };
  return (0, v.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      (0, v.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, v.jsxs)(`div`, {
            className: `flex items-center gap-2`,
            children: [
              (0, v.jsx)(g, { data: x, filename: `categories`, onImport: P }),
              (0, v.jsxs)(`button`, {
                onClick: () =>
                  O({
                    id: Date.now(),
                ...
                children: [(0, v.jsx)(s, { className: `h-4 w-4` }), ` Add Category`],
              }),
            ],
          }),
        ],
      ...
      (0, v.jsx)(`div`, {
        ...
        children: (0, v.jsxs)(`div`, {
          ...
          children: [
            (0, v.jsx)(m, { className: `absolute left-3 top-2.5 h-4 w-4 text-slate-400` }),
            (0, v.jsx)(`input`, {
              type: `text`,
              value: j,
              onChange: (e) => {
                (M(e.target.value), A(1));
              },
      ...
      C
        ...
        : (0, v.jsx)(y, {
            ...
            onEdit: (e) => O({ ...e }),
            onDelete: async (e) => {
              if (confirm(`Delete category "${e.name}"?`))
                try {
                  (await n({ data: e.id }), u.success(`Category deleted`), N());
                } catch (e) {
                  u.error(e.message || `Failed to delete category`);
                }
            },
          }),
      F > 1 &&
        (0, v.jsxs)(`div`, {
          ...
          children: [
            (0, v.jsxs)(`p`, {
              ...
              children: [
                `Page `,
                (0, v.jsx)(`strong`, { children: I }),
                ` of `,
                (0, v.jsx)(`strong`, { children: F }),
                ` (`,
                c.length,
                ` total categories)`,
              ],
            ...
            (0, v.jsxs)(`div`, {
              ...
              children: [
                (0, v.jsxs)(`button`, {
                  ...
                  children: [(0, v.jsx)(a, { className: `h-3.5 w-3.5` }), ` Previous`],
                }),
                (0, v.jsxs)(`button`, {
                  onClick: () => A((e) => Math.min(F, e + 1)),
                  disabled: I >= F,
                  className: `inline-flex items-center gap-1 rounded-md border border-slate-200 px-3 py-1.5 text-xs font-medium hover:bg-slate-50 disabled:opacity-40`,
                  children: [`Next `, (0, v.jsx)(h, { className: `h-3.5 w-3.5` })],
                }),
              ],
            }),
          ],
          ...
          children: (0, v.jsxs)(`div`, {
            ...
            children: [
              (0, v.jsx)(`h2`, {
                ...
                children: D.id > 1e6 ? `Add Category` : `Edit Category — ${D.name}`,
              }),
              (0, v.jsxs)(`div`, {
                children: [
                  (0, v.jsx)(`label`, {
                  ...
                  (0, v.jsx)(`input`, {
                    type: `text`,
                    value: D.name,
                    onChange: (e) => O({ ...D, name: e.target.value, slug: i(e.target.value) }),
              ...
              (0, v.jsxs)(`div`, {
                children: [
                  ...
                  (0, v.jsx)(`input`, {
                    type: `text`,
                    value: D.slug,
                    onChange: (e) => O({ ...D, slug: e.target.value }),
                    className: `h-9 w-full rounded-md border border-slate-200 px-3 text-sm focus:border-slate-900 focus:outline-none`,
                  }),
                ],
              }),
              (0, v.jsxs)(`div`, {
                ...
                children: [
                  (0, v.jsx)(`input`, {
                    type: `checkbox`,
                    id: `showInHeader`,
                    checked: D.showInHeader || !1,
                    onChange: (e) => O({ ...D, showInHeader: e.target.checked }),
              ...
              (0, v.jsxs)(`div`, {
                children: [
                  ...
                  (0, v.jsx)(`textarea`, {
                    value: D.description,
                    onChange: (e) => O({ ...D, description: e.target.value }),
                    rows: 3,
