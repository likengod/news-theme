...
import { t } from "./createLucideIcon-hjrkzsgs.js";
import { t as n } from "./eye-CvwOJwvW.js";
import { t as r } from "./message-square-DqTG6Ona.js";
import { t as i } from "./trending-up-DcjF89x0.js";
import { t as a } from "./users-BJGhrbX-.js";
import { mt as o, n as s } from "./index-CMlkpObp.js";
var c = t(`trending-down`, [
              ...
              children: [
                (0, l.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, l.jsx)(`div`, {
                      className: `grid h-10 w-10 place-items-center rounded-md ${e.tint}`,
                      children: (0, l.jsx)(t, { className: `h-5 w-5` }),
                    }),
                  ],
                }),
                (0, l.jsxs)(`div`, {
                  className: `mt-3 inline-flex items-center gap-1 text-xs font-medium ${e.up ? `text-emerald-600` : `text-red-600`}`,
                  children: [
                    (0, l.jsx)(n, { className: `h-3.5 w-3.5` }),
                    e.delta,
                    ` `,
                    (0, l.jsx)(`span`, { className: `text-slate-500`, children: `vs last month` }),
                  ],
                }),
              ],
            },
          ...
          (0, l.jsxs)(`div`, {
            ...
            children: [
              (0, l.jsxs)(`div`, {
                ...
                children: [
                  (0, l.jsx)(`h2`, { className: `font-semibold`, children: `Recent Articles` }),
                  (0, l.jsx)(`a`, {
                    href: `/admin/articles`,
                            ...
                            children: [
                              e.featuredImage
                                ...
                                : (0, l.jsx)(`div`, {
                                    ...
                                    children: (0, l.jsx)(o, { className: `h-5 w-5` }),
                                  }),
                              (0, l.jsxs)(`div`, {
                              ...
                              (0, l.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, l.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, l.jsx)(n, { className: `h-3 w-3` }),
                                      e.views?.toLocaleString() ?? `0`,
                                    ],
                                  }),
                                  (0, l.jsx)(`div`, {
                ...
                (0, l.jsx)(`ul`, {
                  ...
                  children:
                    p.length === 0
                      ...
                      : p.map((e, t) => {
                          let n = Math.round((e.count / h) * 100);
                          return (0, l.jsxs)(
                            `li`,
                            {
                              className: `px-5 py-3`,
