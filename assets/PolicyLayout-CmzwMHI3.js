...
import { t as a } from "./file-text-CRjBQ2A8.js";
import { t as o } from "./message-square-DqTG6Ona.js";
import { t as s } from "./shield-check-DyBVQKTu.js";
import { P as c, St as l, _t as u, gt as d, pt as f, w as p } from "./index-CMlkpObp.js";
var m = e(n()),
  h = t(),
  g = [
    ...
    { label: `Submit News`, to: `/submit-news` },
  ];
function _(e) {
  return e
    .toLowerCase()
...
function v({
  ...
  notice: v,
  sections: y,
  lastUpdated: b = `January 10, 2026`,
  contactEmail: x = `legal@northeasttimeline.com`,
}) {
  let S = i({ select: (e) => e.location.pathname }),
    C = g.find((e) => e.to === S),
    w = g.filter((e) => e.to !== S),
    [T, E] = (0, m.useState)(!1),
    [D, O] = (0, m.useState)(!1);
              ...
              children: [
                  ...
                  children: (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsx)(`span`, {
                        ...
                        children: (0, h.jsx)(s, { className: `h-4 w-4` }),
                      }),
                      (0, h.jsx)(`span`, {
                        className: `flex-1 text-[15px] font-semibold`,
                        children: C?.label ?? t,
                      }),
                      (0, h.jsx)(l, { className: `h-4 w-4 opacity-70` }),
                    ],
                  }),
                }),
                (0, h.jsx)(`ul`, {
                ...
                (0, h.jsxs)(`button`, {
                  ...
                  children: [
                    (0, h.jsx)(`span`, {
                      ...
                      children: (0, h.jsx)(a, { className: `h-4 w-4` }),
                    }),
                    (0, h.jsx)(`span`, {
                      className: `flex-1 text-[15px] font-semibold`,
                      children: `Other Policies`,
                    }),
                    (0, h.jsx)(l, { className: `h-4 w-4 transition ${T ? `rotate-180` : ``}` }),
                  ],
                }),
                T &&
                  (0, h.jsx)(`ul`, {
                ...
                (0, h.jsxs)(`button`, {
                  ...
                  children: [
                    (0, h.jsx)(`span`, {
                      className: `grid h-8 w-8 place-items-center rounded-lg bg-muted`,
                      children: (0, h.jsx)(o, { className: `h-4 w-4` }),
                    }),
                    (0, h.jsx)(`span`, {
                      className: `flex-1 text-[15px] font-semibold`,
                      children: `Connect Us`,
                    }),
                    (0, h.jsx)(l, { className: `h-4 w-4 transition ${D ? `rotate-180` : ``}` }),
                  ],
                }),
                D &&
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsxs)(`a`, {
                        ...
                        children: [
                          (0, h.jsx)(u, { className: `h-4 w-4 text-muted-foreground` }),
                          ` `,
                          x,
                        ],
                      }),
                      (0, h.jsxs)(`a`, {
                        ...
                        className: `flex items-center gap-2 rounded-lg px-2 py-1.5 hover:bg-muted`,
                        children: [
                          (0, h.jsx)(f, { className: `h-4 w-4 text-muted-foreground` }),
                          ` +91 12345 67890`,
                        ],
                      }),
                      (0, h.jsxs)(`p`, {
                        ...
                        children: [
                          (0, h.jsx)(d, { className: `mt-0.5 h-4 w-4 text-muted-foreground` }),
                ...
                (0, h.jsxs)(`header`, {
                  children: [
                    (0, h.jsxs)(`div`, {
                      ...
                      children: [
                        (0, h.jsx)(`span`, {
                          ...
                          children: (0, h.jsx)(s, { className: `h-6 w-6` }),
                        }),
                        (0, h.jsx)(`h1`, {
                    ...
                    (0, h.jsxs)(`p`, {
                      ...
                      children: [e === `Policy` ? `Narrative Sync` : e, ` · `, b],
                    }),
                    n &&
                      (0, h.jsx)(`p`, {
                    ...
                    (0, h.jsx)(`div`, { className: `mt-6 h-px w-full bg-border` }),
                  ],
                }),
                v &&
                  (0, h.jsxs)(`aside`, {
