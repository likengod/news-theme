...
import { C as r, E as i, S as a, f as o, i as s, p as c } from "./site-content-BDGWQAlc.js";
import { t as l } from "./loader-circle-3QDpCwJC.js";
import { t as u } from "./sparkles-C_7tCNub.js";
import { t as d } from "./crown-DVAr_sIn.js";
import { t as f } from "./external-link-CLZsHAzx.js";
import { t as p } from "./file-text-CRjBQ2A8.js";
import { t as m } from "./save-DCSXhHjW.js";
import { t as h } from "./shield-check-DyBVQKTu.js";
import { Bt as g } from "./index-CMlkpObp.js";
import { n as _ } from "./ai.functions-D5-VhyLq.js";
import { n as v, t as y } from "./SettingsHelpers-nrY-Ajj-.js";
var b = e(n()),
  x = t();
function S({ sec: e, idx: t, activeSections: n, update: r }) {
  let [i, a] = (0, b.useState)(``),
    ...
    m = async () => {
      if (!i.trim()) {
        g.error(`Please enter instructions for the AI.`);
        return;
      }
      (s(!0), p(``));
      try {
        (p(await _({ data: { instructions: i, currentHeading: e.heading, currentBody: e.body } })),
          g.success(`Content generated! Please review.`));
      } catch (e) {
        g.error(e.message || `Failed to generate content.`);
      } finally {
        s(!1);
      }
    };
      ...
      (0, x.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, x.jsx)(`input`, {
            ...
            onChange: (e) => {
              let i = [...n];
              ((i[t].heading = e.target.value), r(`sections`, i));
            },
          ...
          (0, x.jsxs)(`div`, {
            ...
            children: [
              (0, x.jsxs)(`label`, {
                ...
                children: [`Section `, t + 1, ` Content (HTML allowed)`],
              }),
              (0, x.jsxs)(`button`, {
                onClick: () => d(!0),
                ...
                children: [(0, x.jsx)(u, { className: `h-3.5 w-3.5` }), ` AI Assistant`],
              }),
            ],
          }),
          (0, x.jsx)(`textarea`, {
            ...
            onChange: (e) => {
              let i = [...n];
              ((i[t].body = e.target.value), r(`sections`, i));
            },
            rows: 6,
                  ...
                  (0, x.jsx)(`button`, {
                    onClick: () => {
                      ...
                      ((e[t].body = f),
                        ...
                        p(``),
                        a(``),
                        g.success(`Content applied successfully!`));
                    },
                    disabled: !f,
...
var C = [
    ...
    { key: `subscriptionIntro`, label: `Subscription Intro Text`, textarea: !0 },
  ...
  w = [
    ...
    { key: `workWithUsHeroIntro`, label: `Hero Intro text`, textarea: !0 },
    { key: `workWithUsIdCardReq`, label: `ID Card Requirement Text`, textarea: !0 },
    {
      key: `workWithUsRules`,
...
function T() {
  let [e, t] = (0, b.useState)(() => o()),
    [n, l] = (0, b.useState)(() => c()),
    [u, _] = (0, b.useState)(`about`);
  (0, b.useEffect)(() => {
    s()
      .then((e) => t(e))
      .catch(() => {});
  }, []);
  let T = (0, b.useMemo)(() => e.find((e) => e.slug === u) ?? e[0], [e, u]),
    E = (e, n) => t((t) => t.map((t) => (t.slug === u ? { ...t, [e]: n } : t))),
    D = (e, t) => l((n) => ({ ...n, [e]: t })),
    O = async () => {
      u === `subscription` || u === `work-with-us`
        ? (await i({ data: n }).catch(() => {}),
          g.success(`${u === `subscription` ? `Subscription` : `Work With Us`} settings saved!`))
        : (r(e),
          await a({ data: T }).catch(() => {}),
          g.success(`"${T?.title || u}" saved to MySQL!`));
    },
    k = u === `subscription`,
    A = u === `work-with-us`,
    j = k || A;
      ...
      (0, x.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, x.jsxs)(`div`, {
            ...
            children: [
              (0, x.jsx)(h, { className: `h-4 w-4 text-emerald-600` }),
              ` MySQL Page Storage Active`,
            ],
          }),
        ],
      }),
          ...
          (0, x.jsx)(`aside`, {
            ...
            children: (0, x.jsxs)(`ul`, {
              ...
              children: [
                  ...
                  (0, x.jsx)(
                    `li`,
                    {
                      children: (0, x.jsxs)(`button`, {
                        onClick: () => _(e.slug),
                        className: `flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-medium transition ${e.slug === u ? `bg-slate-900 text-white shadow-sm` : `text-slate-700 hover:bg-slate-100`}`,
                        children: [
                          (0, x.jsx)(p, { className: `h-4 w-4 shrink-0` }),
                          (0, x.jsx)(`span`, { className: `truncate`, children: e.title }),
                        ],
                      }),
                    },
                    e.slug,
                ...
                (0, x.jsx)(`li`, { className: `my-2 border-t border-slate-100` }),
                (0, x.jsx)(`li`, {
                  children: (0, x.jsxs)(`button`, {
                    onClick: () => _(`subscription`),
                    className: `flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-medium transition ${k ? `bg-slate-900 text-white shadow-sm` : `text-slate-700 hover:bg-slate-100`}`,
                    children: [
                      (0, x.jsx)(d, { className: `h-4 w-4 shrink-0` }),
                      (0, x.jsx)(`span`, {
                        className: `truncate`,
                ...
                (0, x.jsx)(`li`, {
                  className: `mt-1`,
                  children: (0, x.jsxs)(`button`, {
                    onClick: () => _(`work-with-us`),
                    className: `flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-medium transition ${A ? `bg-slate-900 text-white shadow-sm` : `text-slate-700 hover:bg-slate-100`}`,
                    children: [
                      (0, x.jsx)(d, { className: `h-4 w-4 shrink-0` }),
                      (0, x.jsx)(`span`, {
                        className: `truncate`,
            ...
            children: [
                  ...
                  (0, x.jsxs)(`div`, {
                    ...
                    children: [
                      (0, x.jsxs)(`a`, {
                        ...
                        children: [`View Live Page `, (0, x.jsx)(f, { className: `h-3.5 w-3.5` })],
                      }),
                      (0, x.jsxs)(`button`, {
                        onClick: O,
                        ...
                        children: [(0, x.jsx)(m, { className: `h-4 w-4` }), ` Save Page`],
                      }),
                    ],
                  }),
                ],
              ...
              k
                ? (0, x.jsx)(y, {
                    ...
                    children: C.map((e) => (0, x.jsx)(v, { f: e, s: n, update: D }, e.key)),
                  })
                : A
                  ? (0, x.jsx)(y, {
                      title: `Work With Us Setup`,
                      subtitle: `Configure the content on the /work-with-us page.`,
                      children: w.map((e) => (0, x.jsx)(v, { f: e, s: n, update: D }, e.key)),
                    })
                  : T
                    ? (0, x.jsxs)(`div`, {
                        className: `space-y-8`,
                        children: [
                          (0, x.jsxs)(`div`, {
                            children: [
                              ...
                              (0, x.jsx)(`input`, {
                                type: `text`,
                                value: T.intro || ``,
                                onChange: (e) => E(`intro`, e.target.value),
                          ...
                          u === `contact`
                            ? (0, x.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, x.jsx)(`strong`, { children: `Note:` }),
                                  ` The Contact Us page relies on a hardcoded layout with a contact form. Only the subtitle/intro above can be updated here.`,
                                ],
                              })
                            : (0, x.jsxs)(`div`, {
                                className: `space-y-4`,
