...
import { a as g } from "./AdSettingsContext-BPuWF7kc.js";
import { t as _ } from "./createLucideIcon-hjrkzsgs.js";
import { t as v } from "./sparkles-C_7tCNub.js";
import { t as y } from "./clock-DkOD1y1x.js";
import { t as ee } from "./external-link-CLZsHAzx.js";
import { t as b } from "./folder-open-B4k9x8X8.js";
import { t as x } from "./image-fjgNV0aQ.js";
import { t as S } from "./info-CSk4y27_.js";
import { t as C } from "./lock-BxD192lc.js";
import { t as w } from "./plus-CmmBzNRy.js";
import { t as te } from "./rotate-ccw-B1_KblCN.js";
import { t as T } from "./save-DCSXhHjW.js";
import { t as E } from "./trash-2-Ct1qNc1i.js";
import { t as D } from "./upload-DHoeWDIp.js";
import { Bt as O, Jt as k, ct as A } from "./index-CMlkpObp.js";
import { r as j } from "./media-library-DM9U1yyP.js";
import { t as M } from "./MediaField-DPta6ix_.js";
import { t as ne } from "./switch-BYa5gnRW.js";
import { t as N } from "./label-ZyRtWLj_.js";
var P = _(`code`, [
...
function R({
  ...
  let p = async (t) => {
    if (t) {
      try {
        (o((await j(t, `advertisement`)).dataUrl), O.success(`${e} image uploaded`));
      } catch {
  ...
  return (0, L.jsxs)(`div`, {
    ...
    children: [
      (0, L.jsx)(`input`, {
        ...
        accept: `image/*`,
        hidden: !0,
        onChange: (e) => p(e.target.files?.[0]),
      }),
      (0, L.jsx)(`div`, {
        onClick: () => c((e) => !e),
        title: `Click to add/change ${e} image (${a})`,
        className: `group relative flex cursor-pointer items-center justify-center overflow-hidden rounded-lg border border-dashed transition-all duration-200 ${r} ${n ? `border-slate-300 bg-white shadow-xs hover:border-slate-500 hover:shadow-md` : `border-slate-300 bg-slate-50 hover:border-slate-400 hover:bg-slate-100/80`}`,
        children: n
          ? (0, L.jsxs)(L.Fragment, {
              children: [
                (0, L.jsx)(`img`, { src: n, alt: e, className: `h-full w-full object-cover` }),
                (0, L.jsx)(`div`, {
                ...
                (0, L.jsx)(`button`, {
                  ...
                  children: (0, L.jsx)(A, { className: `h-3 w-3` }),
                }),
              ],
            })
          : (0, L.jsxs)(`div`, {
              ...
              children: [
                (0, L.jsx)(w, { className: `h-4 w-4` }),
                (0, L.jsx)(`span`, { className: `mt-0.5 text-[9px] font-semibold`, children: i }),
              ],
            }),
      }),
      (0, L.jsxs)(`div`, {
        ...
        children: [
          (0, L.jsx)(`span`, {
            className: `rounded px-1.5 py-0.2 text-[8px] font-bold uppercase tracking-wider text-white ${t}`,
            children: e,
          }),
          (0, L.jsx)(`span`, {
        ...
        (0, L.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, L.jsxs)(`button`, {
              ...
              children: [
                (0, L.jsx)(D, { className: `h-4 w-4 shrink-0 text-slate-500` }),
                (0, L.jsxs)(`div`, {
                  children: [
                    (0, L.jsx)(`div`, {
            ...
            (0, L.jsxs)(`button`, {
              ...
              children: [
                (0, L.jsx)(b, { className: `h-4 w-4 shrink-0 text-slate-500` }),
                (0, L.jsxs)(`div`, {
                  children: [
                    (0, L.jsx)(`div`, {
                      className: `font-medium text-slate-900`,
      ...
      l &&
        (0, L.jsx)(M, {
          ...
          onClose: () => u(!1),
          onPick: (t) => {
            (o(t.dataUrl), u(!1), O.success(`${e} image selected`));
          },
        }),
    ],
  });
}
function re({ ad: e, slot: t, onUpdate: n }) {
  let r = t === `home2` ? `landscape` : `portrait`,
    i = e.orientation || r,
    a = e.imagePortrait || (e.image && (i === `portrait` || !e.imageLandscape) ? e.image : ``),
    o = e.imageLandscape || (e.image && (i === `landscape` || !e.imagePortrait) ? e.image : ``),
    s =
      t === `home2` ? `406 × 196 px` : t === `leaderboard` ? `728 × 90 px, etc.` : `1200 × 675 px`;
    ...
    ? (0, L.jsxs)(`div`, {
        ...
        children: [
          (0, L.jsx)(R, {
            ...
            onChange: (t) => {
              n(e.id, { imagePortrait: t, image: t || e.imageLandscape || e.image });
            },
          }),
          (0, L.jsx)(R, {
            label: `Desktop View`,
            ...
            onChange: (t) => {
              n(e.id, { imageLandscape: t, image: t || e.imagePortrait || e.image });
            },
          }),
        ],
      })
    : t === `featured_slide`
      ? (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsx)(R, {
            ...
            recSize: `800 × 500 px`,
            onChange: (t) => {
              n(e.id, { imageLandscape: t, image: t, orientation: `landscape` });
            },
          }),
        })
      : (0, L.jsxs)(`div`, {
          ...
          children: [
            (0, L.jsx)(R, {
              ...
              onChange: (t) => {
                n(e.id, {
                  imagePortrait: t,
                  image: t || e.imageLandscape || e.image,
            ...
            (0, L.jsx)(R, {
              ...
              onChange: (t) => {
                n(e.id, {
                  imageLandscape: t,
                  image: t || e.imagePortrait || e.image,
...
var z = [
  ...
  oe = `<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1234567890123456" crossorigin="anonymous"><\/script>
<!-- Responsive Ad -->
...
function B() {
  let e = k(),
    ...
    n =
      ...
      t.licenseRole === `VIP`,
    _ = [`Enterprise`, `Enterprise+`].includes(t.licenseType || ``) || t.licenseRole === `VIP`,
    [D, A] = (0, I.useState)(`home1`),
    [j, M] = (0, I.useState)([]),
    [R, B] = (0, I.useState)([]),
    [V, H] = (0, I.useState)(5),
    [U, W] = (0, I.useState)(`image`),
    [G, K] = (0, I.useState)(``),
    [se, ce] = (0, I.useState)(!1),
    [le, ue] = (0, I.useState)(!1),
    [de, fe] = (0, I.useState)(null),
    [pe, me] = (0, I.useState)(null),
    q = (0, I.useRef)(null);
  ((0, I.useEffect)(() => {
    (l(), M(s(`home1`)), B(d()), W(u(`home1`)), K(f(`home1`)));
  }, []),
    (0, I.useEffect)(() => {
      D === `trash` ? B(d()) : (M(s(D)), H(o(D)), W(u(D)), K(f(D)), ce(!1));
    }, [D]));
  let J = D === `trash`,
    Y = J ? `home1` : D,
    X = z.find((e) => e.key === Y),
    he = (0, I.useMemo)(() => {
      ...
      return (
        z.forEach((t) => {
          e[t.key] = s(t.key).length;
        }),
        e
      );
    }, [j, D]);
  (0, I.useMemo)(() => d().length, [D, R]);
  let Z = (e, t) => M((n) => n.map((n) => (n.id === e ? { ...n, ...t } : n))),
    ge = (e) => {
      (r([e], Y), M(s(Y)), B(d()), O.success(`Moved to Trash (recoverable for 30 days)`));
    },
    Q = () => {
      let e = ae();
      (M((t) => [
        ...
        me(e),
        O.success(`New ad slide added to ${X?.label ?? Y}!`),
        setTimeout(() => {
    ...
    $ = () => {
      if ((h(Y, U), U === `script`))
        (a(Y, G), O.success(`Saved 3rd Party Script Ad integration for ${X?.label ?? Y}`));
      else {
        let e = j.filter(
          (e) => (e.image || e.imagePortrait || e.imageLandscape || ``).trim().length > 0,
        );
        (m(e, Y), p(Y, V), M(e));
        let t = X?.label ?? Y;
        O.success(
          `Saved ${e.length} custom banner slide${e.length === 1 ? `` : `s`} to ${t} (rotates every ${V}s)`,
        );
      }
    },
    _e = (e) => {
      (i(e), B(d()), O.success(`Restored ad slide`));
    },
    ve = (e) => {
      (c(e), B(d()), O.success(`Permanently deleted`));
    };
  return (0, L.jsxs)(`div`, {
        ...
        children: [
          (0, L.jsx)(`div`, {
            ...
            children: z.map((e) => {
              let t = D === e.key,
                r =
                  ((e.key === `popup` || e.key === `leaderboard`) && !n) ||
                  (e.key === `featured_slide` && !_),
                i = he[e.key] || 0;
              return (0, L.jsxs)(
                `button`,
                {
                  onClick: () => A(e.key),
                  className: `group flex items-center gap-2 rounded-t-lg border-b-2 px-4 py-2.5 text-sm font-semibold transition-all ${t ? `border-slate-900 bg-slate-900 text-white shadow-xs` : r ? `border-transparent text-slate-400 hover:bg-slate-50` : `border-transparent text-slate-600 hover:bg-slate-100 hover:text-slate-900`}`,
                  children: [
                    (0, L.jsxs)(`div`, {
                      className: `flex items-center gap-1.5`,
                      children: [
                        (0, L.jsx)(`span`, { children: e.label }),
                        r && (0, L.jsx)(C, { className: `h-3.5 w-3.5 text-slate-300` }),
                      ],
                    }),
                    !r &&
                      (0, L.jsx)(`span`, {
                        className: `rounded-full px-2 py-0.5 text-[10.5px] font-bold ${t ? `bg-slate-700 text-slate-200` : `bg-slate-200 text-slate-600 group-hover:bg-slate-300`}`,
                        children: i,
                      }),
                  ],
                },
            ...
            (0, L.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, L.jsxs)(`button`, {
                  ...
                  children: [(0, L.jsx)(E, { className: `h-4 w-4` }), ` Trash (`, R.length, `)`],
                }),
              ],
            }),
        ],
      }),
      ((D === `popup` || D === `leaderboard`) && !n) || (D === `featured_slide` && !_)
        ? (0, L.jsxs)(`div`, {
            ...
            children: [
              (0, L.jsx)(`div`, {
                ...
                children: (0, L.jsx)(C, { className: `h-8 w-8 text-slate-400` }),
              }),
              (0, L.jsx)(`h3`, {
              ...
              (0, L.jsxs)(`p`, {
                ...
                children: [
                  `The `,
                  D === `popup` ? `Popup` : D === `leaderboard` ? `Leaderboard` : `Featured Ads`,
              ...
              (0, L.jsx)(`button`, {
                onClick: () => e({ to: `/admin/settings`, search: { tab: `activate` } }),
        ...
        : J
          ? R.length === 0
            ? (0, L.jsxs)(`div`, {
                className: `flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center`,
                children: [
                  (0, L.jsx)(F, { className: `mb-3 h-8 w-8 text-slate-400` }),
                  (0, L.jsx)(`h3`, {
                ...
                children: [
                  (0, L.jsx)(`div`, {
                    ...
                    children: (0, L.jsxs)(`div`, {
                      ...
                      children: [
                        (0, L.jsx)(S, { className: `h-4 w-4 shrink-0 text-amber-600` }),
                          ...
                          (0, L.jsxs)(`div`, {
                            ...
                            children: [
                              (0, L.jsx)(`div`, {
                                ...
                                children:
                                  e.type === `script`
                                    ? (0, L.jsx)(P, { className: `h-6 w-6 text-purple-600` })
                                    : e.image
                                      ? (0, L.jsx)(`img`, {
                                          src: e.image,
                                          alt: ``,
                                  ...
                                  (0, L.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, L.jsxs)(`span`, {
                                        ...
                                        children: [
                                          (0, L.jsx)(b, { className: `h-3 w-3` }),
                                          z.find((t) => t.key === e.slot)?.label || e.slot,
                                        ],
                                      }),
                                      (0, L.jsx)(`span`, { children: `ï¿½` }),
                                      (0, L.jsxs)(`span`, {
                                        className: `inline-flex items-center gap-1 text-red-500`,
                                        children: [
                                          (0, L.jsx)(y, { className: `h-3 w-3` }),
                                          `Deleted`,
                                        ],
                                      }),
                                    ],
                          ...
                          (0, L.jsxs)(`div`, {
                            ...
                            children: [
                              (0, L.jsxs)(`button`, {
                                ...
                                children: [
                                  (0, L.jsx)(te, { className: `h-3.5 w-3.5` }),
                                  ` Restore`,
                                ],
                              }),
                              (0, L.jsxs)(`button`, {
                                ...
                                children: [
                                  (0, L.jsx)(E, { className: `h-3.5 w-3.5` }),
                                  ` Delete forever`,
                                ],
                              }),
                            ],
                      ...
                      (0, L.jsxs)(`div`, {
                        ...
                        children: [
                          (0, L.jsxs)(`label`, {
                            ...
                            children: [
                              (0, L.jsx)(P, { className: `h-4.5 w-4.5 text-purple-600` }),
                              (0, L.jsx)(`span`, {
                                children: `Paste 3rd-Party Script HTML/JS Code (Google AdSense, Bing Ads, Custom Script)`,
                              }),
                            ],
                          }),
                          (0, L.jsx)(`div`, {
...
`
                      ...
                      (0, L.jsxs)(`div`, {
                        ...
                        children: [
                          (0, L.jsx)(S, { className: `h-4 w-4 shrink-0 mt-0.5 text-blue-600` }),
                          (0, L.jsxs)(`p`, {
                            children: [
                              (0, L.jsx)(`strong`, { children: `Important:` }),
                              ` 3rd party scripts are executed exactly as provided. Ensure you only paste code from trusted ad networks like Google AdSense. In script mode, custom banner slides for this slot are ignored.`,
                            ],
                          }),
                        ],
                      }),
                  ...
                  (0, L.jsx)(`div`, {
                    ...
                    children: (0, L.jsxs)(`button`, {
                      ...
                      children: [
                        (0, L.jsx)(T, { className: `h-4 w-4 text-emerald-400` }),
                        ` Save Script Integration`,
                      ],
                    }),
                  }),
                ],
              ...
              ? (0, L.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, L.jsxs)(`h3`, {
                      ...
                      children: [`No ads added to `, X?.label, ` yet`],
                    }),
                    (0, L.jsxs)(`p`, {
                    ...
                    (0, L.jsxs)(`div`, {
                      ...
                      children: [
                        (0, L.jsxs)(`div`, {
                          ...
                          children: [
                            (0, L.jsx)(v, { className: `h-4 w-4 text-amber-400` }),
                            (0, L.jsxs)(`span`, {
                              children: [
                                (0, L.jsx)(`strong`, { children: j.length }),
                                ` active ad slide`,
                                j.length === 1 ? `` : `s`,
                                ` in `,
                                (0, L.jsx)(`strong`, { children: X?.label }),
                              ],
                            }),
                          ],
                        }),
                        (0, L.jsxs)(`button`, {
                          ...
                          children: [(0, L.jsx)(w, { className: `h-3.5 w-3.5` }), ` Add ad`],
                        }),
                      ],
                    }),
                    (0, L.jsx)(`div`, {
                      ...
                      children: j.map((e, t) =>
                        (0, L.jsxs)(
                          `div`,
                          {
                            className: `rounded-xl border border-slate-200 bg-white p-4 shadow-xs transition-colors ${e.id === pe ? `bg-emerald-50/40 border-emerald-300 ring-1 ring-emerald-300` : `hover:border-slate-300`}`,
                            children: [
                              (0, L.jsxs)(`div`, {
                                className: `flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-3`,
                                children: [
                                    ...
                                    children: [
                                      (0, L.jsxs)(`div`, {
                                        ...
                                        children: [
                                          ...
                                          (0, L.jsx)(`input`, {
                                            type: `date`,
                                            value: ie(e.expiresAt),
                                            onChange: (t) =>
                                              Z(e.id, {
                                                expiresAt: t.target.value
                                                  ? new Date(t.target.value).toISOString()
                                                  : null,
                                              }),
                                      ...
                                      (0, L.jsx)(`button`, {
                                        ...
                                        children: (0, L.jsx)(E, { className: `h-4 w-4` }),
                                      }),
                                    ],
                                  }),
                                ],
                                  ...
                                  children: [
                                    (0, L.jsxs)(`div`, {
                                      children: [
                                        ...
                                        (0, L.jsx)(re, { ad: e, slot: Y, onUpdate: Z }),
                                      ],
                                    }),
                                    (0, L.jsxs)(`div`, {
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            e.href &&
                                              ...
                                              (0, L.jsxs)(`a`, {
                                                ...
                                                children: [
                                                  `Test link `,
                                                  (0, L.jsx)(ee, { className: `h-2.5 w-2.5` }),
                                                ],
                                              }),
                                          ],
                                        }),
                                        (0, L.jsx)(`input`, {
                                          value: e.href,
                                          onChange: (t) => Z(e.id, { href: t.target.value }),
