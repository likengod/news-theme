...
import { i as a } from "./AdSettingsContext-BPuWF7kc.js";
import { t as o } from "./createLucideIcon-hjrkzsgs.js";
import { t as s } from "./sparkles-C_7tCNub.js";
import { t as c } from "./clock-DkOD1y1x.js";
import { t as l } from "./refresh-cw-15eK9DsP.js";
import { t as u } from "./rotate-ccw-B1_KblCN.js";
import { t as d } from "./save-DCSXhHjW.js";
import { Bt as f } from "./index-CMlkpObp.js";
var p = o(`power`, [
...
function b() {
  let [e, t] = (0, m.useState)(() => i()),
    [n, o] = (0, m.useState)(!1),
    [b, x] = (0, m.useState)(!1),
    S = a(),
    C = e.festiveThemeEnabled !== !1;
  ((0, m.useEffect)(() => {
    t(i());
  }, []),
    (0, m.useEffect)(() => {
      ...
      let t = (Number(e.topBarSwapDelay) || 5) * 1e3,
        n = setInterval(() => {
          x((e) => !e);
        }, t);
  ...
  let w = (e, n) => {
    ...
    T = () => {
      (r(e),
        o(!0),
        f.success(`Festive & Custom Alert settings saved!`),
        setTimeout(() => o(!1), 2e3));
    },
    E = e.topBarWeatherCustomText?.trim() || `Breaking News Alert`,
    D = e.topBarTextGradient || e.festiveCategoryTitleGradient,
    O = e.festiveCategoryTitleColor || e.topBarTextColor || `#000000`,
    k = S.fonts.find((t) => t.id === e.customAlertFontFamily),
    A = k ? `"${k.family}", sans-serif` : `"Inter", system-ui, sans-serif`,
    j = v[e.customAlertAnimationStyle || `slide-up`] || v[`slide-up`],
    M =
      D && g[D]
        ? {
            backgroundImage: g[D],
    ...
    N =
      D && g[D]
        ? {
            backgroundColor: e.festiveCategoryBadgeBgColor || `#000000`,
            backgroundImage: g[D],
            WebkitBackgroundClip: `text`,
            WebkitTextFillColor: `transparent`,
            backgroundClip: `text`,
        ...
        : {
            backgroundColor: e.festiveCategoryBadgeBgColor || `#000000`,
            color: e.festiveCategoryBadgeTextColor || `#FFFFFF`,
          },
    [P, F] = (0, m.useState)(0);
  return (
    (0, m.useEffect)(() => {
      F((e) => e + 1);
    }, [e.customAlertFontFamily, e.customAlertFontSize]),
    (0, m.useEffect)(() => {
      (F((e) => e + 1), C && x((e) => !e));
    }, [e.customAlertAnimationStyle, C]),
    (0, h.jsxs)(`div`, {
      className: `space-y-6 max-w-5xl mx-auto`,
      children: [
        (0, h.jsx)(`style`, { dangerouslySetInnerHTML: { __html: _ } }),
        (0, h.jsxs)(`section`, {
            ...
            (0, h.jsxs)(`div`, {
              ...
              children: [
                (0, h.jsxs)(`div`, {
                  ...
                  children: [
                    (0, h.jsx)(`div`, {
                      ...
                      children: (0, h.jsx)(s, { className: `h-5 w-5` }),
                    }),
                    (0, h.jsxs)(`div`, {
                      children: [
                        (0, h.jsx)(`h2`, {
                ...
                (0, h.jsxs)(`button`, {
                  type: `button`,
                  onClick: T,
                  className: `inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all active:scale-95 shrink-0 self-start sm:self-auto ${n ? `bg-emerald-600` : `bg-slate-900 hover:bg-slate-800`}`,
                  children: [
                    (0, h.jsx)(d, { className: `h-3.5 w-3.5` }),
                    n ? `Saved to MySQL!` : `Save Changes`,
                  ],
                }),
              ],
            }),
                ...
                (0, h.jsxs)(`div`, {
                  ...
                  children: [
                    (0, h.jsxs)(`div`, {
                      ...
                      children: [
                        (0, h.jsx)(p, {
                          className: `h-4 w-4 ${C ? `text-emerald-600` : `text-slate-400`}`,
                        }),
                        (0, h.jsx)(`span`, {
                        ...
                        (0, h.jsx)(`span`, {
                          className: `inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${C ? `bg-emerald-100 text-emerald-800 border border-emerald-200` : `bg-slate-200 text-slate-600 border border-slate-300`}`,
                          children: C ? `ON (Active)` : `OFF (Disabled)`,
                        }),
                      ],
                    }),
                    (0, h.jsx)(`p`, {
                ...
                (0, h.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, h.jsx)(`button`, {
                      ...
                      role: `switch`,
                      "aria-checked": C,
                      onClick: () => w(`festiveThemeEnabled`, !C),
                      className: `relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2 ${C ? `bg-emerald-600` : `bg-slate-300`}`,
                      children: (0, h.jsx)(`span`, {
                        className: `pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-md ring-0 transition duration-200 ease-in-out ${C ? `translate-x-5` : `translate-x-0`}`,
                      }),
                    }),
                  ],
                }),
                  ...
                  children: [
                    (0, h.jsxs)(`div`, {
                      children: [
                        ...
                        (0, h.jsx)(`input`, {
                          type: `text`,
                          value: e.topBarWeatherCustomText || ``,
                          onChange: (e) => {
                            (w(`topBarWeatherCustomText`, e.target.value),
                              w(`festiveScanMeCustomText`, e.target.value));
                          },
                    ...
                    (0, h.jsxs)(`div`, {
                      children: [
                        ...
                        (0, h.jsxs)(`div`, {
                          className: `flex items-center gap-2`,
                          children: [
                            (0, h.jsx)(c, { className: `h-4 w-4 text-slate-400` }),
                            (0, h.jsx)(`input`, {
                              type: `number`,
                              value: e.topBarSwapDelay || 5,
                              onChange: (e) => w(`topBarSwapDelay`, Number(e.target.value)),
                              placeholder: `5`,
                        ...
                        (0, h.jsxs)(`div`, {
                          ...
                          children: [
                            (0, h.jsx)(`input`, {
                              ...
                              onChange: (e) => {
                                (w(`festiveCategoryTitleColor`, e.target.value),
                                  w(`topBarTextColor`, e.target.value));
                              },
                              className: `h-10 w-12 cursor-pointer rounded border border-slate-200 p-1`,
                            }),
                            (0, h.jsx)(`input`, {
                              type: `text`,
                              value: e.festiveCategoryTitleColor || e.topBarTextColor || ``,
                              onChange: (e) => {
                                (w(`festiveCategoryTitleColor`, e.target.value),
                                  w(`topBarTextColor`, e.target.value));
                              },
                            ...
                            (e.festiveCategoryTitleColor || e.topBarTextColor) &&
                              (0, h.jsxs)(`button`, {
                                type: `button`,
                                onClick: () => {
                                  (w(`festiveCategoryTitleColor`, ``),
                                    w(`topBarTextColor`, ``),
                                    w(`festiveCategoryTitleGradient`, ``),
                                    w(`topBarTextGradient`, ``));
                                },
                                ...
                                children: [
                                  (0, h.jsx)(u, { className: `h-3.5 w-3.5 text-slate-400` }),
                                  `Reset (Black)`,
                                ],
                              }),
                          ],
                          ...
                          children: y.map((t) =>
                            (0, h.jsxs)(
                              `button`,
                              {
                                type: `button`,
                                onClick: () => {
                                  (w(`festiveCategoryTitleColor`, t.hex),
                                    w(`topBarTextColor`, t.hex),
                                    w(`festiveCategoryTitleGradient`, ``),
                                    w(`topBarTextGradient`, ``));
                                },
                                className: `inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold transition-all shadow-xs whitespace-nowrap ${(e.festiveCategoryTitleColor === t.hex || e.topBarTextColor === t.hex) && !D ? `border-2 border-slate-900 bg-slate-900 text-white shadow-sm ring-2 ring-slate-400/20` : `border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 hover:border-slate-300`}`,
                                children: [
                                  (0, h.jsx)(`span`, {
                    ...
                    (0, h.jsxs)(`div`, {
                      children: [
                        ...
                        (0, h.jsxs)(`select`, {
                          value: e.festiveCategoryTitleGradient || e.topBarTextGradient || ``,
                          onChange: (e) => {
                            (w(`festiveCategoryTitleGradient`, e.target.value),
                              w(`topBarTextGradient`, e.target.value));
                          },
                    ...
                    (0, h.jsxs)(`div`, {
                      children: [
                        ...
                        (0, h.jsxs)(`select`, {
                          value: e.customAlertAnimationStyle || `slide-up`,
                          onChange: (e) => w(`customAlertAnimationStyle`, e.target.value),
                          className: `h-10 w-full rounded-lg border border-slate-200 px-3 bg-white text-sm focus:border-slate-900 focus:outline-none`,
                          children: [
                            (0, h.jsx)(`option`, {
                              value: `slide-up`,
                            ...
                            (0, h.jsx)(`option`, { value: `zoom`, children: `🔍 Zoom Scale In` }),
                            (0, h.jsx)(`option`, { value: `flip`, children: `🔄 3D Flip Swap` }),
                          ],
                        }),
                        (0, h.jsx)(`p`, {
                          className: `mt-1 text-[11px] text-slate-400`,
                    ...
                    (0, h.jsxs)(`div`, {
                      children: [
                        ...
                        (0, h.jsxs)(`select`, {
                          value: e.customAlertFontFamily || ``,
                          onChange: (e) => w(`customAlertFontFamily`, e.target.value),
                          className: `h-10 w-full rounded-lg border border-slate-200 px-3 bg-white text-sm focus:border-slate-900 focus:outline-none`,
                          children: [
                            (0, h.jsx)(`option`, {
                              value: ``,
                        ...
                        (0, h.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, h.jsxs)(`span`, {
                              ...
                              children: [e.customAlertFontSize || 14, `px`],
                            }),
                          ],
                        }),
                        (0, h.jsx)(`input`, {
                          ...
                          max: 36,
                          step: 1,
                          value: e.customAlertFontSize || 14,
                          onChange: (e) => w(`customAlertFontSize`, Number(e.target.value)),
                          ...
                          children: [
                            ...
                            C
                              ? (0, h.jsxs)(`span`, {
                                  ...
                                  children: [
                                    (0, h.jsx)(l, { className: `h-3 w-3 animate-spin` }),
                                    `Swapping every `,
                                    e.topBarSwapDelay || 5,
                                    `s`,
                                  ],
                                    ...
                                    `span`,
                                    {
                                      ...
                                      style: {
                                        ...
                                        ...(b
                                          ? {
                                              fontFamily: A,
                                              fontSize: `${e.customAlertFontSize || 14}px`,
                                            }
                                          : {}),
                                        ...j,
                                      },
                                      children: b ? E : `DEL 165 AQI | MUM 82 AQI | KOL 145 AQI`,
                                    },
                                    `topbar-${b ? `custom` : `default`}-${P}`,
                                  ),
                                }),
                              ],
                            }),
                                ...
                                (0, h.jsx)(`div`, {
                                  ...
                                  children: (0, h.jsx)(
                                    `h1`,
                                    {
                                      ...
                                      style: { ...M, ...(b ? { fontFamily: A } : {}), ...j },
                                      children: b ? E : `Country`,
                                    },
                                    `cat-${b ? `custom` : `default`}-${P}`,
                                  ),
                                }),
                              ],
                            }),
                              ...
                              children: [
                                ...
                                (0, h.jsx)(
                                  `span`,
                                  {
                                    ...
                                    style: { ...N, ...j },
                                    children: b ? E : `MARKETS`,
                                  },
                                  `badge-${b ? `custom` : `default`}-${P}`,
                                ),
                              ],
                            }),
                            (0, h.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, h.jsx)(
                                          `h4`,
                                          {
                                            ...
                                            style: { ...M, ...j },
                                            children: b ? E : `SCAN ME`,
                                          },
                                          `scan-${b ? `custom` : `default`}-${P}`,
                                        ),
                                        !b &&
                                          (0, h.jsx)(`p`, {
        ...
        (0, h.jsx)(`div`, {
          ...
          children: (0, h.jsxs)(`button`, {
            onClick: T,
            className: `inline-flex items-center gap-2 rounded-full px-7 py-3 text-sm font-bold text-white shadow-xl transition-all active:scale-95 ${n ? `bg-emerald-600 ring-4 ring-emerald-200` : `bg-slate-900 hover:bg-slate-800 ring-4 ring-slate-300/40`}`,
            children: [
              (0, h.jsx)(d, { className: `h-4 w-4` }),
              n ? `Saved to MySQL!` : `Save Festive & Alert Settings`,
            ],
          }),
        }),
      ],
...
export { b as FestiveSettingsForm };
