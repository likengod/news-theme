...
import { t as r } from "./clock-DkOD1y1x.js";
import { Bt as i, E as a, P as o, _t as s, gt as c, pt as l, w as u } from "./index-CMlkpObp.js";
import { o as d } from "./inbox.functions-WsLb-L71.js";
var f = e(n()),
  p = t();
function m() {
  let [e, t] = (0, f.useState)(!1),
    [n, m] = (0, f.useState)(!1),
    [h, g] = (0, f.useState)({ name: ``, email: ``, subject: `News tip`, message: `` }),
    _ = (e, t) => g((n) => ({ ...n, [e]: t }));
  return (0, p.jsxs)(`div`, {
                    ...
                    : (0, p.jsxs)(`form`, {
                        ...
                        onSubmit: async (e) => {
                          ...
                          try {
                            (await d({ data: h }),
                              t(!0),
                              i.success(`Message sent — we'll reply within one business day.`));
                          } catch (e) {
                            i.error(e.message || `Failed to send message`);
                          } finally {
                            m(!1);
                          }
                        },
                        children: [
                          (0, p.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, p.jsx)(`input`, {
                                ...
                                type: `text`,
                                value: h.name,
                                onChange: (e) => _(`name`, e.target.value),
                          ...
                          (0, p.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, p.jsx)(`input`, {
                                ...
                                type: `email`,
                                value: h.email,
                                onChange: (e) => _(`email`, e.target.value),
                                className: `w-full border border-border bg-background px-3 py-2 text-sm outline-none focus:border-foreground`,
                              }),
                            ],
                          }),
                          (0, p.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, p.jsxs)(`select`, {
                                value: h.subject,
                                onChange: (e) => _(`subject`, e.target.value),
                                className: `w-full border border-border bg-background px-3 py-2 text-sm outline-none focus:border-foreground`,
                                children: [
                                  (0, p.jsx)(`option`, { children: `News tip` }),
                                  (0, p.jsx)(`option`, { children: `Correction` }),
                                  (0, p.jsx)(`option`, { children: `Advertising` }),
                                  (0, p.jsx)(`option`, { children: `Partnership` }),
                                  (0, p.jsx)(`option`, { children: `Careers` }),
                          ...
                          (0, p.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, p.jsx)(`textarea`, {
                                ...
                                rows: 6,
                                value: h.message,
                                onChange: (e) => _(`message`, e.target.value),
                                className: `w-full border border-border bg-background px-3 py-2 text-sm outline-none focus:border-foreground`,
                              }),
                            ],
                          }),
                      ...
                      (0, p.jsxs)(`ul`, {
                        ...
                        children: [
                          ...
                          (0, p.jsxs)(`li`, {
                            ...
                            children: [
                              (0, p.jsx)(l, { className: `h-4 w-4 shrink-0 text-foreground` }),
                              (0, p.jsx)(`a`, {
                          ...
                          (0, p.jsxs)(`li`, {
                            className: `flex items-center gap-3`,
                            children: [
                              (0, p.jsx)(s, { className: `h-4 w-4 shrink-0 text-foreground` }),
                              (0, p.jsx)(`a`, {
                          ...
                          (0, p.jsxs)(`li`, {
                            ...
                            children: [
                              ...
                              (0, p.jsx)(`span`, { children: `Mon – Sat · 9:00 AM – 7:00 PM IST` }),
                            ],
                          }),
                        ],
                      }),
