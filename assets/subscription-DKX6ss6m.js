...
import { Bt as o, Ct as s, P as c, w as l } from "./index-CMlkpObp.js";
import { a as u, d, l as f, r as p } from "./roles-OEcKEDC4.js";
var m = e(n()),
  h = t();
function g() {
  let [e, t] = (0, m.useState)(`monthly`),
    n = r(d),
    [g, _] = (0, m.useState)(() => i()),
    v =
    ...
    b =
      e === `monthly`
        ? (v ? g.subscriptionPriceINRMonthly : g.subscriptionPriceUSDMonthly) ||
          (v ? `149` : `4.99`)
        : (v ? g.subscriptionPriceINRYearly : g.subscriptionPriceUSDYearly) ||
          (v ? `1499` : `49.99`),
    x = e === `monthly` ? `/month` : `/year`,
    S = e === `yearly` ? `Save vs monthly` : `Cancel anytime`,
    C = async (e) => {
      if (!u().find((e) => e.id === `premium`)) return o.error(`Premium role not configured`);
      let t = p();
      [`admin`, `editor`, `journalist`, `author`, `premium`].includes(t) || f(`premium`);
      try {
        await n({ data: {} });
      } catch {}
      o.success(`Welcome to Premium (${e})! Your account is upgraded.`);
    },
    w = g.subscriptionFeatures
      ? g.subscriptionFeatures
          .split(
            `
`,
          )
  ...
  return (0, h.jsxs)(`div`, {
    ...
    children: [
      (0, h.jsx)(c, { showTicker: !1, showBreakingBar: !1 }),
      (0, h.jsxs)(`main`, {
          ...
          (0, h.jsxs)(`header`, {
            ...
            children: [
              ...
              (0, h.jsx)(`h1`, {
                ...
                children: g.subscriptionTitle || `Go Premium`,
              }),
              (0, h.jsx)(`p`, {
              ...
              (0, h.jsx)(`div`, {
                ...
                children: [`monthly`, `yearly`].map((n) =>
                  (0, h.jsx)(
                    `button`,
                    {
                      onClick: () => t(n),
                      className: `rounded-full px-5 py-1.5 text-sm font-semibold capitalize transition ${e === n ? `bg-foreground text-background` : `text-muted-foreground`}`,
                      children: n,
                    },
                    n,
                  ),
          ...
          (0, h.jsxs)(`section`, {
            ...
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  (0, h.jsx)(a, { className: `h-5 w-5` }),
                  (0, h.jsx)(`h2`, {
                    className: `text-xl font-bold`,
                    children: g.subscriptionTitle || `Premium`,
                  }),
                ],
              }),
              (0, h.jsxs)(`p`, {
                ...
                children: w.map((e) =>
                  (0, h.jsxs)(
                    `li`,
                    {
                      ...
                      children: [(0, h.jsx)(s, { className: `mt-0.5 h-4 w-4 shrink-0` }), ` `, e],
                    },
                    e,
                  ),
                ),
              }),
              [`admin`, `editor`, `journalist`, `author`, `premium`].includes(p())
                ? (0, h.jsx)(`div`, {
                ...
                : (0, h.jsxs)(h.Fragment, {
                    children: [
                      (0, h.jsxs)(`button`, {
                        ...
                        children: [`Upgrade to Premium — `, y, b, x],
                      }),
                      (0, h.jsx)(`p`, {
