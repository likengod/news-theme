...
import { Bt as i, P as a, w as o } from "./index-CMlkpObp.js";
import { l as s } from "./inbox.functions-WsLb-L71.js";
var c = e(n()),
  l = t(),
  u = [
...
function d() {
  ...
  return (0, l.jsxs)(`div`, {
    ...
    children: [
      (0, l.jsx)(a, { showTicker: !1, showBreakingBar: !1 }),
      (0, l.jsx)(`main`, {
        ...
        children: (0, l.jsxs)(`section`, {
          ...
          children: [
            ...
            (0, l.jsxs)(`form`, {
              onSubmit: async (n) => {
                if ((n.preventDefault(), !e.name.trim() || !e.email.trim() || !e.pitch.trim())) {
                  i.error(`Name, email and short pitch are required`);
                  return;
                }
                p(!0);
                try {
                  (await s({ data: e }),
                    i.success(
                      `Application received! Our editors will reply within 5 working days.`,
                    ),
                    t({
                      name: ``,
                      email: ``,
                  ...
                  i.error(e.message || `Failed to submit application`);
                } finally {
                  p(!1);
                }
              },
              ...
              children: [
                ...
                (0, l.jsx)(f, {
                  label: `Phone`,
                  value: e.phone,
                  onChange: (e) => n(`phone`, e),
                  placeholder: `+91 00000 00000`,
                }),
                (0, l.jsx)(f, {
                  label: `Alternative Number`,
                  value: e.alternativePhone,
                  onChange: (e) => n(`alternativePhone`, e),
                ...
                (0, l.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, l.jsxs)(`select`, {
                      value: e.tier,
                      onChange: (e) => n(`tier`, e.target.value),
                      ...
                      children: [
                        u.map((e) => (0, l.jsx)(`option`, { value: e.id, children: e.name }, e.id)),
                        (0, l.jsx)(`option`, { value: `fact_checker`, children: `Fact Checker` }),
                        (0, l.jsx)(`option`, { value: `proofreader`, children: `Proofreader` }),
                      ],
                    }),
                  ],
                }),
                ...
                (0, l.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, l.jsx)(`textarea`, {
                      value: e.pitch,
                      onChange: (e) => n(`pitch`, e.target.value),
                      rows: 6,
                      required: !0,
                ...
                (0, l.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, l.jsx)(`button`, {
                      ...
                      children: d ? `Submitting Application…` : `Submit Application`,
                    }),
                  ],
                }),
              ],
