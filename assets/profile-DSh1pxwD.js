...
import { t as i } from "./useServerFn-DmEKdotq.js";
import { t as a } from "./loader-circle-3QDpCwJC.js";
import { t as o } from "./triangle-alert-BoaREb7v.js";
import { t as ee } from "./award-BR0C0Kbe.js";
import { t as te } from "./building-2-CZviYf4Z.js";
import { t as s } from "./crown-DVAr_sIn.js";
import { t as ne } from "./eye-off-BREVkIs3.js";
import { t as c } from "./eye-CvwOJwvW.js";
import { t as re } from "./lock-BxD192lc.js";
...
import { s as pe } from "./inbox.functions-WsLb-L71.js";
import { i as me, n as he, r as ge } from "./journalist-ranks-C1cSOWs-.js";
var h = e(n()),
  g = t(),
  _ = {
    admin: `Admin`,
...
function b() {
  let e = oe(),
    ...
    b = i(le),
    _e = i(pe),
    [x, ve] = (0, h.useState)(`overview`),
    [ye, be] = (0, h.useState)(!0),
    [S, C] = (0, h.useState)(!1),
    [w, xe] = (0, h.useState)(null),
    [T, Se] = (0, h.useState)([]),
    [E, Ce] = (0, h.useState)(0),
    [we, D] = (0, h.useState)(null),
    [O, k] = (0, h.useState)(``),
    [A, j] = (0, h.useState)(``),
    [M, Te] = (0, h.useState)(!1),
    [N, P] = (0, h.useState)(``),
    ...
    [G] = (0, h.useState)(() => he());
  (0, h.useEffect)(() => {
    fe.auth.getSession().then(async ({ data: n }) => {
      if (!n.session?.user) {
        e({ to: `/auth` });
        return;
      }
      D(n.session.access_token);
      let r = n.session.user.id,
        i = localStorage.getItem(`nt:points:${r}`);
      Ce(i === null ? 0 : Number(i));
      try {
        let e = await t({ data: n.session.access_token });
        (xe(e.profile),
          Se(e.roles),
          P(e.profile.phone ?? ``),
          I(e.profile.bank_name ?? ``),
          R(e.profile.bank_account_name ?? ``),
          B(e.profile.bank_account_no ?? ``),
          H(e.profile.bank_ifsc ?? ``),
          W(!!e.profile.delete_requested));
      } catch {
        d.error(`Could not load profile`);
      } finally {
        be(!1);
      }
    });
  }, []);
  let K = T.some((e) => [`journalist`, `author`, `editor`, `admin`].includes(e)),
    q = T.includes(`premium`),
    J = Number(w?.articles_published ?? 0),
    Y = me(J, G),
    X = ge(J, G),
    Oe = X
      ? Math.min(100, Math.round(((J - (Y?.minNews ?? 0)) / (X.minNews - (Y?.minNews ?? 0))) * 100))
      : 100;
  async function ke(e) {
    if ((e.preventDefault(), O.length < 8)) {
    ...
    C(!0);
    try {
      (await n({ data: { password: O } }),
        d.success(`Password changed! Other sessions have been signed out.`),
        k(``),
        j(``));
    } catch (e) {
      d.error(e?.message ?? `Failed to change password`);
    } finally {
      C(!1);
    }
  }
  async function Ae(e) {
    ...
    try {
      (await b({ data: { phone: N } }), d.success(`Phone number updated!`));
    } catch (e) {
      d.error(e?.message ?? `Failed to update phone`);
    } finally {
      C(!1);
    }
  }
  async function je(e) {
    (e.preventDefault(), C(!0));
    try {
      (await b({ data: { bank_name: F, bank_account_name: L, bank_account_no: z, bank_ifsc: V } }),
        d.success(`Bank account details saved!`));
    } catch (e) {
      d.error(e?.message ?? `Failed to save bank details`);
    } finally {
      C(!1);
    }
  }
  async function Me(e) {
    if ((e.preventDefault(), U !== `DELETE`)) {
      d.error(`Type "DELETE" to confirm`);
      return;
    }
    C(!0);
    try {
      (await _e({ data: {} }),
        W(!0),
        d.success(`Deletion request submitted. Our team will review it within 48 hours.`));
    } catch (e) {
      d.error(e?.message ?? `Failed to submit deletion request`);
    } finally {
      C(!1);
    }
  }
  let Z = [
    { key: `overview`, label: `Overview`, icon: f },
    { key: `password`, label: `Change Password`, icon: re },
    ...(K
      ? [
          { key: `phone`, label: `Phone Number`, icon: de },
          { key: `bank`, label: `Bank Account`, icon: te },
        ]
      : []),
    { key: `delete`, label: `Delete Account`, icon: u },
  ];
  if (ye)
    return (0, g.jsx)(`div`, {
      className: `min-h-screen bg-slate-50 flex items-center justify-center`,
      children: (0, g.jsx)(a, { className: `h-8 w-8 animate-spin text-slate-400` }),
    });
  let Q = w?.display_name ?? `Account`,
    Ne =
      Q.split(/\s+/)
        .filter(Boolean)
        .slice(0, 2)
  ...
  return (0, g.jsxs)(`div`, {
    ...
    children: [
      (0, g.jsx)(se, { showTicker: !1, showBreakingBar: !1 }),
      (0, g.jsxs)(`main`, {
              ...
              (0, g.jsxs)(`aside`, {
                ...
                children: [
                  (0, g.jsx)(`div`, {
                    ...
                    children: (0, g.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, g.jsxs)(`span`, {
                          className: `inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-semibold ring-1 ${v[$] ?? v.reader}`,
                          children: [q && (0, g.jsx)(s, { className: `h-3 w-3` }), _[$] ?? $],
                        }),
                        (0, g.jsxs)(r, {
                          to: `/earn-points`,
                          ...
                          children: [
                            (0, g.jsxs)(`span`, { children: [`₹`, E] }),
                            (0, g.jsx)(`span`, {
                              className: `text-xs font-normal text-emerald-600`,
                              children: `Wallet`,
                            }),
                            (0, g.jsx)(m, { className: `h-3.5 w-3.5` }),
                          ],
                        }),
                        !q &&
                          (0, g.jsxs)(r, {
                  ...
                  (0, g.jsx)(`nav`, {
                    ...
                    children: Z.map(({ key: e, label: t, icon: n }) =>
                      (0, g.jsxs)(
                        `button`,
                        {
                          onClick: () => ve(e),
                          className: `flex w-full items-center gap-3 border-b border-slate-100 px-4 py-3 text-sm font-medium transition-colors last:border-b-0 ${x === e ? `bg-slate-900 text-white` : `text-slate-700 hover:bg-slate-50`} ${e === `delete` && x !== `delete` ? `text-red-600 hover:bg-red-50` : ``}`,
                          children: [
                            (0, g.jsx)(n, { className: `h-4 w-4 flex-shrink-0` }),
                            t,
                            x === e && (0, g.jsx)(m, { className: `ml-auto h-3.5 w-3.5` }),
                          ],
                        },
                        e,
                      ),
                                ...
                                (0, g.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, g.jsxs)(`div`, {
                                      ...
                                      children: [
                                        q
                                          ? (0, g.jsx)(s, { className: `h-5 w-5 text-amber-500` })
                                          : (0, g.jsx)(f, { className: `h-5 w-5 text-slate-400` }),
                                        (0, g.jsx)(`span`, {
                                          className: `text-lg font-bold text-slate-900`,
                                          children: q ? `Premium` : `Free`,
                                        }),
                                      ],
                                    }),
                                    !q &&
                                ...
                                (0, g.jsx)(`div`, {
                                  ...
                                  children: T.map((e) =>
                                    (0, g.jsx)(
                                      `span`,
                                      {
                                        className: `inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold ring-1 ${v[e] ?? v.reader}`,
                                        children: _[e] ?? e,
                                      },
                                      e,
                                    ),
                              ...
                              (0, g.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, g.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, g.jsx)(ee, { className: `h-5 w-5 text-blue-600` }),
                                      (0, g.jsx)(`span`, {
                                  ...
                                  Y
                                    ? (0, g.jsxs)(g.Fragment, {
                                        children: [
                                          (0, g.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, g.jsx)(`span`, {
                                                className: `rounded-full px-2.5 py-0.5 text-xs font-bold ring-1 ${y[Y.id] ?? y.bronze}`,
                                                children: Y.name,
                                              }),
                                              (0, g.jsxs)(`span`, {
                                                className: `text-xs text-slate-500`,
                                                children: [J, ` articles published`],
                                              }),
                                            ],
                                          }),
                                          X &&
                                              ...
                                              children: [
                                                ...
                                                (0, g.jsxs)(`p`, {
                                                  ...
                                                  children: [
                                                    ...
                                                    (0, g.jsx)(`strong`, { children: X.name }),
                                                  ],
                                                }),
                                              ],
                                            }),
                                    ...
                                    : (0, g.jsxs)(`p`, {
                                        ...
                                        children: [
                                          `Publish `,
                                          (0, g.jsx)(`strong`, { children: G[0]?.minNews ?? 100 }),
                                          ` articles to earn your first rank badge.`,
                                          (0, g.jsx)(`br`, {}),
                                          (0, g.jsxs)(`span`, {
                                            className: `text-xs text-slate-400`,
                                            children: [J, ` published so far`],
                                          }),
                                        ],
                                      }),
                                ],
                          ...
                          children: [
                                ...
                                (0, g.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, g.jsx)(`button`, {
                                      ...
                                      children: M
                                        ? (0, g.jsx)(ne, { className: `h-4 w-4` })
                                        : (0, g.jsx)(c, { className: `h-4 w-4` }),
                                    }),
                                  ],
                                }),
                              ],
                            ...
                            A &&
                              ...
                              (0, g.jsxs)(`p`, {
                                ...
                                children: [
                                  (0, g.jsx)(ue, { className: `h-3.5 w-3.5` }),
                            ...
                            A &&
                              ...
                              (0, g.jsxs)(`p`, {
                                ...
                                children: [
                                  (0, g.jsx)(ie, { className: `h-3.5 w-3.5` }),
                                  ` Passwords match`,
                                ],
                              }),
                            (0, g.jsxs)(`button`, {
                              type: `submit`,
                              disabled: S || O.length < 8 || O !== A,
                              ...
                              children: [
                                S
                                  ? (0, g.jsx)(a, { className: `h-4 w-4 animate-spin` })
                                  : (0, g.jsx)(l, { className: `h-4 w-4` }),
                                `Save Password`,
                              ],
                            }),
                          ],
                        ...
                        (0, g.jsxs)(`form`, {
                          ...
                          children: [
                            (0, g.jsxs)(`div`, {
                              ...
                              children: [
                                (0, g.jsx)(o, { className: `h-3.5 w-3.5 mt-0.5 flex-shrink-0` }),
                            ...
                            ].map(({ label: e, value: t, set: n, placeholder: r }) =>
                              (0, g.jsxs)(
                                `div`,
                                {
                                  children: [
                                  ...
                                  (0, g.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, g.jsxs)(`ul`, {
                                        ...
                                        children: [
                                          (0, g.jsx)(`li`, {
                                            children: `Your profile and personal data will be permanently removed`,
                                          }),
                                          (0, g.jsx)(`li`, {
                                            children: `Your wallet balance will be forfeited`,
                                          }),
                                          (0, g.jsx)(`li`, {
                                            children: `Your published articles will be retained under an anonymous byline`,
                                          }),
                                          (0, g.jsx)(`li`, {
