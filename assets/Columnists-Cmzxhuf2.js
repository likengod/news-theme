...
import { c as i, i as a, l as o, r as s, t as c } from "./news-data-D07Mj5gy.js";
import { t as l } from "./chevron-left-DittOCGp.js";
import { t as u } from "./copy-DYqJrnFU.js";
import { t as d } from "./eye-CvwOJwvW.js";
import { t as f } from "./play-DEdTvMHq.js";
import { t as p } from "./share-2-BrzAs-U1.js";
import { Ct as m, F as h, M as g, O as _, ct as v, j as y, xt as b } from "./index-CMlkpObp.js";
import { t as x } from "./Views-CepayK_z.js";
var S = e(n()),
  C = t(),
  w = [
    {
...
function T({ initialIndex: e, items: t, onClose: n }) {
  let [r, i] = (0, S.useState)(e),
    [a, s] = (0, S.useState)(!1),
    [f, h] = (0, S.useState)(!1),
    x = (0, S.useRef)(null),
    w = t[r];
  (0, S.useEffect)(() => {
    let e = (e) => {
      (e.key === `Escape` && n(),
        (e.key === `ArrowRight` || e.key === `ArrowDown`) && (i((e) => (e + 1) % t.length), h(!1)),
        (e.key === `ArrowLeft` || e.key === `ArrowUp`) &&
          (i((e) => (e - 1 + t.length) % t.length), h(!1)));
    };
    return (window.addEventListener(`keydown`, e), () => window.removeEventListener(`keydown`, e));
  }, [t.length, n]);
  let T = (e) => {
      let t = e.touches[0];
      x.current = { x: t.clientX, y: t.clientY };
    },
    E = (e) => {
      if (!x.current) return;
      let r = e.changedTouches[0],
        a = r.clientX - x.current.x,
        o = r.clientY - x.current.y;
      if (((x.current = null), Math.abs(o) > Math.abs(a) && Math.abs(o) > 60)) {
        n();
        return;
      }
      Math.abs(a) > 40 &&
        (h(!1), i(a < 0 ? (e) => (e + 1) % t.length : (e) => (e - 1 + t.length) % t.length));
    },
    D = (e) => {
      e.stopPropagation();
      ...
      if (typeof navigator < `u` && navigator.share)
        try {
          await navigator.share({
            title: w.title,
            text: `Watch "${w.title}" on News Theme`,
            url: t,
          });
          return;
        } catch {}
    ...
    k = typeof window < `u` ? window.location.href : ``,
    A = encodeURIComponent(`Watch "${w.title}": ${k}`);
  return (0, C.jsxs)(`div`, {
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, C.jsx)(`button`, {
            ...
            children: (0, C.jsx)(v, { className: `h-5 w-5` }),
          }),
        ],
      }),
      (0, C.jsxs)(`div`, {
          ...
          (0, C.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, C.jsx)(`button`, {
                type: `button`,
                onClick: (e) => {
                  (e.stopPropagation(), h(!1), i((e) => (e - 1 + t.length) % t.length));
                },
                ...
                children: (0, C.jsx)(l, { className: `h-6 w-6` }),
              }),
              (0, C.jsx)(`button`, {
                type: `button`,
                onClick: (e) => {
                  (e.stopPropagation(), h(!1), i((e) => (e + 1) % t.length));
                },
                ...
                children: (0, C.jsx)(b, { className: `h-6 w-6` }),
              }),
            ],
          }),
          (0, C.jsxs)(`div`, {
              ...
              (0, C.jsxs)(`div`, {
                ...
                children: [
                  (0, C.jsx)(`div`, {
                    ...
                    children: (0, C.jsx)(d, { className: `h-5 w-5 text-white/90` }),
                  }),
                  (0, C.jsx)(`span`, {
                    className: `text-[10px] font-bold tracking-wide text-white/90`,
                    children: c(o(w.title)),
                  }),
                ],
              }),
              (0, C.jsxs)(`button`, {
                ...
                children: [
                  (0, C.jsx)(`div`, {
                    ...
                    children: (0, C.jsx)(p, { className: `h-5 w-5` }),
                  }),
                  (0, C.jsx)(`span`, {
                    className: `text-[10px] font-bold tracking-wide text-white/90`,
                    children: `Share`,
              ...
              (0, C.jsxs)(`button`, {
                ...
                children: [
                  (0, C.jsx)(`div`, {
                    className: `flex h-11 w-11 items-center justify-center rounded-full bg-black/70 text-white backdrop-blur border border-white/20 shadow-xl hover:bg-white/20`,
                    children: a
                      ? (0, C.jsx)(m, { className: `h-5 w-5 text-green-400` })
                      : (0, C.jsx)(u, { className: `h-5 w-5` }),
                  }),
                  (0, C.jsx)(`span`, {
                    className: `text-[10px] font-bold tracking-wide text-white/90`,
        ...
        (0, C.jsxs)(`div`, {
          ...
          children: [
            (0, C.jsxs)(`div`, {
              ...
              children: [
                (0, C.jsx)(`h4`, { className: `text-sm font-bold`, children: `Share to` }),
                (0, C.jsx)(`button`, {
                  type: `button`,
                  onClick: () => h(!1),
                  className: `text-white/60 hover:text-white`,
                  children: (0, C.jsx)(v, { className: `h-4 w-4` }),
                }),
              ],
            }),
            (0, C.jsxs)(`div`, {
              ...
              children: [
                (0, C.jsxs)(`a`, {
                  href: `https://api.whatsapp.com/send?text=${A}`,
                  target: `_blank`,
                  rel: `noreferrer`,
                  ...
                  children: [
                    (0, C.jsx)(`div`, {
                      ...
                      children: (0, C.jsx)(g, { className: `h-8 w-8` }),
                    }),
                    (0, C.jsx)(`span`, {
                ...
                (0, C.jsxs)(`a`, {
                  href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(k)}`,
                  target: `_blank`,
                  rel: `noreferrer`,
                  className: `flex flex-col items-center gap-2 hover:opacity-80 transition hover:scale-110`,
                  children: [
                    (0, C.jsx)(`div`, {
                      ...
                      children: (0, C.jsx)(_, { className: `h-8 w-8` }),
                    }),
                    (0, C.jsx)(`span`, {
                      className: `text-[11px] text-white/80 font-medium`,
                      children: `Facebook`,
                ...
                (0, C.jsxs)(`a`, {
                  href: `https://twitter.com/intent/tweet?text=${A}`,
                  target: `_blank`,
                  rel: `noreferrer`,
                  className: `flex flex-col items-center gap-2 hover:opacity-80 transition hover:scale-110`,
                  children: [
                    (0, C.jsx)(`div`, {
                      ...
                      children: (0, C.jsx)(y, { className: `h-8 w-8` }),
                    }),
                    (0, C.jsx)(`span`, {
                      className: `text-[11px] text-white/80 font-medium`,
                      children: `Twitter`,
                ...
                (0, C.jsxs)(`button`, {
                  ...
                  children: [
                    (0, C.jsx)(`div`, {
                      ...
                      children: a
                        ? (0, C.jsx)(m, { className: `h-8 w-8 text-green-400` })
                        : (0, C.jsx)(u, { className: `h-8 w-8` }),
                    }),
                    (0, C.jsx)(`span`, {
                      className: `text-[11px] text-white/80 font-medium`,
                      children: a ? `Copied` : `Copy`,
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, C.jsxs)(`p`, {
            ...
            children: [
              (0, C.jsx)(d, { className: `h-3.5 w-3.5 text-white/90` }),
              (0, C.jsxs)(`span`, { children: [c(o(w.title)), ` views`] }),
              (0, C.jsx)(`span`, { children: `•` }),
              (0, C.jsx)(`span`, { children: `Swipe left/right for next` }),
            ],
          }),
        ],
      }),
...
function E() {
  let e = h(),
    ...
    a = (e) => {
      if (i.current) {
        let t = i.current.clientWidth * 0.75;
        i.current.scrollBy({ left: e === `left` ? -t : t, behavior: `smooth` });
      }
    };
  return (0, C.jsxs)(`section`, {
    ...
    children: [
      (0, C.jsxs)(`div`, {
        ...
        children: [
          (0, C.jsx)(`h3`, {
            ...
            style: { color: e.watch.color, fontSize: `${e.watch.fontSize}px` },
            children: e.watch.title,
          }),
          (0, C.jsx)(r, {
            to: `/reels`,
                    ...
                    (0, C.jsxs)(`div`, {
                      ...
                      children: [
                        (0, C.jsx)(`span`, {
                          ...
                          children: (0, C.jsx)(f, { className: `h-3 w-3 fill-current ml-0.5` }),
                        }),
                        (0, C.jsx)(`span`, {
      ...
      t !== null && (0, C.jsx)(T, { initialIndex: t, items: w, onClose: () => n(null) }),
      (0, C.jsxs)(`div`, {
        className: `hidden md:flex mt-5 items-center justify-between`,
        children: [
          (0, C.jsx)(`div`, { className: `flex-1` }),
          (0, C.jsxs)(`div`, {
            className: `flex items-center gap-2`,
            children: [
              (0, C.jsx)(`span`, { className: `h-1.5 w-1.5 rounded-full bg-foreground` }),
              (0, C.jsx)(`span`, { className: `h-1.5 w-1.5 rounded-full bg-muted-foreground/40` }),
            ],
          }),
          (0, C.jsxs)(`div`, {
            ...
            children: [
              (0, C.jsx)(`button`, {
                ...
                children: (0, C.jsx)(l, { className: `h-4 w-4` }),
              }),
              (0, C.jsx)(`button`, {
                type: `button`,
                onClick: () => a(`right`),
                "aria-label": `Next`,
                className: `flex h-8 w-8 items-center justify-center rounded-full border border-border text-foreground transition hover:bg-foreground hover:text-background`,
                children: (0, C.jsx)(b, { className: `h-4 w-4` }),
              }),
            ],
          }),
        ],
