...
import { t as r } from "./createLucideIcon-hjrkzsgs.js";
import { t as i } from "./award-BR0C0Kbe.js";
import { t as a } from "./gift-DDecJUYd.js";
import { t as o } from "./link-Cwvsn6qC.js";
import { t as s } from "./pencil-BiM_MtGb.js";
import { t as c } from "./plus-CmmBzNRy.js";
import { t as l } from "./save-DCSXhHjW.js";
import { t as u } from "./shield-check-DyBVQKTu.js";
import { t as d } from "./trash-2-Ct1qNc1i.js";
import { Bt as f, M as p, N as m, O as h, ct as g, k as _ } from "./index-CMlkpObp.js";
import { a as v, n as y, t as b } from "./journalist-ranks-C1cSOWs-.js";
import {
  a as x,
  c as S,
  d as C,
          ...
          (0, N.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, N.jsxs)(`button`, {
                ...
                children: [(0, N.jsx)(c, { className: `h-3.5 w-3.5` }), ` Add Task`],
              }),
            ],
          }),
          (0, N.jsxs)(`table`, {
            ...
            children: [
              (0, N.jsx)(`thead`, {
                ...
                children: (0, N.jsxs)(`tr`, {
                  children: [
                    (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Task Title` }),
                    (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Reward Amount` }),
                    (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Daily Cap` }),
                    (0, N.jsx)(`th`, { className: `px-5 py-3 text-right`, children: `Actions` }),
                  ],
                }),
              }),
              (0, N.jsxs)(`tbody`, {
                            ...
                            children: (0, N.jsxs)(`div`, {
                              ...
                              children: [
                                (0, N.jsxs)(`button`, {
                                  ...
                                  children: [(0, N.jsx)(s, { className: `h-3 w-3` }), ` Edit`],
                                }),
                                (0, N.jsxs)(`button`, {
                                  onClick: () => r(e.id),
                                  ...
                                  children: [(0, N.jsx)(d, { className: `h-3 w-3` }), ` Delete`],
                                }),
                              ],
                            }),
                          }),
            ...
            children: [
              (0, N.jsx)(`thead`, {
                ...
                children: (0, N.jsxs)(`tr`, {
                  children: [
                    (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Task Title` }),
                    (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Points Awarded` }),
                    (0, N.jsx)(`th`, { className: `px-5 py-3 text-right`, children: `Actions` }),
                  ],
                }),
              }),
...
function F({ ranks: e, onChangeField: t, onSave: n }) {
      ...
      (0, N.jsxs)(`div`, {
        ...
        children: [
          (0, N.jsxs)(`div`, {
            ...
            children: [
              (0, N.jsx)(i, { className: `h-5 w-5 text-amber-600` }),
              (0, N.jsxs)(`div`, {
                children: [
                  (0, N.jsx)(`h2`, {
          ...
          (0, N.jsxs)(`button`, {
            ...
            children: [(0, N.jsx)(l, { className: `h-4 w-4` }), ` Save Rank Scale`],
          }),
        ],
      }),
      (0, N.jsx)(`div`, {
              ...
              children: [
                ...
                (0, N.jsxs)(`div`, {
                  children: [
                    ...
                    (0, N.jsx)(`input`, {
                      type: `number`,
                      value: e.minNews,
                      onChange: (n) => t(e.id, `minNews`, Number(n.target.value)),
                ...
                (0, N.jsxs)(`div`, {
                  children: [
                    ...
                    (0, N.jsx)(`input`, {
                      type: `number`,
                      value: e.pointsPerNews,
                      onChange: (n) => t(e.id, `pointsPerNews`, Number(n.target.value)),
      ...
      (0, N.jsxs)(`div`, {
        ...
        children: [
          (0, N.jsxs)(`div`, {
            className: `flex items-center gap-2`,
            children: [
              (0, N.jsx)(o, { className: `h-5 w-5 text-blue-600` }),
              (0, N.jsx)(`h2`, {
                className: `text-sm font-bold uppercase tracking-wider text-slate-800`,
          ...
          (0, N.jsxs)(`button`, {
            onClick: () => {
              (D(e),
                r(!0),
                f.success(`Social links saved! Earn-points page will use these URLs.`),
                setTimeout(() => r(!1), 2e3));
            },
            className: `inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-xs font-semibold text-white transition-colors ${n ? `bg-emerald-600` : `bg-slate-900 hover:bg-slate-800`}`,
            children: [(0, N.jsx)(l, { className: `h-4 w-4` }), n ? `Saved!` : `Save Social Links`],
          }),
        ],
      }),
      (0, N.jsx)(`div`, {
            ...
            `div`,
            {
              children: [
                (0, N.jsxs)(`label`, {
                  ...
                  children: [
                    (0, N.jsx)(r, { className: `h-3.5 w-3.5`, style: { color: n.color } }),
                    n.label,
                  ],
                }),
                (0, N.jsx)(`input`, {
                  type: `url`,
                  value: e[n.key],
                  onChange: (r) => t({ ...e, [n.key]: r.target.value }),
...
function R({ claims: e, onApprove: t, onReject: n }) {
  return (0, N.jsxs)(`section`, {
    className: `rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden`,
    children: [
      (0, N.jsxs)(`div`, {
      ...
      (0, N.jsxs)(`table`, {
        ...
        children: [
          (0, N.jsx)(`thead`, {
            ...
            children: (0, N.jsxs)(`tr`, {
              children: [
                (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `User Name` }),
                (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Platform` }),
                (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Submitted Handle` }),
                (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Points` }),
                (0, N.jsx)(`th`, { className: `px-5 py-3`, children: `Status` }),
                (0, N.jsx)(`th`, { className: `px-5 py-3 text-right`, children: `Actions` }),
              ],
            }),
          }),
                    ...
                    children: [
                      ...
                      (0, N.jsx)(`td`, {
                        ...
                        children: (0, N.jsx)(`span`, {
                          className: `inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold ${e.status === `approved` ? `bg-emerald-50 text-emerald-700 border border-emerald-200` : e.status === `rejected` ? `bg-red-50 text-red-700 border border-red-200` : `bg-amber-50 text-amber-800 border border-amber-200`}`,
                          children: e.status,
                        }),
                      }),
                      (0, N.jsx)(`td`, {
                        ...
                        children: (0, N.jsxs)(`div`, {
                          ...
                          children: [
                            (0, N.jsxs)(`button`, {
                              ...
                              children: [(0, N.jsx)(u, { className: `h-3.5 w-3.5` }), ` Approve`],
                            }),
                            (0, N.jsxs)(`button`, {
                              onClick: () => n(e),
                              ...
                              children: [(0, N.jsx)(j, { className: `h-3.5 w-3.5` }), ` Reject`],
                            }),
                          ],
                        }),
                      }),
...
function z({ title: e, onClose: t, children: n }) {
  return (0, N.jsx)(`div`, {
    ...
    children: (0, N.jsxs)(`div`, {
      ...
      children: [
        (0, N.jsxs)(`div`, {
          ...
          children: [
            (0, N.jsx)(`h2`, { className: `text-base font-bold text-slate-900`, children: e }),
            (0, N.jsx)(`button`, {
              onClick: t,
        ...
        (0, N.jsx)(`div`, { className: `space-y-3`, children: n }),
      ],
    }),
  });
}
function B({ onSave: e, onCancel: t }) {
  return (0, N.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, N.jsxs)(`button`, {
        onClick: e,
        className: `inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2 text-xs font-semibold text-white hover:bg-slate-800`,
        children: [(0, N.jsx)(l, { className: `h-3.5 w-3.5` }), ` Save Task`],
      }),
    ],
  });
}
function V() {
  let [e, t] = (0, M.useState)(() => E()),
  ...
  let l = (e) => {
    ...
    u = (e, t, n) => {
      o(i.map((r) => (r.id === e ? { ...r, [t]: n } : r)));
    },
    d = () => {
      (v(i), f.success(`Journalist ranks points scale saved to MySQL!`));
    },
    p = (e) => {
      (O(e.userId, e.id, `approved`),
        f.success(`Claim approved! Awarded +${e.points} pts to user in MySQL`),
        c((t) => t.map((t) => (t.id === e.id ? { ...t, status: `approved` } : t))));
    },
    m = (e) => {
      (O(e.userId, e.id, `rejected`),
        f.success(`Claim rejected`),
        c((t) => t.map((t) => (t.id === e.id ? { ...t, status: `rejected` } : t))));
    },
    h = e.find((e) => e.roleId === n) ?? e[0],
    g = (t) => {
      l(e.map((e) => (e.roleId === h.roleId ? { ...e, ...t } : e)));
    },
    [_, D] = (0, M.useState)(null),
    [k, j] = (0, M.useState)(!1),
    [I, V] = (0, M.useState)(null),
    [H, U] = (0, M.useState)(!1);
  return (0, N.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      (0, N.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, N.jsxs)(`div`, {
            ...
            children: [
              (0, N.jsx)(a, { className: `h-4 w-4 text-amber-600` }),
              ` MySQL Points Engine Active`,
            ],
          }),
        ],
      }),
      (0, N.jsx)(F, { ranks: i, onChangeField: u, onSave: d }),
      (0, N.jsx)(L, {}),
      (0, N.jsxs)(`section`, {
        className: `space-y-4`,
        children: [
          (0, N.jsx)(`div`, {
            ...
            children: e.map((e) =>
              (0, N.jsx)(
                ...
                {
                  onClick: () => r(e.roleId),
                  className: `rounded-lg px-3.5 py-1.5 text-xs font-semibold transition ${n === e.roleId ? `bg-slate-900 text-white shadow-sm` : `bg-slate-100 text-slate-600 hover:bg-slate-200`}`,
                  children: e.label,
                },
                e.roleId,
              ),
          ...
          (0, N.jsx)(P, {
            ...
            onDeleteRecurring: (e) => {
              (g({ recurring: h.recurring.filter((t) => t.id !== e) }), f.success(`Task removed`));
            },
            onAddOneTime: () => {
              (V(A()), U(!0));
            },
            ...
            onDeleteOneTime: (e) => {
              (g({ oneTime: h.oneTime.filter((t) => t.id !== e) }), f.success(`Task removed`));
            },
          }),
        ],
      }),
      (0, N.jsx)(R, { claims: s, onApprove: p, onReject: m }),
      _ &&
        (0, N.jsxs)(z, {
          title: k ? `Add Recurring Task` : `Edit Recurring Task`,
          onClose: () => D(null),
          children: [
            (0, N.jsxs)(`div`, {
              children: [
                ...
                (0, N.jsx)(`input`, {
                  type: `text`,
                  value: _.title,
                  onChange: (e) => D({ ..._, title: e.target.value }),
            ...
            (0, N.jsxs)(`div`, {
              children: [
                ...
                (0, N.jsx)(`input`, {
                  type: `text`,
                  value: _.reward,
                  onChange: (e) => D({ ..._, reward: e.target.value }),
            ...
            (0, N.jsxs)(`div`, {
              children: [
                ...
                (0, N.jsx)(`input`, {
                  type: `text`,
                  value: _.cap,
                  onChange: (e) => D({ ..._, cap: e.target.value }),
            ...
            (0, N.jsx)(B, {
              onSave: () => {
                if (!_ || !_.title.trim()) return f.error(`Title is required`);
                let e = h.recurring;
                (g({ recurring: k ? [...e, _] : e.map((e) => (e.id === _.id ? _ : e)) }),
                  f.success(k ? `Task added` : `Task updated`),
                  D(null));
              },
              onCancel: () => D(null),
            }),
      ...
      I &&
        (0, N.jsxs)(z, {
          title: H ? `Add One-Time Task` : `Edit One-Time Task`,
          onClose: () => V(null),
          children: [
            (0, N.jsxs)(`div`, {
              children: [
                ...
                (0, N.jsx)(`input`, {
                  type: `text`,
                  value: I.title,
                  onChange: (e) => V({ ...I, title: e.target.value }),
            ...
            (0, N.jsxs)(`div`, {
              children: [
                ...
                (0, N.jsx)(`input`, {
                  type: `number`,
                  value: I.points,
                  onChange: (e) => V({ ...I, points: Number(e.target.value) || 0 }),
            ...
            (0, N.jsx)(B, {
              onSave: () => {
                if (!I || !I.title.trim()) return f.error(`Title is required`);
                let e = h.oneTime;
                (g({ oneTime: H ? [...e, I] : e.map((e) => (e.id === I.id ? I : e)) }),
                  f.success(H ? `Task added` : `Task updated`),
                  V(null));
              },
              onCancel: () => V(null),
            }),
