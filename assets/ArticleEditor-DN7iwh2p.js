...
import { t as r } from "./useServerFn-DmEKdotq.js";
import { d as i } from "./font-config-B3PEHeid.js";
import { a } from "./AdSettingsContext-BPuWF7kc.js";
import { a as o, o as s } from "./news-data-D07Mj5gy.js";
import { t as c } from "./createLucideIcon-hjrkzsgs.js";
import { t as l } from "./loader-circle-3QDpCwJC.js";
import { t as u } from "./sparkles-C_7tCNub.js";
import { t as d } from "./coins-DPDIZQ5S.js";
import { n as f, t as p } from "./youtube-B9oEMaad.js";
import { t as m } from "./file-text-CRjBQ2A8.js";
import { t as h } from "./image-fjgNV0aQ.js";
import { t as g } from "./link-2-BS_Fbo2N.js";
import { t as _ } from "./link-Cwvsn6qC.js";
import { n as v, t as y } from "./video-DGx4KmKx.js";
import { t as b } from "./settings-CBU21Oic.js";
import { t as x } from "./share-2-BrzAs-U1.js";
import { t as S } from "./type-ChedjNk3.js";
import { t as C } from "./upload-DHoeWDIp.js";
import { Bt as w, ct as T, ft as E, gt as D, kt as O, lt as k } from "./index-CMlkpObp.js";
import { t as A } from "./ai.functions-D5-VhyLq.js";
import { a as j, t as M } from "./journalist.functions-dwNZ1_v5.js";
import { n as N } from "./MediaField-DPta6ix_.js";
var P = c(`code-xml`, [
  ...
  U = c(`minus`, [[`path`, { d: `M5 12h14`, key: `1ays0h` }]]),
  W = c(`palette`, [
    [
      `path`,
      {
  ...
  Y = e(n()),
  X = t();
function ee({ value: e, onChange: t }) {
  let n = (0, Y.useRef)(null),
    r = (0, Y.useRef)(null),
    a = (0, Y.useRef)(e),
    [o, s] = Y.useState([`Default`]);
  ((0, Y.useEffect)(() => {
    n.current && e !== a.current && ((n.current.innerHTML = e || ``), (a.current = e || ``));
  }, [e]),
    (0, Y.useEffect)(() => {
    ...
    (0, Y.useEffect)(() => {
      let e = i();
      if (e && e.fonts) {
        let t = e.fonts.map((e) => e.name || e.family);
        s([`Default`, ...new Set(t)]);
      }
      let t = () => {
        let e = i();
      ...
      return (
        window.addEventListener(`nt:fonts-updated`, t),
        () => window.removeEventListener(`nt:fonts-updated`, t)
      );
    }, []));
  let c = () => {
      if (!n.current) return;
    ...
    l = () => n.current?.focus(),
    u = (e, t) => {
      (l(), document.execCommand(e, !1, t), c());
    },
    d = (e) => {
      (l(), document.execCommand(`insertHTML`, !1, e), c());
    },
    m = () => {
      let e = prompt(`Image URL (or use Upload)`);
      e &&
        d(
          `<img src="${e}" alt="${prompt(`Alt text (optional)`) || `image`}" style="max-width:100%;height:auto;border-radius:8px;margin:12px 0" />`,
        );
    },
    _ = (e) => {
      if (!e) return;
      ...
      ((t.onload = () =>
        d(
          `<img src="${t.result}" alt="image" style="max-width:100%;height:auto;border-radius:8px;margin:12px 0" />`,
        )),
        t.readAsDataURL(e));
    },
    b = () => {
      let e = prompt(`YouTube URL (e.g. https://youtu.be/abc123)`);
      if (!e) return;
      let t = e.match(/(?:youtu\.be\/|v=|shorts\/|embed\/)([\w-]{11})/);
      d(
        `<div style="position:relative;width:100%;aspect-ratio:16/9;margin:12px 0"><iframe src="https://www.youtube.com/embed/${t ? t[1] : e}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:0;border-radius:8px"></iframe></div><p><br/></p>`,
      );
    },
    x = () => {
      let e = prompt(`Facebook video URL`);
      e &&
        d(
          `<div style="position:relative;width:100%;aspect-ratio:16/9;margin:12px 0"><iframe src="https://www.facebook.com/plugins/video.php?href=${encodeURIComponent(e)}&show_text=false" style="position:absolute;inset:0;width:100%;height:100%;border:0;border-radius:8px" scrolling="no" allowfullscreen></iframe></div><p><br/></p>`,
        );
    },
    w = () => {
      let e = prompt(`Direct video URL (.mp4, .webm)`);
      e &&
        d(
          `<video src="${e}" controls style="max-width:100%;border-radius:8px;margin:12px 0"></video><p><br/></p>`,
        );
    },
    T = () => {
      let e = prompt(`URL`);
    ...
    E = () => d(`<hr style="border:0;border-top:1px solid #e2e8f0;margin:16px 0" />`),
    D = () => u(`formatBlock`, `blockquote`),
    O = [`12`, `14`, `16`, `18`, `20`, `24`, `28`, `32`],
    k = [`#1A1110`, `#E11D48`, `#16A34A`, `#2563EB`, `#D97706`, `#7C3AED`, `#64748B`, `#FFFFFF`],
    A = (e) => {
      if (e === `Default`) return;
      let t = window.getSelection();
      if (!t || t.rangeCount === 0 || t.isCollapsed) {
        d(`<span style="font-family:'${e}',serif">text</span>`);
        return;
      }
      let n = t.getRangeAt(0),
        r = document.createElement(`span`);
      ((r.style.fontFamily = `'${e}', serif`),
    ...
    j = (e) => {
      let t = window.getSelection();
      if (!t || t.rangeCount === 0 || t.isCollapsed) {
        d(`<span style="font-size:${e}px">text</span>`);
        return;
      }
      let n = t.getRangeAt(0),
        r = document.createElement(`span`);
    ...
    M = ({ onClick: e, title: t, children: n }) =>
      (0, X.jsx)(`button`, {
        type: `button`,
    ...
    N = () => (0, X.jsx)(`span`, { className: `mx-1 h-5 w-px bg-slate-300` }),
    J = (n.current?.innerText || ``).trim().split(/\s+/).filter(Boolean).length;
  return (0, X.jsxs)(`div`, {
    ...
    children: [
      (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsx)(M, {
            onClick: () => u(`formatBlock`, `p`),
            title: `Paragraph`,
            children: (0, X.jsx)(G, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`formatBlock`, `h2`),
            title: `Heading 2`,
            children: (0, X.jsx)(z, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`formatBlock`, `h3`),
            title: `Heading 3`,
            children: (0, X.jsx)(B, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(N, {}),
          (0, X.jsx)(`select`, {
            onChange: (e) => {
              (A(e.target.value), (e.target.value = `Default`));
            },
            onMouseDown: (e) => e.stopPropagation(),
            title: `Font family`,
            className: `h-8 rounded border border-slate-200 bg-white px-1.5 text-xs`,
            children: o.map((e) => (0, X.jsx)(`option`, { value: e, children: e }, e)),
          }),
          (0, X.jsxs)(`select`, {
            onChange: (e) => {
              (e.target.value !== `Size` && j(e.target.value), (e.target.value = `Size`));
            },
            onMouseDown: (e) => e.stopPropagation(),
            title: `Font size`,
            className: `h-8 rounded border border-slate-200 bg-white px-1.5 text-xs`,
            children: [
              (0, X.jsx)(`option`, { children: `Size` }),
              O.map((e) => (0, X.jsx)(`option`, { children: e }, e)),
            ],
          }),
          (0, X.jsxs)(`div`, {
            className: `relative inline-flex items-center gap-0.5`,
            children: [
              (0, X.jsx)(S, { className: `ml-1 h-3.5 w-3.5 text-slate-500` }),
              k.map((e) =>
                (0, X.jsx)(
                  `button`,
                  {
              ...
              (0, X.jsx)(`button`, {
                ...
                onMouseDown: (e) => e.preventDefault(),
                onClick: () => {
                  let e = prompt(`Hex color, e.g. #ff0000`);
                  e && u(`foreColor`, e);
                },
          ...
          (0, X.jsx)(M, {
            onClick: () => u(`bold`),
            title: `Bold`,
            children: (0, X.jsx)(R, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`italic`),
            title: `Italic`,
            children: (0, X.jsx)(V, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`underline`),
            title: `Underline`,
            children: (0, X.jsx)(q, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () =>
              d(
          ...
          (0, X.jsx)(N, {}),
          (0, X.jsx)(M, {
            onClick: () => u(`justifyLeft`),
            title: `Align left`,
            children: (0, X.jsx)(L, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`justifyCenter`),
            title: `Align center`,
            children: (0, X.jsx)(F, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`justifyRight`),
            title: `Align right`,
          ...
          (0, X.jsx)(M, {
            onClick: D,
            title: `Quote`,
            children: (0, X.jsx)(K, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`insertUnorderedList`),
            title: `Bullet list`,
            children: (0, X.jsx)(v, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: () => u(`insertOrderedList`),
            title: `Numbered list`,
          ...
          (0, X.jsx)(M, {
            onClick: E,
            title: `Divider`,
            children: (0, X.jsx)(U, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(M, {
            onClick: T,
            title: `Link`,
          ...
          (0, X.jsx)(M, {
            ...
            title: `Upload image`,
            children: (0, X.jsx)(C, { className: `h-4 w-4` }),
          }),
          (0, X.jsx)(`input`, {
            ref: r,
            type: `file`,
            ...
            hidden: !0,
            onChange: (e) => {
              (_(e.target.files?.[0]), r.current && (r.current.value = ``));
            },
          }),
          (0, X.jsx)(M, {
            onClick: b,
            title: `Embed YouTube`,
            children: (0, X.jsx)(p, { className: `h-4 w-4 text-red-600` }),
          }),
          (0, X.jsx)(M, {
            onClick: x,
            title: `Embed Facebook video`,
            children: (0, X.jsx)(f, { className: `h-4 w-4 text-blue-600` }),
          }),
          (0, X.jsx)(M, {
            onClick: w,
            title: `Embed video file`,
            children: (0, X.jsx)(y, { className: `h-4 w-4` }),
          }),
          (0, X.jsxs)(`span`, {
...
function Z({ value: e, onChange: t, hint: n }) {
  return (0, X.jsxs)(`div`, {
    ...
    children: [
      (0, X.jsx)(`div`, {
        ...
        children: e
          ? (0, X.jsx)(`img`, { src: e, alt: `preview`, className: `h-full w-full object-cover` })
          : (0, X.jsxs)(`div`, {
              className: `text-center text-slate-400`,
              children: [
                (0, X.jsx)(h, { className: `mx-auto h-6 w-6` }),
                (0, X.jsx)(`span`, { className: `mt-1 block text-xs`, children: `No image` }),
              ],
            }),
      }),
      (0, X.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, X.jsx)(N, {
            ...
            recommendedSize: `1600Ã—900 px (16:9)`,
          }),
        ],
      }),
    ],
...
function te({ journalistId: e, journalistName: t, onSelect: n }) {
  let i = r(j),
    [a, o] = (0, Y.useState)(``),
    [s, c] = (0, Y.useState)(!1),
    ...
    f = async () => {
      let e = a.trim();
      if (e.length < 2) return w.error(`Enter a name or User ID (min 2 chars)`);
      c(!0);
      try {
        let t = await i({ data: { query: e } });
        (d(t), t.length === 0 && w.info(`No matching journalist found`));
      } catch (e) {
        w.error(e instanceof Error ? e.message : `Search failed`);
      } finally {
        c(!1);
      }
    };
  return (0, X.jsxs)(`div`, {
    children: [
      (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsx)(J, { className: `h-3.5 w-3.5` }),
          ` Journalist`,
          (0, X.jsx)(`span`, {
            className: `font-normal normal-case text-slate-400`,
            children: `â€” assign a journalist from your users by name or User ID`,
          }),
        ],
      }),
      e
        ? (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, X.jsx)(ne, { publicUserId: e, displayName: t }),
            ],
          })
        : (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, X.jsxs)(`button`, {
                ...
                children: [
                  s
                    ? (0, X.jsx)(l, { className: `h-3.5 w-3.5 animate-spin` })
                    : (0, X.jsx)(E, { className: `h-3.5 w-3.5` }),
                  `Search`,
                ],
              }),
            ],
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, X.jsxs)(`p`, {
                          ...
                          children: [`ID: `, e.publicUserId, ` â€¢ `, e.role],
                        }),
                      ],
                    }),
                    (0, X.jsx)(`span`, {
                      className: `shrink-0 rounded-full border px-2 py-0.5 text-[11px] font-medium ${e.verified ? `border-emerald-200 bg-emerald-50 text-emerald-700` : `border-slate-200 bg-slate-100 text-slate-600`}`,
                      children: e.verified ? `Verified` : e.role,
                    }),
                  ],
                }),
              },
...
function ne({ publicUserId: e, displayName: t }) {
  let n = r(M),
    [i, a] = (0, Y.useState)(``),
    [o, s] = (0, Y.useState)(``),
    [c, u] = (0, Y.useState)(!1),
      ...
      (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsxs)(`span`, {
            ...
            children: [
              (0, X.jsx)(k, { className: `h-3.5 w-3.5 text-emerald-600` }),
              ` Award points to `,
              t || `journalist`,
            ],
          }),
          f !== null &&
            (0, X.jsxs)(`span`, {
              ...
              children: [(0, X.jsx)(d, { className: `h-3 w-3` }), ` Wallet: `, f],
            }),
        ],
      }),
      (0, X.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, X.jsxs)(`button`, {
            ...
            onClick: async () => {
              ...
              if (!Number.isFinite(t) || t === 0) return w.error(`Enter a non-zero point amount`);
              u(!0);
              try {
                let r = await n({ data: { publicUserId: e, points: t, reason: o || void 0 } });
                (p(r.newBalance),
                  a(``),
                  s(``),
                  w.success(
                    `${t > 0 ? `Added` : `Deducted`} ${Math.abs(t)} pts Â· new balance ${r.newBalance}`,
                  ));
              } catch (e) {
                w.error(e instanceof Error ? e.message : `Failed to award points`);
              } finally {
                u(!1);
              }
            },
            ...
            children: [
              c
                ? (0, X.jsx)(l, { className: `h-3.5 w-3.5 animate-spin` })
                : (0, X.jsx)(d, { className: `h-3.5 w-3.5` }),
              `Add to wallet`,
            ],
          }),
        ],
...
var $ = {
  ...
  re = () => (typeof window < `u` ? window.location.host : `northeasttimeline.com`),
  ie = (e) => [re(), `news`, e.slug || s(e.title) || `news-title`].filter(Boolean).join(`/`),
  ae = (e) => {
    if (!e) return ``;
    try {
      ...
      if (typeof e == `string`) return e.slice(0, 16).replace(` `, `T`);
    } catch (e) {
      console.error(`formatDateTimeLocal error:`, e);
    }
    return ``;
  };
function oe({ initial: e, onClose: t, onSave: n }) {
  let r = a(),
    i = [`Enterprise`, `Enterprise+`].includes(r.licenseType || ``) || r.licenseRole === `VIP`,
    [c, d] = (0, Y.useState)({
      ...e,
      title: e.title || ``,
      slug: e.slug || ``,
      category: e.category || `Northeast`,
      city: e.city || ``,
      state: e.state || ``,
      country: e.country || ``,
      author: e.author || ``,
      ...
      views: e.views || 0,
      featured: !!e.featured,
      newsType: e.newsType || `Standard`,
      journalistId: e.journalistId || ``,
      journalistName: e.journalistName || ``,
      access_level: e.access_level || `Free`,
    }),
    [f, p] = (0, Y.useState)(`content`),
    [g, v] = (0, Y.useState)(!1),
    [y, S] = (0, Y.useState)(``),
    [C, E] = (0, Y.useState)(`Normal`),
    [k, j] = (0, Y.useState)(!1),
    [M, N] = (0, Y.useState)(null),
    P = async () => {
      if (!y.trim()) {
        w.error(`Please enter news instructions.`);
        return;
      }
      (j(!0), N(null));
      try {
        (N(
          await A({
            data: { instructions: y, style: C, availableTags: (await O()).map((e) => e.name) },
          }),
        ),
          w.success(`Content generated! Please review.`));
      } catch (e) {
        w.error(e.message || `Failed to generate AI content.`);
      } finally {
        j(!1);
      }
    },
    F = () => {
      M &&
        (d((e) => ({
          ...e,
          content: M.body || e.content,
          excerpt: M.excerpt || e.excerpt,
          city: M.location?.city || e.city,
          state: M.location?.state || e.state,
          country: M.location?.country || e.country,
          metaTitle: M.metaTitle || e.metaTitle,
          metaDescription: M.metaDescription || e.metaDescription,
          tags: Array.isArray(M.tags) && M.tags.length > 0 ? M.tags.join(`,`) : e.tags,
        })),
        v(!1),
        w.success(`AI Content applied successfully!`));
    },
    I = (e, t) => d((n) => ({ ...n, [e]: t })),
    L = (e) => {
      if (!c.title.trim()) return w.error(`Title is required`);
      if (!c.author.trim()) return w.error(`Author is required`);
      n(e ? { ...c, status: e } : c);
    },
    R = ie(c),
    z = () => (typeof window < `u` ? window.location.protocol : `http:`),
    B = async () => {
      try {
        let e = z();
        (await navigator.clipboard.writeText(`${e}//${R}`), w.success(`URL copied`));
      } catch {
        w.error(`Copy failed`);
      }
    },
    V = [
      { id: `content`, label: `Content`, icon: m },
      { id: `media`, label: `Media`, icon: h },
      { id: `seo`, label: `SEO & Social`, icon: x },
      { id: `settings`, label: `Settings`, icon: b },
    ];
  return (0, X.jsxs)(`div`, {
      ...
      (0, X.jsxs)(`div`, {
        ...
        children: [
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      (0, X.jsxs)(`div`, {
                        ...
                        children: [
                          (0, X.jsxs)(`span`, {
                            ...
                            children: [
                              (0, X.jsx)(u, { className: `h-3 w-3` }),
                              ` `,
                              e.title ? `Edit` : `New`,
                            ],
                          }),
                          (0, X.jsx)(`span`, {
                            className: `rounded-full border px-2 py-0.5 text-[11px] font-medium ${$[c.status]}`,
                            children: c.status,
                          }),
                        ],
                      }),
                      (0, X.jsx)(`h2`, {
                        ...
                        children: c.title || `Untitled article`,
                      }),
                      (0, X.jsxs)(`div`, {
                        className: `mt-2 flex items-center gap-2 text-xs`,
                        children: [
                          (0, X.jsx)(_, { className: `h-3.5 w-3.5 text-slate-400` }),
                          (0, X.jsx)(`a`, {
                            href: `${z()}//${R}`,
                            target: `_blank`,
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`button`, {
                        ...
                        children: (0, X.jsx)(T, { className: `h-4 w-4` }),
                      }),
                    ],
                  }),
                ],
              ...
              (0, X.jsx)(`div`, {
                ...
                children: V.map((e) => {
                  ...
                  return (0, X.jsxs)(
                    ...
                    {
                      onClick: () => p(e.id),
                      className: `inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium transition-all ${f === e.id ? `bg-slate-900 text-white shadow-sm` : `border border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:text-slate-900`}`,
                      children: [(0, X.jsx)(t, { className: `h-3.5 w-3.5` }), ` `, e.label],
                    },
                    e.id,
                  );
                }),
                  ...
                  children: [
                      ...
                      children: [
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsx)(`input`, {
                            value: c.title,
                            onChange: (t) => {
                              (I(`title`, t.target.value), e.title || I(`slug`, s(t.target.value)));
                            },
                          ...
                          children: [
                            (0, X.jsx)(Q, {
                              ...
                              children: (0, X.jsx)(`select`, {
                                value: c.category,
                                onChange: (e) => I(`category`, e.target.value),
                                className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-slate-900 focus:outline-none`,
                                children: o.map((e) => (0, X.jsx)(`option`, { children: e }, e)),
                              }),
                            }),
                            (0, X.jsx)(Q, {
                              ...
                              children: (0, X.jsx)(`input`, {
                                value: c.slug,
                                onChange: (e) => I(`slug`, s(e.target.value)),
                          ...
                          children: [
                            (0, X.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, X.jsx)(`span`, {
                                  className: `font-normal normal-case text-slate-400`,
                                  children: `â€” builds the URL's location segment`,
                                }),
                              ],
                            }),
                            (0, X.jsxs)(`div`, {
                              ...
                              children: [
                                (0, X.jsx)(`input`, {
                                  value: c.city,
                                  onChange: (e) => I(`city`, e.target.value),
                                  placeholder: `City`,
                                  className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-slate-900 focus:outline-none`,
                                }),
                                (0, X.jsx)(`input`, {
                        ...
                        (0, X.jsx)(`div`, {
                          ...
                          children: (0, X.jsxs)(Q, {
                            ...
                            children: [
                              (0, X.jsx)(`textarea`, {
                                value: c.excerpt,
                                onChange: (e) => I(`excerpt`, e.target.value),
                                rows: 2,
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, X.jsx)(ee, { value: c.content, onChange: (e) => I(`content`, e) }),
                      ],
                    }),
                  ],
                }),
                ...
                (0, X.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, X.jsx)(`div`, {
                      className: `rounded-xl border border-slate-200 bg-white p-5 shadow-sm`,
                      children: (0, X.jsx)(Q, {
                        label: `Open Graph Image ${c.ogImage ? `` : `(defaults to Featured Image)`}`,
                        children: (0, X.jsx)(Z, {
                          value: c.ogImage,
                          onChange: (e) => I(`ogImage`, e),
                      ...
                      children: [
                        (0, X.jsxs)(Q, {
                          ...
                          children: [
                            (0, X.jsx)(`input`, {
                              value: c.metaTitle,
                              onChange: (e) => I(`metaTitle`, e.target.value),
                              placeholder: c.title || `Defaults to article title`,
                              className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-slate-900 focus:outline-none`,
                            }),
                            (0, X.jsxs)(`span`, {
                              className: `mt-1 block text-xs text-slate-400`,
                              children: [c.metaTitle.length, ` / 60 chars recommended`],
                            }),
                          ],
                        }),
                        (0, X.jsxs)(Q, {
                          ...
                          children: [
                            (0, X.jsx)(`textarea`, {
                              ...
                              onChange: (e) => I(`metaDescription`, e.target.value),
                              rows: 3,
                            ...
                            (0, X.jsxs)(`span`, {
                              className: `mt-1 block text-xs text-slate-400`,
                              children: [c.metaDescription.length, ` / 160 chars recommended`],
                            }),
                          ],
                        }),
                        (0, X.jsx)(Q, {
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, X.jsx)(`p`, {
                          ...
                          children: c.metaTitle || c.title || `Article title`,
                        }),
                        (0, X.jsx)(`p`, {
                        ...
                        (0, X.jsx)(`p`, {
                          ...
                          children:
                            c.metaDescription || c.excerpt || `Article description preview...`,
                        }),
                      ],
                    }),
                  ],
                  ...
                  children: [
                      ...
                      children: [
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsxs)(`select`, {
                            value: c.newsType,
                            onChange: (e) => I(`newsType`, e.target.value),
                            className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                            children: [
                              (0, X.jsx)(`option`, { children: `Standard` }),
                              (0, X.jsx)(`option`, { children: `Breaking` }),
                              (0, X.jsx)(`option`, { children: `Featured` }),
                              (0, X.jsx)(`option`, { children: `Exclusive` }),
                              (0, X.jsx)(`option`, { children: `Opinion` }),
                              (0, X.jsx)(`option`, { children: `Video` }),
                            ],
                          }),
                        }),
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsx)(`input`, {
                            value: c.author,
                            onChange: (e) => I(`author`, e.target.value),
                            className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                          }),
                        }),
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsxs)(`select`, {
                            ...
                            className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                            children: [
                              (0, X.jsx)(`option`, { children: `Published` }),
                              (0, X.jsx)(`option`, { children: `Draft` }),
                              (0, X.jsx)(`option`, { children: `Review` }),
                            ],
                          }),
                        }),
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsxs)(`select`, {
                            ...
                            onChange: (e) => I(`access_level`, e.target.value),
                            className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                            children: [
                              (0, X.jsx)(`option`, { value: `Free`, children: `Free (All users)` }),
                              (0, X.jsx)(`option`, {
                                value: `Premium`,
                        ...
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsx)(`input`, {
                            type: `datetime-local`,
                            value: ae(c.date),
                            onChange: (e) => I(`date`, e.target.value),
                            className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                          }),
                        }),
                        i &&
                          (0, X.jsx)(Q, {
                            ...
                            children: (0, X.jsx)(`input`, {
                              ...
                              min: 0,
                              value: c.views,
                              onChange: (e) => I(`views`, Number(e.target.value) || 0),
                              className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm`,
                            }),
                          }),
                        (0, X.jsx)(Q, {
                          ...
                          children: (0, X.jsxs)(`label`, {
                            ...
                            children: [
                              (0, X.jsx)(`input`, {
                                type: `checkbox`,
                                checked: c.featured,
                                onChange: (e) => I(`featured`, e.target.checked),
                              }),
                    ...
                    (0, X.jsx)(`div`, {
                      ...
                      children: (0, X.jsx)(te, {
                        ...
                        journalistName: c.journalistName,
                        onSelect: (e) => {
                          (I(`journalistId`, e?.publicUserId ?? ``),
                            I(`journalistName`, e?.displayName ?? ``),
                            e?.displayName && I(`author`, e.displayName));
                        },
                      }),
                    }),
                  ],
          ...
          (0, X.jsx)(`div`, {
            ...
            children: (() => {
              let e = [`content`, `media`, `seo`, `settings`],
                n = e.indexOf(f),
                r = f === `settings`,
                i = n === 0,
                a = e[n - 1],
                ...
                children: [
                  (0, X.jsxs)(`p`, {
                    ...
                    children: [
                      ...
                      e.length,
                      ` Â·`,
                      r ? `Review & publish` : `Complete this step, then continue`,
                    ],
                  }),
                  (0, X.jsxs)(`div`, {
                    className: `flex gap-2`,
                    children: [
                      ...
                      !r &&
                        (0, X.jsxs)(`button`, {
                          ...
                          children: [
                            `Next:`,
                            o === `media` ? `Media` : o === `seo` ? `SEO & Social` : `Settings`,
                          ],
                        }),
                      r &&
                        (0, X.jsxs)(X.Fragment, {
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsxs)(`h3`, {
                    ...
                    children: [
                      (0, X.jsx)(u, { className: `h-5 w-5 text-indigo-600` }),
                      ` AI News Assistant`,
                    ],
                  }),
                  (0, X.jsx)(`button`, {
                          ...
                          (0, X.jsxs)(`div`, {
                            children: [
                              ...
                              (0, X.jsxs)(`select`, {
                                ...
                                children: [
                                  (0, X.jsx)(`option`, { value: `Normal`, children: `Normal` }),
                                  (0, X.jsx)(`option`, {
                                    value: `Corporate`,
                                    children: `Corporate`,
                                  }),
                                  (0, X.jsx)(`option`, { value: `Business`, children: `Business` }),
                                  (0, X.jsx)(`option`, { value: `Friendly`, children: `Friendly` }),
                                  i && (0, X.jsx)(`option`, { value: `5 ws`, children: `5 ws` }),
                                ],
                              }),
                            ],
                          }),
                      ...
                      (0, X.jsx)(`div`, {
                        ...
                        children: (0, X.jsx)(`button`, {
                          ...
                          children: k
                            ? (0, X.jsxs)(X.Fragment, {
                                children: [
                                  (0, X.jsx)(l, { className: `h-4 w-4 animate-spin` }),
                                  ` Generating Article...`,
                                ],
                              })
                            : `Generate Article`,
                            ...
                            (0, X.jsxs)(`div`, {
                              children: [
                                ...
                                (0, X.jsx)(`div`, {
                                  className: `text-sm bg-slate-50 p-2 rounded border border-slate-200`,
                                  children:
                                    [M.location?.city, M.location?.state, M.location?.country]
                                      .filter(Boolean)
                                      .join(`, `) || `N/A`,
                                }),
                              ],
...
export { oe as default, $ as statusStyle };
