...
import { t } from "./link-D3mkMh6f.js";
import { t as n } from "./createLucideIcon-hjrkzsgs.js";
import { t as r } from "./badge-check-YFvADS2B.js";
import { t as i } from "./square-check-big-BVbR8GPf.js";
import { t as a } from "./arrow-right-EjAn-Xgu.js";
import { t as o } from "./award-BR0C0Kbe.js";
import { t as s } from "./shield-alert-nwcqNZiD.js";
import { t as c } from "./trending-up-DcjF89x0.js";
import { P as l, b as u, ft as d, mt as f, w as p } from "./index-CMlkpObp.js";
var m = n(`circle-question-mark`, [
  ...
  y = e();
function b() {
  let { settings: e } = u.useLoaderData(),
    n = (e.workWithUsRules || ``)
      .split(
        `
`,
...
`,
  ...
  return (0, y.jsxs)(`div`, {
    ...
    children: [
      (0, y.jsx)(l, { showTicker: !1, showBreakingBar: !1 }),
      (0, y.jsxs)(`main`, {
        ...
        children: [
              ...
              (0, y.jsxs)(`p`, {
                ...
                children: [
                  (0, y.jsxs)(`span`, {
                    ...
                    children: [
                      (0, y.jsx)(`span`, {
                        className: `absolute inline-flex h-full w-full animate-ping rounded-full bg-foreground opacity-30`,
                      }),
                      (0, y.jsx)(`span`, {
          ...
          (0, y.jsxs)(`section`, {
            ...
            children: [
              (0, y.jsxs)(`div`, {
                ...
                children: [
                  (0, y.jsx)(v, { className: `h-6 w-6 text-foreground` }),
                  (0, y.jsx)(`h2`, {
              ...
              (0, y.jsx)(`div`, {
                ...
                children: b.map((e, t) => {
                  let n = x[t % x.length],
                    r = e.indexOf(`:`),
                    i = r > -1 ? e.slice(0, r).trim() : e,
                    a = r > -1 ? e.slice(r + 1).trim() : ``;
                  return (0, y.jsxs)(
                    `div`,
                    {
                      className: `rounded-xl border border-border bg-background p-6 transition-shadow hover:shadow-md`,
                      children: [
                        (0, y.jsx)(n, { className: `h-6 w-6 mb-4 text-foreground/70` }),
                        (0, y.jsx)(`h3`, { className: `font-bold text-lg`, children: i }),
                        (0, y.jsx)(`p`, {
              ...
              (0, y.jsxs)(`section`, {
                ...
                children: [
                  (0, y.jsxs)(`div`, {
                    ...
                    children: [
                      (0, y.jsx)(o, { className: `h-6 w-6 text-foreground` }),
                      (0, y.jsx)(`h2`, {
                    ...
                    children: S.map((e, t) => {
                      ...
                      return (0, y.jsxs)(
                        `li`,
                        {
                          ...
                          children: [
                            (0, y.jsx)(`span`, {
                              className: `flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${n.bg} ${n.text} font-bold text-lg`,
                              children: n.letter,
                            }),
                            (0, y.jsxs)(`div`, {
                              children: [
                                  ...
                                  children: o.map((e, t) =>
                                    (0, y.jsxs)(
                                      `li`,
                                      {
                                        ...
                                        children: [
                                          (0, y.jsx)(a, {
                                            className: `h-4 w-4 shrink-0 ${n.icon}`,
                                          }),
                                          ` `,
                                          e,
                                        ],
                  ...
                  (0, y.jsxs)(`section`, {
                    ...
                    children: [
                      (0, y.jsxs)(`div`, {
                        className: `flex items-center gap-3 mb-6`,
                        children: [
                          (0, y.jsx)(_, { className: `h-6 w-6 text-foreground` }),
                          (0, y.jsx)(`h2`, {
                            className: `text-2xl font-bold tracking-tight`,
                      ...
                      (0, y.jsx)(`div`, {
                        ...
                        children: (0, y.jsx)(`p`, {
                          ...
                          children:
                            e.workWithUsIdCardReq ||
                            (0, y.jsxs)(y.Fragment, {
                              children: [
                                (0, y.jsx)(`strong`, { children: `Requirement:` }),
                                ` You must reach the `,
                                (0, y.jsx)(`span`, {
                  ...
                  (0, y.jsxs)(`section`, {
                    ...
                    children: [
                      (0, y.jsxs)(`div`, {
                        className: `flex items-center gap-3 mb-6`,
                        children: [
                          (0, y.jsx)(s, { className: `h-6 w-6 text-foreground` }),
                          (0, y.jsx)(`h2`, {
                            className: `text-2xl font-bold tracking-tight`,
                ...
                `div`,
                {
                  ...
                  children: [
                    (0, y.jsx)(`span`, {
                      ...
                      children: (0, y.jsx)(n, { className: `h-6 w-6` }),
                    }),
                    (0, y.jsx)(`h3`, { className: `mt-6 text-xl font-bold`, children: s }),
                    c &&
                      (0, y.jsx)(`p`, {
          ...
          (0, y.jsxs)(`section`, {
            ...
            children: [
              (0, y.jsxs)(`div`, {
                className: `flex items-center gap-3 mb-8`,
                children: [
                  (0, y.jsx)(m, { className: `h-6 w-6 text-foreground` }),
                  (0, y.jsx)(`h2`, {
                    className: `text-2xl font-bold tracking-tight`,
              ...
              (0, y.jsx)(`div`, {
                ...
                children: E.map((e, t) => {
                  let n = e.indexOf(`?:`),
                    r = n > -1 ? e.slice(0, n + 1).trim() : e,
                    i = n > -1 ? e.slice(n + 2).trim() : ``,
                    a = e.indexOf(`? :`),
                    o = a > -1 ? e.slice(0, a + 1).trim() : r,
                    s = a > -1 ? e.slice(a + 3).trim() : i,
                    c = e.indexOf(`:`),
                    l = s ? o : c > -1 ? e.slice(0, c).trim() : e,
                    u = s || (c > -1 ? e.slice(c + 1).trim() : ``);
                  return (0, y.jsxs)(
                    `div`,
                    {
                      className: `space-y-2`,
                      children: [
                        (0, y.jsx)(`h4`, { className: `font-bold text-foreground`, children: l }),
                        (0, y.jsx)(`p`, {
          ...
          (0, y.jsx)(`div`, {
            ...
            children: (0, y.jsxs)(t, {
              ...
              children: [`Apply Now `, (0, y.jsx)(a, { className: `h-4 w-4` })],
            }),
          }),
        ],
      }),
