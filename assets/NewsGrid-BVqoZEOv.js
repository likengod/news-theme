...
import { a as i, i as a, n as o, r as s } from "./hero-markets-DsSniPpX.js";
import { n as c, u as l } from "./news-data-D07Mj5gy.js";
import { F as u } from "./index-CMlkpObp.js";
var d = e(n()),
  f = t(),
  p = [
    {
  ...
  m = d.memo(function ({ articles: e = [], usedIds: t }) {
    let n = u(),
      i = e.length > 0,
      a = (0, d.useMemo)(() => {
        let t = new Map();
        for (let n of e) {
          let e = (n.category || `Others`).toLowerCase().trim(),
            r = t.get(e) || [];
          (r.push(n), t.set(e, r));
        }
        return t;
    ...
    return (0, f.jsx)(`section`, {
      ...
      children: (0, f.jsx)(`div`, {
        ...
        children: (0, d.useMemo)(() => {
          let r = new Set(t || []);
          return p.map((t, o) => {
            let s = n.newsGridColumns[o]?.category;
            if (i && s) {
              let n = (s === `Auto (Latest)` ? `northeast` : s).toLowerCase().trim(),
                i = a.get(n) || [],
                l = i.filter((e) => !r.has(e.id));
              if (l.length < 7) {
                let e = i.filter((e) => r.has(e.id));
                for (let t of e)
                  if ((l.some((e) => e.id === t.id) || l.push(t), l.length >= 7)) break;
              }
              if (l.length < 7) {
                let t = e.filter((e) => !l.some((t) => t.id === e.id) && !r.has(e.id));
                for (let e of t) if ((l.push(e), l.length >= 7)) break;
              }
              if (l.length < 7) {
                let t = e.filter((e) => !l.some((t) => t.id === e.id)),
                  n = t.length > 0 ? (o * 3) % t.length : 0,
                  r = [...t.slice(n), ...t.slice(0, n)];
                for (let e of r) if ((l.push(e), l.length >= 7)) break;
              }
              if (l.length > 0) {
                let e = l[0],
                  n = l.slice(1, 7);
                return (
                  l.slice(0, 7).forEach((e) => r.add(e.id)),
                  {
                    ...t,
                    img: c(e.featuredImage || e.img, o),
                    lead: e.title,
                    slug: e.slug,
                    items: n.map((e) => ({ title: e.title, slug: e.slug })),
                  }
                );
              }
            }
            return { ...t, slug: `sample`, items: t.items.map((e) => ({ ...e, slug: `sample` })) };
          });
        }, [e, n.newsGridColumns, i, a, t]).map((e, t) => {
          let i = n.newsGridColumns[t];
          return (0, f.jsxs)(
            `div`,
            {
              ...
              children: [
                (0, f.jsx)(`h3`, {
                  ...
                  style: { color: i.color, fontSize: `${i.fontSize}px` },
                  children: i.title,
                }),
                (0, f.jsxs)(r, {
                  to: `/news/$slug`,
