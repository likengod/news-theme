...
import { t as r } from "./loader-circle-3QDpCwJC.js";
import { n as i, t as a } from "./youtube-B9oEMaad.js";
import { t as o } from "./play-DEdTvMHq.js";
import { a as s, i as c, o as l } from "./reels-config-DsBSc8kp.js";
var u = e(n());
function d() {
  let [e, t] = (0, u.useState)(() => s());
  return ((0, u.useEffect)(() => l(() => t(s())), []), e);
}
var f = t();
function p() {
  let e = d(),
  ...
  if (
    ...
    }, [(0, u.useMemo)(() => JSON.stringify(e), [e])]),
    !e.enabled || (!s && t.length === 0))
  )
    return null;
  let h = e.provider === `youtube` ? a : i,
    g = e.provider === `youtube` ? `#FF0000` : `#1877F2`;
    ...
    children: [
      (0, f.jsxs)(`div`, {
        ...
        children: [
          (0, f.jsxs)(`h2`, {
            ...
            children: [(0, f.jsx)(h, { className: `h-5 w-5`, style: { color: g } }), e.title],
          }),
          (0, f.jsxs)(`span`, {
            className: `text-[11px] uppercase tracking-widest text-muted-foreground`,
            children: [
              e.provider === `youtube` ? `YouTube Shorts` : `Facebook Reels`,
              e.mode !== `manual` && ` · Auto`,
            ],
          }),
        ],
      ...
      s && t.length === 0
        ? (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(r, { className: `mr-2 h-4 w-4 animate-spin` }),
              ` Loading latest reels…`,
            ],
          })
        : (0, f.jsx)(`div`, {
                          ...
                          children: [
                            ...
                            (0, f.jsx)(`div`, {
                              ...
                              children: (0, f.jsx)(`div`, {
                                ...
                                children: (0, f.jsx)(o, { className: `h-5 w-5 fill-white ml-0.5` }),
                              }),
                            }),
                            (0, f.jsx)(`div`, {
