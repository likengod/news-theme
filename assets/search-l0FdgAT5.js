...
import "./hero-markets-DsSniPpX.js";
import { a as i } from "./news-data-D07Mj5gy.js";
import { P as a, ft as o, v as s, w as c } from "./index-CMlkpObp.js";
import { t as l } from "./Views-CepayK_z.js";
var u = e(n()),
  d = t();
function f(e) {
  ...
  let t = [
    ...
    n = e.getUTCDate();
  return `${t[e.getUTCMonth()]} ${n}, ${e.getUTCFullYear()}`;
}
function p() {
  let e = s.useSearch(),
    t = s.useLoaderData(),
    ...
    [h, g] = (0, u.useState)(n),
    [_, v] = (0, u.useState)(p),
    { items: y, total: b, totalPages: x } = t;
  return (0, d.jsxs)(`div`, {
          ...
          (0, d.jsxs)(`header`, {
            ...
            children: [
                ...
                children:
                  n || p !== `All`
                    ? (0, d.jsxs)(d.Fragment, {
                        children: [
                          `Results`,
                          n && (0, d.jsxs)(d.Fragment, { children: [` for “`, n, `”`] }),
                          p !== `All` && (0, d.jsxs)(d.Fragment, { children: [` in “`, p, `”`] }),
                        ],
                      })
              ...
              (0, d.jsx)(`p`, {
                ...
                children:
                  n || p !== `All`
                    ? `${b.toLocaleString()} stories found — latest first.`
              ...
              (0, d.jsxs)(`form`, {
                onSubmit: (e) => {
                  (e.preventDefault(),
                    window.location.assign(
                      `/search?q=${encodeURIComponent(h.trim())}&category=${encodeURIComponent(_)}&page=1`,
                    ));
                },
                ...
                children: [
                  (0, d.jsxs)(`div`, {
                    ...
                    children: [
                      (0, d.jsx)(o, { className: `ml-3 h-4 w-4 text-muted-foreground` }),
                      (0, d.jsx)(`input`, {
                        autoFocus: !0,
                        value: h,
                  ...
                  (0, d.jsx)(`div`, {
                    ...
                    children: (0, d.jsxs)(`select`, {
                      ...
                      children: [
                        (0, d.jsx)(`option`, { value: `All`, children: `All Categories` }),
                        i
                          .filter((e) => e !== `Others`)
                          .map((e) => (0, d.jsx)(`option`, { value: e, children: e }, e)),
                      ],
                    }),
                  }),
                  (0, d.jsx)(`button`, {
                      ...
                      children: [
                        (0, d.jsx)(r, {
                          ...
                          children: (0, d.jsx)(`img`, {
                            src: e.featuredImage || `/assets/hero-markets-DB4EwqS2.jpg`,
                            alt: e.title,
                          ...
                          children: [
                            ...
                            (0, d.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, d.jsx)(`span`, {
                                  className: `ml-auto`,
                                  children: (0, d.jsx)(l, { count: e.views }),
                                }),
                              ],
                            }),
                          ],
