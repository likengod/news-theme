...
import { l as u, t as d, u as f } from "./news-data-D07Mj5gy.js";
import { t as p } from "./createLucideIcon-hjrkzsgs.js";
import { t as m } from "./chevron-left-DittOCGp.js";
import { t as h } from "./copy-DYqJrnFU.js";
import { t as g } from "./eye-CvwOJwvW.js";
import { t as _ } from "./play-DEdTvMHq.js";
import { t as v } from "./share-2-BrzAs-U1.js";
import {
  Ct as y,
  M as b,
  O as x,
...
import { a as O, c as k } from "./reels-config-DsBSc8kp.js";
var A = p(`film`, [
  ...
  try {
    ...
    return (
      e &&
        ...
        e.urls.forEach((n, r) => {
          let i = k(e.provider, n);
          i &&
            t.push({
              title: `Featured Reel #` + (r + 1),
              duration: `1:00`,
              img: M[r % M.length],
              kicker: `Featured`,
              embedSrc: i,
...
var F = t();
function I({ initialIndex: e, items: t, onClose: n }) {
  let [r, i] = (0, j.useState)(e),
    [a, o] = (0, j.useState)(!1),
    [s, c] = (0, j.useState)(!1),
    l = (0, j.useRef)(null),
    f = t[r] || t[0];
  ...
  (0, j.useEffect)(() => {
    let e = (e) => {
      (e.key === `Escape` && n(),
        (e.key === `ArrowRight` || e.key === `ArrowDown`) && (i((e) => (e + 1) % t.length), c(!1)),
        (e.key === `ArrowLeft` || e.key === `ArrowUp`) &&
          (i((e) => (e - 1 + t.length) % t.length), c(!1)));
    };
  ...
  let p = (e) => {
    ...
    _ = (e) => {
      ...
      let r = e.changedTouches[0],
        a = r.clientX - l.current.x,
        o = r.clientY - l.current.y;
      if (((l.current = null), Math.abs(o) > Math.abs(a) && Math.abs(o) > 60)) {
        n();
        return;
      }
      Math.abs(a) > 40 &&
        (c(!1), i(a < 0 ? (e) => (e + 1) % t.length : (e) => (e - 1 + t.length) % t.length));
    },
    S = (e) => {
      e.stopPropagation();
      ...
      if (typeof navigator < `u` && navigator.share)
        try {
          await navigator.share({
            title: f.title,
            text: `Watch ` + f.title + ` on Vanguard News`,
            url: t,
          });
          return;
        } catch {}
    ...
    E = typeof window < `u` ? window.location.href : ``,
    O = encodeURIComponent(`Watch ` + f.title + `: ` + E),
    k = f.views || u(f.title);
  return (0, F.jsxs)(`div`, {
      ...
      (0, F.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, F.jsx)(`button`, {
            ...
            children: (0, F.jsx)(C, { className: `h-5 w-5` }),
          }),
        ],
      }),
      (0, F.jsxs)(`div`, {
          ...
          (0, F.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, F.jsx)(`button`, {
                type: `button`,
                onClick: (e) => {
                  (e.stopPropagation(), c(!1), i((e) => (e - 1 + t.length) % t.length));
                },
                ...
                children: (0, F.jsx)(m, { className: `h-6 w-6` }),
              }),
              (0, F.jsx)(`button`, {
                type: `button`,
                onClick: (e) => {
                  (e.stopPropagation(), c(!1), i((e) => (e + 1) % t.length));
                },
                ...
                children: (0, F.jsx)(D, { className: `h-6 w-6` }),
              }),
            ],
          }),
          (0, F.jsxs)(`div`, {
            ...
            children: [
              (0, F.jsxs)(`div`, {
                ...
                children: [
                  (0, F.jsx)(`div`, {
                    ...
                    children: (0, F.jsx)(g, { className: `h-5 w-5 text-white/90` }),
                  }),
                  (0, F.jsx)(`span`, {
              ...
              (0, F.jsxs)(`button`, {
                ...
                children: [
                  (0, F.jsx)(`div`, {
                    className: `flex h-11 w-11 items-center justify-center rounded-full bg-black/70 text-white backdrop-blur border border-white/20 shadow-xl`,
                    children: (0, F.jsx)(v, { className: `h-5 w-5 text-white/90` }),
                  }),
                  (0, F.jsx)(`span`, {
              ...
              s &&
                (0, F.jsxs)(`div`, {
                  ...
                  children: [
                    (0, F.jsx)(`a`, {
                      href: `https://api.whatsapp.com/send?text=` + O,
                      target: `_blank`,
                      ...
                      children: (0, F.jsx)(b, { className: `h-5 w-5` }),
                    }),
                    (0, F.jsx)(`a`, {
                      href: `https://www.facebook.com/sharer/sharer.php?u=` + encodeURIComponent(E),
                      target: `_blank`,
                      rel: `noopener noreferrer`,
                      ...
                      children: (0, F.jsx)(x, { className: `h-4 w-4` }),
                    }),
                    (0, F.jsx)(`a`, {
                      href: `https://twitter.com/intent/tweet?text=` + O,
                      target: `_blank`,
                      rel: `noopener noreferrer`,
                      ...
                      title: `Share on X`,
                      children: (0, F.jsx)(T, { className: `h-4 w-4` }),
                    }),
                    (0, F.jsx)(`button`, {
                      type: `button`,
                      onClick: S,
                      ...
                      title: `Copy Link`,
                      children: a
                        ? (0, F.jsx)(y, { className: `h-4 w-4 text-green-400` })
                        : (0, F.jsx)(h, { className: `h-4 w-4` }),
                    }),
                  ],
                }),
            ],
...
function L() {
  let e = w.useSearch().page ?? 1,
    t = (0, j.useMemo)(() => P(), []),
    n = t.length,
    i = Math.max(1, Math.ceil(n / 20)),
    a = Math.min(Math.max(1, e), i),
    o = (a - 1) * 20,
    s = t.slice(o, o + 20),
    ...
    children: [
      ...
      (0, F.jsxs)(`main`, {
        ...
        children: [
                  ...
                  (0, F.jsxs)(`div`, {
                    ...
                    children: [
                      (0, F.jsx)(`span`, {
                        ...
                        children: (0, F.jsx)(A, { className: `h-3.5 w-3.5 md:h-4 md:w-4` }),
                      }),
                      (0, F.jsx)(`h1`, {
                ...
                `div`,
                {
                  ...
                  children: [
                        ...
                        (0, F.jsxs)(`div`, {
                          ...
                          children: [
                            (0, F.jsx)(`span`, {
                              ...
                              children: (0, F.jsx)(_, {
                                className: `h-2.5 w-2.5 sm:h-3 sm:w-3 fill-current ml-0.5`,
                              }),
                            }),
                            (0, F.jsx)(`span`, {
                    ...
                    (0, F.jsxs)(`div`, {
                      ...
                      children: [
                        (0, F.jsx)(g, {
                          className: `h-2.5 w-2.5 sm:h-3 sm:w-3 text-muted-foreground/70`,
                        }),
                        (0, F.jsx)(`span`, { children: d(r) }),
                      ],
                    }),
                  ],
                },
            ...
            (0, F.jsxs)(`div`, {
              ...
              children: [
                (0, F.jsxs)(`div`, {
                  ...
                  children: [
                    `Showing `,
                    (0, F.jsx)(`strong`, { className: `text-foreground`, children: o + 1 }),
                    `–`,
                    (0, F.jsx)(`strong`, {
                      className: `text-foreground`,
                      children: Math.min(o + 20, n),
                    }),
                    ` of`,
                    ` `,
                    (0, F.jsx)(`strong`, { className: `text-foreground`, children: n }),
                    ` reels`,
                  ],
                }),
                (0, F.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    Array.from({ length: i }, (e, t) => t + 1).map((e) =>
                      (0, F.jsx)(
                        r,
                        {
                          to: `/reels`,
                          search: { page: e },
                          className: `flex h-9 w-9 items-center justify-center rounded-lg text-xs font-bold transition ${e === a ? `bg-foreground text-background shadow` : `border border-border text-foreground hover:bg-muted`}`,
                          children: e,
                        },
                        e,
                      ),
                    ...
                    a < i
                      ? (0, F.jsxs)(r, {
                          ...
                          className: `flex h-9 items-center gap-1 rounded-lg border border-border px-3 text-xs font-semibold text-foreground transition hover:bg-foreground hover:text-background`,
                          children: [
                            (0, F.jsx)(`span`, { children: `Next` }),
                            (0, F.jsx)(D, { className: `h-4 w-4` }),
                          ],
                        })
                      : (0, F.jsxs)(`span`, {
                          className: `flex h-9 items-center gap-1 rounded-lg border border-border/40 px-3 text-xs font-semibold text-muted-foreground/40 cursor-not-allowed`,
          ...
          c !== null && (0, F.jsx)(I, { initialIndex: c, items: t, onClose: () => l(null) }),
        ],
      }),
      (0, F.jsx)(E, {}),
    ],
