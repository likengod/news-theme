...
import { t as r } from "./folder-open-B4k9x8X8.js";
import { t as i } from "./image-fjgNV0aQ.js";
import { t as a } from "./plus-CmmBzNRy.js";
import { t as o } from "./trash-2-Ct1qNc1i.js";
import { t as s } from "./upload-DHoeWDIp.js";
import { Bt as c, St as l, ct as u, ft as d } from "./index-CMlkpObp.js";
import { n as f, r as p, t as m } from "./media-library-DM9U1yyP.js";
var h = e(n()),
  g = t();
function _({
  label: e,
  ...
  ((0, h.useEffect)(() => {
    ...
    (0, h.useEffect)(() => {
      if (!j) return;
      let e = (e) => {
        N.current?.contains(e.target) || M(!1);
      };
      return (
  ...
  let P = async (e) => {
      if (e) {
        try {
          (n((await p(e, d)).dataUrl), c.success(`Uploaded to file manager`));
        } catch {
    ...
    F = (0, g.jsx)(`div`, {
      className:
        _ ??
        `flex ${b ? `h-20` : `h-28`} items-center justify-center overflow-hidden rounded-md border border-dashed ${y ? `border-slate-700 bg-slate-900` : `border-slate-200 bg-slate-50`}`,
      children: t
        ? (0, g.jsx)(`img`, {
            src: t,
            alt: e ?? `preview`,
        ...
        : (0, g.jsxs)(`div`, {
            ...
            children: [
              (0, g.jsx)(i, { className: `mx-auto h-5 w-5` }),
              (0, g.jsx)(`span`, {
          ...
          children: [
            (0, g.jsxs)(`div`, {
              ...
              children: [
                (0, g.jsxs)(`button`, {
                  ...
                  children: [
                    (0, g.jsx)(a, { className: `h-3.5 w-3.5` }),
                    t ? `Change image` : `Add image`,
                    (0, g.jsx)(l, { className: `h-3.5 w-3.5 opacity-60` }),
                  ],
                }),
                j &&
                  (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      (0, g.jsxs)(`button`, {
                        ...
                        children: [
                          (0, g.jsx)(s, { className: `h-3.5 w-3.5` }),
                          (0, g.jsxs)(`div`, {
                            children: [
                              (0, g.jsx)(`div`, {
                      ...
                      (0, g.jsxs)(`button`, {
                        ...
                        children: [
                          (0, g.jsx)(r, { className: `h-3.5 w-3.5` }),
                          (0, g.jsxs)(`div`, {
                            children: [
                              (0, g.jsx)(`div`, {
                                className: `font-medium`,
            ...
            t &&
              ...
              (0, g.jsxs)(`button`, {
                ...
                children: [(0, g.jsx)(o, { className: `h-3.5 w-3.5` }), ` Remove`],
              }),
          ],
        }),
        (f || x) &&
    ...
    children: [
      e &&
        (0, g.jsxs)(`div`, {
          ...
          children: [
            (0, g.jsx)(`span`, { className: `text-xs font-medium text-slate-700`, children: e }),
            t &&
              (0, g.jsxs)(`button`, {
                type: `button`,
                onClick: () => n(``),
                className: `inline-flex items-center gap-1 text-[11px] text-red-600 hover:underline`,
                children: [(0, g.jsx)(u, { className: `h-3 w-3` }), ` Remove`],
              }),
          ],
        }),
      D
        ...
        : C
          ? (0, g.jsxs)(`div`, {
              ...
              children: [
                F,
                (0, g.jsx)(`div`, { className: `min-w-32 flex-1 space-y-1.5`, children: I }),
              ],
            })
          : (0, g.jsxs)(g.Fragment, { children: [F, I] }),
      k &&
        (0, g.jsx)(v, {
          accept: m,
          onClose: () => A(!1),
          onPick: (e) => {
            (n(e.dataUrl), A(!1), c.success(`Image selected from library`));
          },
        }),
    ],
  });
}
function v({ onClose: e, onPick: t, accept: n }) {
  let [r, a] = (0, h.useState)(() => f.list()),
    [o, s] = (0, h.useState)(``);
  (0, h.useEffect)(() => {
    let e = () => a(f.list());
    return (
  ...
  let c = n.includes(`image`),
    l = r.filter(
      (e) =>
        !(
          (c && !e.type.startsWith(`image/`)) ||
          (o && !e.name.toLowerCase().includes(o.toLowerCase()))
        ),
    );
  return (0, g.jsx)(`div`, {
          ...
          children: [
            (0, g.jsxs)(`div`, {
              children: [
                ...
                (0, g.jsxs)(`p`, {
                  className: `text-[11px] text-slate-500`,
                  children: [l.length, ` of `, r.length, ` file`, r.length === 1 ? `` : `s`],
                }),
              ],
            }),
            (0, g.jsx)(`button`, {
              ...
              "aria-label": `Close`,
              children: (0, g.jsx)(u, { className: `h-4 w-4` }),
            }),
          ],
        }),
        (0, g.jsx)(`div`, {
          ...
          children:
            l.length === 0
              ? (0, g.jsxs)(`div`, {
                  ...
                  children: [
                    (0, g.jsx)(i, { className: `mb-2 h-8 w-8 text-slate-300` }),
