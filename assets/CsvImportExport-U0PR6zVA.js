import { n as e, s as t, t as n } from "./jsx-runtime-CF8L0Gwd.js";
import { t as r } from "./react-YNiYR47K.js";
import { t as i } from "./download-DycZgMgQ.js";
import { t as a } from "./upload-DHoeWDIp.js";
...
var s = t(
    e((e, t) => {
      ((n, r) => {
          ...
          ((this._handle = null),
            ...
            (this.parseChunk = function (e, n) {
              ...
              if (this.isFirstChunk && 0 < r) {
                ...
                ((t ||= ((a = this._config.quoteChar || `"`), this._handle.guessLineEndings(e, a))),
        ...
        function d(e) {
          ((e ||= {}).chunkSize || (e.chunkSize = s.LocalChunkSize), l.call(this, e));
          var t,
            n,
          ...
          ((this.stream = function (e) {
            ((this._input = e),
              ...
              r
                ? (((t = new FileReader()).onload = x(this._chunkLoaded, this)),
                  (t.onerror = x(this._chunkError, this)))
            ...
            (this._readChunk = function () {
              var e = this._input,
                i =
                  (this._config.chunkSize &&
                    ((i = Math.min(this._start + this._config.chunkSize, this._input.size)),
        ...
        function m(e) {
          ...
          function C() {
            if (
              ...
              if (y)
                if (Array.isArray(y.data[0])) {
                  for (var t = 0; w() && t < y.data.length; t++) y.data[t].forEach(n);
                  y.data.splice(0, 1);
                } else y.data.forEach(n);
              function n(t, n) {
                ((t = c(t)), S(e.transformHeader) && (t = e.transformHeader(t, n)), v.push(t));
              }
            }
            function n(t, n) {
                    ...
                    ((t) => (
                      ...
                      ? n === `true` ||
                        ...
                        (n !== `false` &&
                          n !== `FALSE` &&
                          (((e) => {
                            if (l.test(e) && ((e = parseFloat(e)), o < e && e < a)) return 1;
                          })(n)
                            ? parseFloat(n)
                            : u.test(n)
                              ? new Date(n)
                              : n === ``
                                ...
                                : n))
                      : n)(
                    (s = e.header ? (i >= v.length ? `__parsed_extra` : v[i]) : s),
                    (c = e.transform ? e.transform(c, s) : c),
                  );
                s === `__parsed_extra` ? ((r[s] = r[s] || []), r[s].push(c)) : (r[s] = c);
              }
              return (
                e.header &&
                  (i > v.length
                    ? T(
                        `FieldMismatch`,
                        `TooManyFields`,
                        `Too many fields: expected ` + v.length + ` fields but parsed ` + i,
                        p + n,
                      )
                    : i < v.length &&
                      T(
                        `FieldMismatch`,
                        `TooFewFields`,
                        `Too few fields: expected ` + v.length + ` fields but parsed ` + i,
                        p + n,
                      )),
                r
              );
            ...
            y &&
              ...
              !y.data.length || Array.isArray(y.data[0])
                ? ((y.data = y.data.map(n)), (i = y.data.length))
                : (y.data = n(y.data, 0)),
          ...
          function T(e, t, n, r) {
            ((e = { type: e, code: t, message: n }), r !== void 0 && (e.row = r), y.errors.push(e));
          }
          (S(e.step) &&
            ((i = e.step),
            (e.step = function (t) {
              ((y = t),
                w()
                  ...
                  : (C(),
                    y.data.length !== 0 &&
                      ((f += t.data.length),
                      e.preview && f > e.preview ? n.abort() : ((y.data = y.data[0]), i(y, d)))));
            })),
            (this.parse = function (i, a, o) {
              var c = e.quoteChar || `"`,
                c =
                  ...
                  e.delimiter
                    ? S(e.delimiter) &&
                      ((e.delimiter = e.delimiter(i)), (y.meta.delimiter = e.delimiter))
                    : ((c = ((t, n, r, i, a) => {
                        var o, c, l, u;
                        ...
                        for (var d = 0; d < a.length; d++) {
                          for (
                            var f,
                              ...
                              v =
                                ((l = void 0),
                                new g({ comments: i, delimiter: p, newline: n, preview: 10 }).parse(
                                  t,
                                )),
                              y = 0;
                            y < v.data.length;
                            ...
                            r && x(v.data[y])
                              ...
                              : ((f = v.data[y].length),
                                ...
                                l === void 0
                                  ? (l = f)
                                  : 0 < f && ((m += Math.abs(f - l)), (l = f)));
                          (0 < v.data.length && (h /= v.data.length - _),
                            (c === void 0 || m <= c) &&
                              (u === void 0 || u < h) &&
                              1.99 < h &&
                              ((c = m), (o = p), (u = h)));
            ...
            (this.pause = function () {
              ((m = !0), n.abort(), (t = S(e.chunk) ? `` : t.substring(n.getCharIndex())));
            }),
            (this.resume = function () {
              d.streamer._halted
...
`
        ...
        function g(e) {
          var t = (e ||= {}).delimiter,
            ...
            f = d;
          if (
            (e.escapeChar !== void 0 && (f = e.escapeChar),
...
`));
          ...
          ((this.parse = function (s, g, _) {
            ...
            var v = s.length,
              ...
              D = (p = 0);
            if (!s) return z();
            if (o || (!1 !== o && s.indexOf(d) === -1)) {
              for (var O = s.split(n), k = 0; k < O.length; k++) {
                if (((E = O[k]), (p += E.length), k !== O.length - 1)) p += n.length;
                else if (_) return z();
                if (!r || E.substring(0, x) !== r) {
                  if (C) {
                    if (((w = []), F(E.split(t)), B(), m)) return z();
                  } else F(E.split(t));
                  if (a && a <= k) return ((w = w.slice(0, a)), z(!0));
                }
              }
              return z();
            }
            for (
              var A = s.indexOf(t, p),
                j = s.indexOf(n, p),
                M = new RegExp(h(f) + h(d), `g`),
                N = s.indexOf(d, p);
              ;
            )
              if (s[p] === d)
                for (N = p, p++; ; ) {
                  if ((N = s.indexOf(d, N + 1)) === -1)
                    return (
                      _ ||
                        T.push({
                          type: `Quotes`,
                  ...
                  if (N === v - 1) return L(s.substring(p, N).replace(M, d));
                  if (d === f && s[N + 1] === f) N++;
                  else if (d === f || N === 0 || s[N - 1] !== f) {
                    A !== -1 && A < N + 1 && (A = s.indexOf(t, N + 1));
                    var P = I(
                      (j = j !== -1 && j < N + 1 ? s.indexOf(n, N + 1) : j) === -1
                        ? A
                        : Math.min(A, j),
                    );
                    if (s.substr(N + 1 + P, y) === t) {
                      (E.push(s.substring(p, N).replace(M, d)),
                        s[(p = N + 1 + P + y)] !== d && (N = s.indexOf(d, p)),
                        (A = s.indexOf(t, p)),
                        (j = s.indexOf(n, p)));
                      break;
                    }
                    if (((P = I(j)), s.substring(N + 1 + P, N + 1 + P + b) === n)) {
                      if (
                        (E.push(s.substring(p, N).replace(M, d)),
                        R(N + 1 + P + b),
                        (A = s.indexOf(t, p)),
              ...
              else if (r && E.length === 0 && s.substring(p, p + x) === r) {
                if (j === -1) return z();
                ((p = j + b), (j = s.indexOf(n, p)), (A = s.indexOf(t, p)));
              } else if (A !== -1 && (A < j || j === -1))
                (E.push(s.substring(p, A)), (p = A + y), (A = s.indexOf(t, p)));
              else {
                if (j === -1) break;
                if ((E.push(s.substring(p, j)), R(j + b), C && (B(), m))) return z();
                if (a && w.length >= a) return z(!0);
              }
            return L();
            function F(e) {
            ...
            function I(e) {
              var t = 0;
              return (t =
                e !== -1 && (e = s.substring(N + 1, e)) && e.trim() === `` ? e.length : t);
            }
            function L(e) {
              return (
                _ || (e === void 0 && (e = s.substring(p)), E.push(e), (p = v), F(E), C && B()),
                z()
              );
            }
            function R(e) {
              ((p = e), F(E), (E = []), (j = s.indexOf(n, p)));
            }
            function z(r) {
              if (e.header && !g && w.length && !u) {
                ...
                for (let n = 0; n < i.length; n++) {
                  let r = c(i[n]);
                  if (a[(r = S(e.transformHeader) ? e.transformHeader(r, n) : r)]) {
                    let e,
                      s = a[r];
                    for (; (e = r + `_` + s), s++, o.has(e); );
                    (o.add(e), (i[n] = e), a[r]++, (t = !0), ((l = l === null ? {} : l)[e] = r));
                  } else ((a[r] = 1), (i[n] = r));
                  o.add(r);
                }
        ...
        return (
          (s.parse = function (n, r) {
            ...
            if (
              (S(i) && ((r.dynamicTypingFunction = i), (i = {})),
              (r.dynamicTyping = i),
              ...
              return (
                ...
                s.NODE_STREAM_INPUT,
                typeof n == `string`
                  ? ((n = c(n)), (i = new (r.download ? u : f)(r)))
                  : !0 === n.readable && S(n.read) && S(n.on)
                    ? (i = new p(r))
                    : ((t.File && n instanceof File) || n instanceof Object) && (i = new d(r)),
                i.stream(n)
              );
            (((i = (() => {
              var n;
...
`,
                ...
                ((() => {
                  if (typeof t == `object`) {
                    if (
                      ...
                      typeof t.quoteChar == `string` && ((o = t.quoteChar), (c = o + o)),
            ...
            function p(e, t, n) {
              var o = ``,
                ...
                c = !Array.isArray(t[0]);
              if (s && r) {
                for (var l = 0; l < e.length; l++) (0 < l && (o += i), (o += m(e[l], l)));
                0 < t.length && (o += a);
              }
            ...
            function m(e, t) {
              ...
              return e == null
                ...
                : e.constructor === Date
                  ...
                  : ((l = !1),
                    d && typeof e == `string` && d.test(e) && ((e = `'` + e), (l = !0)),
                    (a = (r = e.toString()).replace(f, c)),
                    (l =
                      l ||
                      !0 === n ||
...
`,
          ...
          t.jQuery &&
            ((n = t.jQuery).fn.parse = function (e) {
              ...
              function a() {
                if (i.length === 0) S(e.complete) && e.complete();
                else {
                  var t,
                    r,
                    a,
                    ...
                    if (typeof u == `object`) {
                      if (u.action === `abort`)
                        return (
                          ...
                          (a = l.inputElem),
                          (c = u.reason),
                          void (S(e.error) && e.error({ name: t }, r, a, c))
                        );
  ...
  c = t(r()),
  l = n();
function u({ data: e, getData: t, filename: n, onImport: r }) {
  ...
  return (0, l.jsxs)(`div`, {
    ...
    children: [
            ...
            s.default.parse(t, {
              ...
              complete: (e) => {
                if (e.errors.length > 0) {
                  (console.error(`CSV Parse Errors:`, e.errors), o.error(`Error parsing CSV file`));
                  return;
                }
                try {
                  (r(e.data), o.success(`Successfully imported ${e.data.length} rows`));
                } catch (e) {
                  o.error(e.message || `Failed to process imported data`);
                }
                u.current && (u.current.value = ``);
              },
              error: (e) => {
                (console.error(e),
                  o.error(`Failed to read file`),
                  u.current && (u.current.value = ``));
              },
            });
        },
      ...
      (0, l.jsxs)(`button`, {
        ...
        children: [(0, l.jsx)(a, { className: `h-4 w-4` }), ` Import CSV`],
      }),
      (0, l.jsxs)(`button`, {
        onClick: async () => {
          try {
            let r = e;
            if ((t && (r = await t()), !r || r.length === 0)) {
              o.error(`No data to export`);
              return;
            }
            let i = s.default.unparse(r),
              a = new Blob([i], { type: `text/csv;charset=utf-8;` }),
              c = document.createElement(`a`),
              l = URL.createObjectURL(a);
            (c.setAttribute(`href`, l),
              c.setAttribute(`download`, `${n}-${new Date().toISOString().split(`T`)[0]}.csv`),
              (c.style.visibility = `hidden`),
              document.body.appendChild(c),
              c.click(),
              document.body.removeChild(c),
              o.success(`Export successful!`));
          } catch (e) {
            (console.error(e), o.error(`Failed to export data`));
          }
        },
        className: `inline-flex items-center gap-2 rounded-md bg-white border border-slate-200 px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition`,
        children: [(0, l.jsx)(i, { className: `h-4 w-4` }), ` Export CSV`],
      }),
    ],
  });
}
