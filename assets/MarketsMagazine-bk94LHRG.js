...
import { a as i, i as a, n as o, o as s, r as c, t as l } from "./hero-markets-DsSniPpX.js";
import { c as u, d, l as f, p, u as m } from "./site-content-BDGWQAlc.js";
import { n as h } from "./AdSettingsContext-BPuWF7kc.js";
import { n as g } from "./news-data-D07Mj5gy.js";
import { F as _ } from "./index-CMlkpObp.js";
import { t as v } from "./ScriptAdRenderer-BnJiycPB.js";
var y = e(n()),
  b = t(),
  x = [s, i, a, c, o, l].map((e) => ({ id: e, image: e, href: `#` }));
function S({ articles: e = [], usedIds: t }) {
  let n = _(),
    i = h(),
    a = i?.adConfig ? i.adConfig.slots.home2 || [] : d(`home2`),
    s = i?.adConfig ? i.adConfig.modes.home2 || `image` : f(`home2`),
    c = i?.adConfig ? i.adConfig.scripts.home2 || `` : m(`home2`),
    [S, C] = (0, y.useState)(() => (a.length > 0 ? a : x)),
    [w, T] = (0, y.useState)(s),
    [E, D] = (0, y.useState)(c),
    [O, k] = (0, y.useState)(() => p()),
    [A, j] = (0, y.useState)(!1);
  ((0, y.useEffect)(() => {
    ...
    (0, y.useEffect)(() => {
      if (O.festiveThemeEnabled === !1 || !O.topBarWeatherCustomText) {
        j(!1);
        return;
      }
      let e = (Number(O.topBarSwapDelay) || 5) * 1e3,
        t = setInterval(() => {
          j((e) => !e);
        }, e);
      return () => clearInterval(t);
    }, [O.festiveThemeEnabled, O.topBarWeatherCustomText, O.topBarSwapDelay]),
    (0, y.useEffect)(() => {
      if (i?.adConfig) {
        let e = i.adConfig.slots.home2 || [];
        (C(e.length > 0 ? e : x),
          T(i.adConfig.modes.home2 || `image`),
          D(i.adConfig.scripts.home2 || ``));
      }
    }, [i?.adConfig]),
    (0, y.useEffect)(() => {
      let e = () => {
        let e = d(`home2`);
        (C(e.length > 0 ? e : x), T(f(`home2`)), D(m(`home2`)));
      };
      return (
  ...
  let [M, N] = (0, y.useState)(0);
  (0, y.useEffect)(() => {
    if ((N(0), w === `script` || S.length <= 1)) return;
    let e = i?.adConfig?.rotations.home2 ?? u(`home2`),
      t = setInterval(() => N((e) => (e + 1) % S.length), Math.max(1, e) * 1e3);
    return () => clearInterval(t);
  }, [S, w, i?.adConfig?.rotations]);
  let P = new Set(t || []),
    F = n.marketsMagazine.category,
    I = !F || F === `Markets` ? `Auto (Latest)` : F,
    L = e.filter((e) =>
      P.has(e.id)
        ? !1
        : !I || I === `Auto (Latest)`
  ...
  if (L.length < 4) {
    let t = e.filter((e) => !P.has(e.id) && !L.some((t) => t.id === e.id));
    L = [...L, ...t];
  }
  if (L.length < 4) {
    let t = e.filter((e) => !L.some((t) => t.id === e.id));
    L = [...L, ...t];
  }
  L.slice(0, 4).forEach((e) => P.add(e.id));
  let R = L[0],
    z = L[1],
    B = L[2],
    V = L[3],
    H = O.festiveCategoryTitleGradient || O.topBarTextGradient,
    U = {
        ...
        children: (0, b.jsx)(
          `span`,
          {
            ...
            style:
              H && U[H]
                ? {
                    backgroundColor: O.festiveCategoryBadgeBgColor || `#000000`,
                    backgroundImage: U[H],
                ...
                : {
                    backgroundColor: O.festiveCategoryBadgeBgColor || `#000000`,
                    color: O.festiveCategoryBadgeTextColor || `#ffffff`,
                  },
            children:
              O.festiveThemeEnabled !== !1 && A && O.topBarWeatherCustomText
                ? O.topBarWeatherCustomText
                : n.marketsMagazine.title,
          },
          A ? `custom` : `default`,
        ),
      }),
      (0, b.jsxs)(`div`, {
        ...
        children: [
          (0, b.jsx)(r, {
            to: `/news/$slug`,
            params: {
              slug: R?.slug || `gen-z-traders-go-for-broke-in-pursuit-of-a-new-american-dream`,
            },
            className: `group block`,
            children: (0, b.jsxs)(`figure`, {
              children: [
                (0, b.jsx)(`img`, {
                  src: R ? g(R.featuredImage, 0) : l,
                  alt: `Lead Article`,
                  loading: `eager`,
                  fetchPriority: `high`,
          ...
          (0, b.jsxs)(r, {
            ...
            children: [
              ...
              (0, b.jsx)(`p`, {
                ...
                children: R
                  ? R.excerpt || R.content?.replace(/<[^>]*>/g, ``).slice(0, 300) + `...`
              ...
              (0, b.jsxs)(`p`, {
                ...
                children: [`By `, R ? R.author || `Newsroom Staff` : `Justina Lee and Lu Wang`],
              }),
            ],
          }),
          (0, b.jsx)(`aside`, {
                ...
                : S.map((e, t) =>
                    (0, b.jsx)(
                      `a`,
                      {
                        ...
                        style: { opacity: +(t === M), pointerEvents: t === M ? `auto` : `none` },
      ...
      (0, b.jsxs)(`div`, {
        ...
        children: [
          (0, b.jsx)(r, {
            to: `/news/$slug`,
            params: {
              slug: z?.slug || `a-600-billion-experiment-kicks-off-at-the-biggest-us-pension-fund`,
            },
            className: `group block`,
                ...
                (0, b.jsxs)(`div`, {
                  children: [
                    (0, b.jsx)(`p`, {
                      ...
                      children: z ? z.title : `Market Insights and Analysis`,
                    }),
                    (0, b.jsx)(`p`, {
                      className: `mt-2 max-w-[430px] text-[14px] leading-relaxed text-muted-foreground line-clamp-4`,
                      children: z
                        ? z.excerpt || z.content?.replace(/<[^>]*>/g, ``).slice(0, 150) + `...`
          ...
          (0, b.jsxs)(r, {
            ...
            children: [
              ...
              (0, b.jsx)(`p`, {
                ...
                children: B ? B.title : `Economic Trends and Growth Outlook`,
              }),
              (0, b.jsx)(`p`, {
                className: `mt-2 text-[14px] leading-relaxed text-muted-foreground line-clamp-3`,
                children: B
                  ? B.excerpt || B.content?.replace(/<[^>]*>/g, ``).slice(0, 150) + `...`
