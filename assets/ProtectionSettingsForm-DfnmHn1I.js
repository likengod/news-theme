...
import { t } from "./info-CSk4y27_.js";
import { t as n } from "./lock-BxD192lc.js";
var r = e();
function i({ s: e, update: i }) {
  return (0, r.jsx)(`div`, {
    className: `space-y-6`,
    children: (0, r.jsxs)(`section`, {
      ...
      children: [
        (0, r.jsxs)(`div`, {
          ...
          children: [
            (0, r.jsx)(n, { className: `h-4 w-4 text-slate-700` }),
            (0, r.jsx)(`h2`, {
          ...
          children: [
            (0, r.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, r.jsx)(`button`, {
                  type: `button`,
                  onClick: () => i(`protectionEnabled`, !e.protectionEnabled),
                  className: `relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ${e.protectionEnabled ? `bg-slate-900` : `bg-slate-300`}`,
                  "aria-pressed": e.protectionEnabled,
                  children: (0, r.jsx)(`span`, {
                    className: `pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-xs transition duration-200 ${e.protectionEnabled ? `translate-x-5` : `translate-x-0`}`,
                  }),
                }),
              ],
            }),
            (0, r.jsxs)(`div`, {
              children: [
                ...
                (0, r.jsx)(`input`, {
                  type: `text`,
                  value: e.protectionModalTitle,
                  onChange: (e) => i(`protectionModalTitle`, e.target.value),
            ...
            (0, r.jsxs)(`div`, {
              children: [
                ...
                (0, r.jsx)(`textarea`, {
                  value: e.protectionModalMessage,
                  onChange: (e) => i(`protectionModalMessage`, e.target.value),
                  rows: 6,
            ...
            (0, r.jsxs)(`div`, {
              ...
              children: [
                (0, r.jsxs)(`div`, {
                  ...
                  children: [
                    (0, r.jsx)(t, { className: `h-4 w-4` }),
                    ` Live Protection Notice Preview`,
                  ],
                }),
                (0, r.jsxs)(`div`, {
                  ...
                  children: [
                    (0, r.jsxs)(`div`, {
                      ...
                      children: [
                        (0, r.jsx)(n, { className: `h-4 w-4 text-amber-600` }),
                        e.protectionModalTitle || `Content Protection - News Theme`,
                      ],
                    }),
                    (0, r.jsx)(`p`, {
...
export { i as ProtectionSettingsForm };
