...
import { t } from "./save-DCSXhHjW.js";
import { ct as n } from "./index-CMlkpObp.js";
import { o as r, t as i } from "./roles-OEcKEDC4.js";
var a = e();
function o({ editing: e, isNew: o, setEditing: s, onSave: c }) {
  return (0, a.jsx)(`div`, {
                ...
                (0, a.jsxs)(`div`, {
                  children: [
                    ...
                    (0, a.jsx)(`input`, {
                      type: `number`,
                      value: e.minNews,
                      onChange: (t) => s({ ...e, minNews: Number(t.target.value) || 0 }),
                ...
                (0, a.jsxs)(`div`, {
                  children: [
                    ...
                    (0, a.jsx)(`input`, {
                      ...
                      onChange: (t) => s({ ...e, pointsPerNews: Number(t.target.value) || 0 }),
                      className: `w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-slate-900 focus:outline-none`,
                    }),
                  ],
                }),
                  ...
                  children: i.map((t) =>
                    (0, a.jsx)(
                      `button`,
                      {
                        type: `button`,
                        onClick: () => s({ ...e, color: t }),
                        className: `rounded-full border px-2.5 py-0.5 text-xs font-medium ${r(t)} ${e.color === t ? `ring-2 ring-slate-900 ring-offset-1` : ``}`,
                        children: t,
                      },
                      t,
                    ),
        ...
        (0, a.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, a.jsxs)(`button`, {
              ...
              children: [(0, a.jsx)(t, { className: `h-4 w-4` }), ` Save`],
            }),
          ],
        }),
      ],
