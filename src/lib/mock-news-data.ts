...
export const leftItems: Item[] = [
  {
    ...
    excerpt:
      "Ei mei scripta intellegat. Verear voluptaria eam at, consul putent eu vel. Pro saepe maluisset ne, audire maiorum forensibus eos.",
  },
  {
    kicker: "Food",
    title: "Extra $2.50 for half a prawn? Diner unhappy about $8.50 laksa",
    excerpt:
      "Justo fabulas singulis at pri, saepe luptatum mei an. Duo idque solet scribentur eu, natum iudico labore te eos, no.",
  },
  {
    kicker: "Tech",
    title: "Did You Know You Can Unsend and Edit Text Messages on Your iPhone",
    excerpt:
      "Usu tantas omittantur ut, per te modo appetere senserit. Ei ius aperiam tincidunt, ea sit natum iisque repudiandae.",
    img: top[2].img,
  },
  {
    kicker: "Politics",
    ...
    excerpt:
      "Duo dolorum mandamus mnesarchum te. Sit ridens persius ex. Vel noluisse perpetua consequat ex, has nostro antiopam eu.",
  },
  {
    kicker: "Climate",
    title: "Record heatwave pushes power grids to the brink across southern Europe",
    excerpt:
      "Operators in Spain, Italy and Greece warned of rolling blackouts as demand from cooling systems hit all-time highs this week.",
  },
];
...
export const bottomItems: Item[] = [
  ...
  },
  {
    ...
    excerpt:
      "Shares climbed 2.6% in early trading, pushing the chipmaker past Apple and Microsoft to become the most valuable listed company in the world.",
  },
  {
    kicker: "Crypto",
    title: "Bitcoin breaks $112,000 as spot ETFs log record weekly inflows",
    excerpt:
      "More than $3.2 billion flowed into US-listed spot bitcoin funds last week, with BlackRock's IBIT alone accounting for nearly half of the total.",
  },
  {
    kicker: "Markets",
    title: "Oil slips below $78 as OPEC+ signals gradual supply return",
    excerpt:
      "Brent crude eased after the producer group confirmed it will unwind voluntary cuts in monthly tranches through the second half of the year.",
  },
  {
    kicker: "Business",
    title: "Tesla unveils next-gen robotaxi platform with sub-$25K price tag",
    excerpt:
      "Elon Musk said production will begin in Texas next year, with the company targeting one million autonomous units annually by 2028.",
  },
];
...
export const cultureItems = [
  ...
  },
  {
    ...
    excerpt:
      "Quo natum nemore putant in, his te case habemus. Nulla detraxit explicari in vim. Id eam magna omnesque.",
    date: "Nov 11, 2015",
    kicker: "Crypto",
    img: grid[2].img,
    slug: "sample",
