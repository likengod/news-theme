...
export const defaultPages: PageContent[] = [
  ...
  },
  {
    ...
    intro:
      "News Theme adheres to strict journalistic verification standards. This policy details how our newsroom checks facts, cross-references sources, and upholds factual accuracy across all coverage.",
    body: "",
    sections: [
      {
