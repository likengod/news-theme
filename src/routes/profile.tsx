              ...
              <div>
                <div className="border-b border-slate-100 bg-slate-50 px-6 py-4">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Your membership summary and status
                  </p>
                </div>
                      ...
                      {currentRank ? (
                        <>
                          ...
                          <p className="mt-2 text-xs text-slate-500">
                            Earning <strong>{currentRank.pointsPerNews} pts</strong> per published
                            article at this rank
                          </p>
                        </>
                      ) : (
                        <p className="text-sm text-slate-600">
                          Publish <strong>{ranks[0]?.minNews ?? 100}</strong> articles to earn your
                          first rank badge.
                          <br />
                          <span className="text-xs text-slate-400">
                            {articlesPublished} published so far
                          </span>
                        </p>
                      )}
                    </div>
            ...
            {tab === "phone" && isJournalist && (
              <div>
                <div className="border-b border-slate-100 bg-slate-50 px-6 py-4">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Used on your press credential card
                  </p>
                </div>
              ...
              <div>
                ...
                <form onSubmit={handleSaveBank} className="p-6 space-y-5 max-w-md">
                  <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-3 text-xs text-amber-800 flex items-start gap-2">
                    ...
                    Your bank details are encrypted and only visible to authorised admins for payout
                    purposes.
                  </div>
                  {[
                    {
                    ...
                    <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-5">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-amber-800">
                          Our team will review your request and delete your account within 48 hours.
                    ...
                    <form onSubmit={handleDeleteRequest} className="max-w-md space-y-5">
                      <div className="rounded-lg border border-red-200 bg-red-50 p-4 space-y-2">
                        ...
                        <ul className="space-y-1 text-sm text-red-800 list-disc pl-4">
                          ...
                          <li>
                            Your published articles will be retained under an anonymous byline
                          </li>
