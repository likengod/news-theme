...
const TIERS = [
  {
    ...
    req: "Entry level",
    detail: "Contribute stories on your beat. Get bylines, mentorship and editorial feedback.",
    icon: Newspaper,
  },
  {
    id: "intern",
    name: "Intern Journalist",
    req: "150+ verified news",
    detail:
      "Volunteer journalists who cross 150 published news auto-upgrade to a paid Intern role.",
    icon: GraduationCap,
  },
  {
    id: "permanent",
    name: "Permanent Employee",
    req: "2,000+ verified news",
    detail:
      "Interns who publish 2,000 verified news items can apply for a permanent staff position.",
    icon: BadgeCheck,
  },
];
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 md:p-10">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              As you accumulate points and publish more verified stories, you will automatically
              unlock prestigious rank badges and exclusive perks:
            </p>
          ...
          <div className="space-y-8">
            <section className="rounded-2xl border border-border bg-card/40 p-6 md:p-10">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                We issue physical and digital Press ID cards to verified members of our newsroom to
                assist them in on-the-ground reporting.
              </p>
                ...
                <p className="text-sm font-medium text-foreground whitespace-pre-wrap">
                  {settings.workWithUsIdCardReq || (
                    <>
                      ...
                      (150+ verified published news articles) to be eligible for an Official Press
                      ID Card.
                    </>
                  )}
                </p>
            ...
            <section className="rounded-2xl border border-border bg-card/40 p-6 md:p-10">
              ...
              <ul className="list-inside list-disc space-y-3 text-sm text-muted-foreground">
                {rulesList.length > 0 ? (
                  ...
                  <>
                    <li>
                      <strong className="text-foreground">Zero Plagiarism:</strong> All submissions
                      are passed through advanced plagiarism checks. Copied content results in an
                      instant ban.
                    </li>
                    <li>
                      <strong className="text-foreground">Verify Sources:</strong> You must provide
                      links or contact details for your primary sources when submitting breaking
                      news.
                    </li>
                    <li>
                      <strong className="text-foreground">Unbiased Reporting:</strong> Keep personal
                      opinions strictly to the "Opinion" section. News reports must remain
                      objective.
                    </li>
                    <li>
                      <strong className="text-foreground">No Fake News:</strong> Repeatedly
                      submitting factually incorrect information will result in point deductions and
                      rank demotion.
                    </li>
                  </>
                )}
