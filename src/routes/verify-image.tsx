  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 flex-1 w-full space-y-8">
        ...
        <section className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-xs space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-5 space-y-3">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1 rounded-md bg-blue-500/15 px-2.5 py-0.5 text-xs font-bold text-blue-700 dark:text-blue-300">
                  Layer 1
                </span>
                <span className="text-xs font-semibold text-blue-600 dark:text-blue-400">The Surface Protection</span>
              </div>
              <h3 className="text-sm font-bold text-foreground">Cryptographic EXIF Signature</h3>
              ...
              <div className="rounded-lg bg-blue-500/10 p-3 text-[11px] text-foreground">
            ...
            <div className="rounded-xl border border-purple-500/20 bg-purple-500/5 p-5 space-y-3">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1 rounded-md bg-purple-500/15 px-2.5 py-0.5 text-xs font-bold text-purple-700 dark:text-purple-300">
                  Layer 2
                </span>
                <span className="text-xs font-semibold text-purple-600 dark:text-purple-400">The Deep Protection</span>
              </div>
              <h3 className="text-sm font-bold text-foreground">Forensic Pixel Watermarking (Steganography)</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <div className="rounded-lg bg-purple-500/10 p-3 text-[11px] text-foreground">
