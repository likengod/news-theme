...
import {
  ...
  JournalistPicker,
  AwardPointsBox,
} from "@/components/admin/articles/ArticleSubComponents";
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
                <Field label="Meta Title">
                  ...
                  />
                  <span className="mt-1 block text-xs text-slate-400">
                    {r.metaTitle.length} / 60 chars recommended
                  </span>
                </Field>
                <Field label="Meta Description">
                  ...
                  />
                  <span className="mt-1 block text-xs text-slate-400">
                    {r.metaDescription.length} / 160 chars recommended
                  </span>
                </Field>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-2 truncate text-base text-blue-700">
                  {r.metaTitle || r.title || "Article title"}
                </p>
                <p className="truncate text-xs text-emerald-700">{url}</p>
                <p className="mt-1 line-clamp-2 text-sm text-slate-600">
                  {r.metaDescription || r.excerpt || "Article description preview..."}
                </p>
              </div>
            </div>
          )}
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <Field label="News Type">
                  <select
                    value={r.newsType}
                    onChange={(e) => set("newsType", e.target.value as Row["newsType"])}
                ...
                <Field label="Access Level">
                  <select
                    ...
                    onChange={(e) => set("access_level", e.target.value as Row["access_level"])}
                    className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm"
                  >
