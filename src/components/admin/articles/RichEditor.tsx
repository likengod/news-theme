...
function RichEditor({ value, onChange }: { value: string; onChange: (v: string) => void }) {
  ...
  const insertDivider = () =>
    insertHTML(`<hr style="border:0;border-top:1px solid #e2e8f0;margin:16px 0" />`);
  ...
  return (
    <div className="overflow-hidden rounded-md border border-slate-200">
      ...
      >
        ...
        <Sep />
        <Btn onClick={insertQuote} title="Quote">
        ...
        <Btn onClick={insertDivider} title="Divider">
        ...
        <Btn onClick={() => imgRef.current?.click()} title="Upload image">
        ...
        <Btn onClick={insertFacebook} title="Embed Facebook video">
          <Facebook className="h-4 w-4 text-blue-600" />
        </Btn>
        <Btn onClick={insertVideoUrl} title="Embed video file">
