                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-300">
                      Permanent Upstream: <span className="font-mono text-emerald-400 font-semibold">likengod/news-theme</span>
                    </p>
                  </div>
                </div>
              ...
              {canSeeGitConfig ? (
                <>
                  <div>
                    ...
                    />
                    <p className="mt-1 text-[11px] text-slate-500">HTTPS URL of your upstream update repository.</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1 text-[11px] text-slate-500">Branch to pull from and deploy (default: main).</p>
                  </div>

                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <label className="block text-xs font-medium text-slate-700">Personal Access Token (PAT)</label>
