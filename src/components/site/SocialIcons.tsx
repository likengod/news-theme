...
export function SocialIcons({
    ...
    twitter:
      links.twitter && links.twitter !== "#"
        ...
        : s.twitter !== "#"
          ...
          : undefined,
    pinterest:
      links.pinterest && links.pinterest !== "#"
        ? links.pinterest
        : s.pinterest !== "#"
          ? s.pinterest
          : undefined,
    tiktok:
      links.tiktok && links.tiktok !== "#" ? links.tiktok : s.tiktok !== "#" ? s.tiktok : undefined,
    whatsapp:
  ...
  const items = buildItems(mergedLinks, only).filter(
