    ...
    const targetCats = [
      {
        name: "Country",
        slug: "country",
        desc: "National news, political developments, and policy updates across the country.",
      },
      {
        name: "Entertainment",
        slug: "entertainment",
        desc: "Latest entertainment updates, movie reviews, pop culture, and celebrity news.",
      },
      {
        name: "Health",
        slug: "health",
        desc: "Wellness advice, medical research updates, healthcare policies, and fitness news.",
      },
      {
        name: "Education",
        slug: "education",
        desc: "School board updates, academic achievements, policy discussions, and university news.",
      },
      {
        name: "Jobs",
        slug: "jobs",
        desc: "Employment notifications, career opportunities, job alerts, and recruitment updates.",
      },
      {
        name: "Travel",
        slug: "travel",
        desc: "Destination guides, travel itineraries, tourism updates, and exploration stories.",
      },
      {
        name: "Lifestyle",
        slug: "lifestyle",
        desc: "Fashion trends, design, food culture, relations, and modern living updates.",
      },
    ];
