import { T as saveSettings, p as loadSettings } from "./site-content-DxoUNF0G.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-DZq-bTD9.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BD8TtPLv.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-vQeCjxNu.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-DcNRJ1Zc.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BjlrDkeQ.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-vhKEAqLP.js").then((m) => ({ default: m.BackupRestoreTab })));
