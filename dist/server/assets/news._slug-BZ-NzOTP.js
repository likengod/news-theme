import { y as loadSettings } from "./site-content-CDp-F3e7.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-PNQpdGxL.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-T_cRVJpx.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-xFx9K0vS.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-Blbuivf1.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-BZ-NzOTP.js.map