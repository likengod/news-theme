...
import { n as deleteJournalist, o as upsertJournalist, r as listJournalists } from "./journalist.functions-HgWDO3bM.js";
import { n as MediaField } from "./MediaField-DRBqQJnm.js";
import { t as Field } from "./Field-DPKVWHIh.js";
import { o as roleBadgeClass, u as slugify } from "./roles-DTjUOxKn.js";
import { n as getJournalistStats } from "./articles-store-kwBrWm-d.js";
import { a as saveRanks, i as rankForCount, n as loadRanks } from "./journalist-ranks-B-gbY5KH.js";
import { n as loadAuthorized, r as saveAuthorized, t as DEFAULT_AUTHORIZED } from "./authorized-settings-C6PPe013.js";
import { d as toggleAdminUserBan } from "./admin-users.functions-C_5sIf-e.js";
...
var JournalistFormModal = lazy(() => import("./JournalistFormModal-Dg5a-pyW.js").then((m) => ({ default: m.JournalistFormModal })));
var JournalistProfileModal = lazy(() => import("./JournalistProfileModal-C6sd40dk.js").then((m) => ({ default: m.JournalistProfileModal })));
var RankEditModal = lazy(() => import("./RankEditModal-DmFbDeFM.js").then((m) => ({ default: m.RankEditModal })));
function emptyRank() {
	return {
		id: "",
		name: "",
...
//# sourceMappingURL=admin.journalists-SWUmnMcC.js.map