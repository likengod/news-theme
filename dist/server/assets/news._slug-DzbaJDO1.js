import { _ as loadSettings } from "./site-content-C7K2XYqJ.js";
import { a as useSiteSettings } from "./AdSettingsContext-94yJ-7l7.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-0uaZeuOw.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C8lj6TFi.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-oD-UdN7Q.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CjhxWOoN.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DjEpxBr_.js").then((m) => ({ default: m.PopupAd })));
