import { _ as loadSettings } from "./site-content-peXRAh_E.js";
import { a as useSiteSettings } from "./AdSettingsContext-CK-CZCRz.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-Dcgh3CVE.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C7__GJnu.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Cu42TuFg.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CkPq7-UH.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CWAyC1vA.js").then((m) => ({ default: m.PopupAd })));
