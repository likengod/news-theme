...
function Advertisement({ slot, href = "#", label = "Sponsored", image, video, poster, title, caption, slides, intervalMs = 4e3, aspectRatio = "3 / 4" }) {
	...
	const initialSlides = configSlides && configSlides.length > 0 ? configSlides : slot ? loadAds(slot) : [];
...
//# sourceMappingURL=Advertisement-DX9RVnfT.js.map