import { _ as loadSettings } from "./site-content-k2NOd45F.js";
import { a as useSiteSettings } from "./AdSettingsContext-DC8cFyZt.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DYKwQhrU.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BPIbbHcB.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-BRT-8PWP.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CWVYnFsP.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DfJZnYYn.js").then((m) => ({ default: m.PopupAd })));
