...
import { m as loadAds, u as injectReelAds } from "./site-content-Dwgg51Ng.js";
import { n as useAdSettings } from "./AdSettingsContext-Ber9ofue.js";
import { t as Footer } from "./Footer-CSakICAW.js";
import { a as loadReelsConfig, c as toEmbedSrc } from "./reels-config-4dsZmhVB.js";
import { t as Header } from "./Header-B91FQPJ6.js";
import { t as Route } from "./reels-CyXyMn0x.js";
								...
								return /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("a", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("span", {
												className: "absolute left-1.5 top-1.5 sm:left-2 sm:top-2 bg-amber-500 px-1.5 py-0.5 text-[8px] sm:text-[10px] font-bold text-black rounded shadow-sm flex items-center gap-1",
												children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-2 w-2 sm:h-2.5 sm:w-2.5" }), /* @__PURE__ */ jsx("span", { children: "Sponsored" })]
											}),
											ad.label && /* @__PURE__ */ jsx("h3", {
											...
											/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsxs("span", {
													className: "inline-flex items-center gap-1 text-[8px] sm:text-[10px] font-semibold text-white/90 bg-white/20 backdrop-blur-md px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full border border-white/20 group-hover:bg-amber-500 group-hover:text-black group-hover:border-amber-400 transition-colors",
													children: [/* @__PURE__ */ jsx("span", { children: "Visit" }), /* @__PURE__ */ jsx(ExternalLink, { className: "h-2 w-2 sm:h-2.5 sm:w-2.5" })]
												})
											})
										]
									}), /* @__PURE__ */ jsx("div", {
										className: "mt-1 flex items-center gap-1 text-[9px] sm:text-[11px] text-muted-foreground truncate",
										children: /* @__PURE__ */ jsx("span", { children: ad.label || "Advertisement" })
									})]
								}, `reel-ad-${index}`);
							}
