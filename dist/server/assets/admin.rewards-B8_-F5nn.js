...
import { n as getJournalistRanksServer, o as saveRanks, r as loadRanks } from "./journalist-ranks-CfPnz7Nh.js";
import { a as loadAllPendingClaims, c as getRewardsServer, d as newRecurring, f as saveRewards, i as getPendingClaimsServer, l as loadRewards, n as saveSocialLinks, o as updateClaimStatus, t as loadSocialLinks, u as newOneTime } from "./social-links-BP5bmJ2i.js";
import { useEffect, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Award, Ban, Link as Link$1, Lock, Pencil, Plus, Save, ShieldCheck, Trash2, X } from "lucide-react";
...
function SocialLinksEditor() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ jsx(Link$1, { className: "h-5 w-5 text-blue-600" }), /* @__PURE__ */ jsx("h2", {
					className: "text-sm font-bold uppercase tracking-wider text-slate-800",
...
function SaveBar({ onSave, onCancel }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("button", {
			...
			onClick: onSave,
			className: "inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2 text-xs font-semibold text-white hover:bg-slate-800",
			children: [/* @__PURE__ */ jsx(Save, { className: "h-3.5 w-3.5" }), " Save"]
		})]
	});
}
//#endregion
...
function RewardsPage() {
	...
	if (!isEnterprisePlus) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("h2", {
				...
				children: "Enterprise Plus Feature Locked"
			}),
			/* @__PURE__ */ jsx("p", {
				className: "text-slate-500 max-w-md mb-6",
				children: "The Rewards & Points Engine is exclusively available on Enterprise Plus licenses. Please upgrade your license to unlock this feature."
			}),
			/* @__PURE__ */ jsx(Link, {
				to: "/admin/settings",
				search: { tab: "activate" },
...
//# sourceMappingURL=admin.rewards-B8_-F5nn.js.map