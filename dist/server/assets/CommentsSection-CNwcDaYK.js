...
import { c as postArticleComment, o as getArticleComments } from "./comments.functions-ta8YjS5y.js";
import { t as authClient } from "./auth-client-BMNr78x7.js";
...
function CommentsSection({ articleSlug, articleTitle }) {
	...
	const commentFormFields = (isReply, n, setN, em, setEm, dr, setDr, sub, onSubmit, onCancel, replyToName) => isReply ? /* @__PURE__ */ jsxs("form", {
		onSubmit,
		className: "mt-2 ml-7 pl-3 border-l-2 border-[#141414]/30",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex items-center gap-1.5 mb-1.5 text-xs text-[#141414]",
			children: [
				/* @__PURE__ */ jsx(Reply, { className: "h-3 w-3 text-[#141414]" }),
				/* @__PURE__ */ jsxs("span", {
					className: "text-[11px]",
				...
				userDisplayName && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", {
					className: "text-[#141414]/30",
					children: "·"
				}), /* @__PURE__ */ jsxs("span", {
					className: "text-[11px] text-[#141414]/80",
			...
			className: "flex gap-2 items-start bg-slate-50/80 border border-slate-200/80 rounded-lg p-2",
			children: [/* @__PURE__ */ jsx("div", {
				className: "flex items-center justify-center shrink-0 mt-0.5 text-[#141414]/80",
				...
				children: [/* @__PURE__ */ jsx("textarea", {
					...
					className: "flex items-center justify-between mt-1.5 pt-1.5 border-t border-slate-200/60",
					...
					return /* @__PURE__ */ jsxs("li", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx("div", {
									className: "w-5 h-5 rounded-full bg-slate-100 border border-slate-200/80 flex items-center justify-center text-[10px] font-bold text-slate-700 uppercase shrink-0",
									children: c.user?.[0] || "U"
								}), /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsx("p", {
								className: "mt-1 text-[13px] text-[#222222] leading-snug whitespace-pre-line pl-7",
								children: c.body
							}),
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Reply, { className: "h-3 w-3 text-[#141414]/70" }), /* @__PURE__ */ jsx("span", { children: isReplyingThis ? "Cancel" : "Reply" })]
								})
							}),
							replies.length > 0 && /* @__PURE__ */ jsx("ul", {
								className: "mt-2 ml-7 space-y-1.5 border-l-2 border-slate-200 pl-3",
...
//# sourceMappingURL=CommentsSection-CNwcDaYK.js.map