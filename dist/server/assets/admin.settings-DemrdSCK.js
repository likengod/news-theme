import { T as saveSettings, p as loadSettings } from "./site-content-C0vKOPiO.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-DeuNU4yp.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-CnaI7vXk.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-BCN8r8ua.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BcUy5f3R.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-DAq51Z6i.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DMqmeSNq.js").then((m) => ({ default: m.BackupRestoreTab })));
