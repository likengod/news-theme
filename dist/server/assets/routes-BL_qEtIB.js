...
import { t as Advertisement } from "./Advertisement-CA-CJkV_.js";
...
import { t as Route } from "./routes-B0P8Aka_.js";
...
var NewsGrid = lazy(() => import("./NewsGrid-DFqSBppl.js").then((m) => ({ default: m.NewsGrid })));
var ReelsSection = lazy(() => import("./ReelsSection-Bq6E0YT_.js").then((m) => ({ default: m.ReelsSection })));
var MarketsMagazine = lazy(() => import("./MarketsMagazine-D0Y83ORI.js").then((m) => ({ default: m.MarketsMagazine })));
var Footer = lazy(() => import("./Footer-C0wd5Tvp.js").then((n) => n.n).then((m) => ({ default: m.Footer })));
function Home() {
