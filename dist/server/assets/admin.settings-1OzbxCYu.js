import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-5PxDbNvX.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-CCl_1OAt.js";
import { t as Route } from "./admin.settings-Bu0ECgKu.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DHMS7kAT.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DGmOUJ7y.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-CmvTLjkd.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-CWosFFzc.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-Q0u_Ghr7.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BqkJpK1W.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-Dx30uBBL.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-1OzbxCYu.js.map