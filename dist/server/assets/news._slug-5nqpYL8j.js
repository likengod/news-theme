import { _ as loadSettings } from "./site-content-CvnW9Ioy.js";
import { a as useSiteSettings } from "./AdSettingsContext-DxZAB1-M.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BDZTLIyb.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DyDvnRfo.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CXZCE5UV.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BWoYpB4w.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DdZ5bH3a.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-5nqpYL8j.js.map