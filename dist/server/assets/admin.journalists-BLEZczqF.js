...
import { n as deleteJournalist, o as upsertJournalist, r as listJournalists } from "./journalist.functions-DZBVtA3w.js";
import { n as MediaField } from "./MediaField-DKTVqVdT.js";
import { t as Field } from "./Field-DPKVWHIh.js";
import { o as roleBadgeClass, u as slugify } from "./roles-B9GbRPbf.js";
import { n as getJournalistStats } from "./articles-store-kwBrWm-d.js";
import { a as saveRanks, i as rankForCount, n as loadRanks } from "./journalist-ranks-DnNsIOna.js";
import { n as loadAuthorized, r as saveAuthorized, t as DEFAULT_AUTHORIZED } from "./authorized-settings-C6PPe013.js";
import { d as toggleAdminUserBan } from "./admin-users.functions-BZmhUVMv.js";
...
var JournalistFormModal = lazy(() => import("./JournalistFormModal-C6dl_7D8.js").then((m) => ({ default: m.JournalistFormModal })));
var JournalistProfileModal = lazy(() => import("./JournalistProfileModal-C6sd40dk.js").then((m) => ({ default: m.JournalistProfileModal })));
var RankEditModal = lazy(() => import("./RankEditModal-C8Qq0Q2E.js").then((m) => ({ default: m.RankEditModal })));
function emptyRank() {
	return {
		id: "",
		name: "",
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", {
								...
								children: [pageRows.map(({ j, published, rankId }) => {
									...
									children: journalists.length === 0 ? "No journalists yet. Assign the Journalist role to a user under Admin &rarr; Users." : "No results match your search."
								}) })]
							})]
						})
					}),
...
//# sourceMappingURL=admin.journalists-BLEZczqF.js.map