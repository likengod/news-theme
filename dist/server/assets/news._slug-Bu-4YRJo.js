import { _ as loadSettings } from "./site-content-C2eWnfuz.js";
import { a as useSiteSettings } from "./AdSettingsContext-C505Kgjf.js";
import { t as Views } from "./Views-BBSbqe8O.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DEAfd84h.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DAaRpwaf.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CKgLETgP.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-B0vEja5_.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BAwS05Bl.js").then((m) => ({ default: m.PopupAd })));
