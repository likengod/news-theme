import { a as saveSettings, i as loadSettings, t as cleanCopyright } from "./site-settings-D521lAA0.js";
import { a as useSiteSettings } from "./AdSettingsContext-v0YhHRkC.js";
import { a as LogoUploader } from "./SettingsHelpers-DuqQNd-T.js";
import { r as getContrastRatio, t as ensureAccessibleColor } from "./color-utils-4ZE3UgVW.js";
import { t as Route } from "./admin.settings-CgGgaJEe.js";
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-CMBqz-TA.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CBW3GbSD.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-CtvttOH2.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BP9M5m_U.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-Bb1RnS2s.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-CSl_6bWS.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-4XxL9c4Q.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-2eOel3CF.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-uNZrNLF_.js").then((m) => ({ default: m.SpeedOptimizationTab })));
...
//# sourceMappingURL=admin.settings-BurgblAY.js.map