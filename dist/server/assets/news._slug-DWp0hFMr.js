import { y as loadSettings } from "./site-content-BZnQtTwY.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DmlD27tD.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Bs7JZGxq.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BIAsE8ie.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DECfglQ2.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-DWp0hFMr.js.map