...
import { l as saveCategory, r as getCategories, s as importCategories, t as deleteCategory } from "./taxonomy.functions-nRNzuqCb.js";
import { n as generateCategoryDescriptionServer } from "./ai.functions-B8hP2ujx.js";
import { t as CsvImportExport } from "./CsvImportExport-cj5FA8rJ.js";
import { useEffect, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ChevronLeft, ChevronRight, GripVertical, Loader2, Pencil, Plus, Search, Sparkles, Trash2, X } from "lucide-react";
...
function CategoriesPage() {
	...
	const handleAiGenerateDescription = async () => {
		...
		try {
			const res = await generateCatDescFn({ data: {
			...
			if (res?.description) {
				...
				toast.success(res.provider ? `AI generated description using ${res.provider}!` : "SEO description generated successfully!");
			}
		} catch (err) {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h1", {
					...
					children: [
						...
						allCats.filter((c) => c.showInHeader).length > 0 && /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(GripVertical, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4 text-slate-400" }), " Reorder Header"]
						}),
						/* @__PURE__ */ jsxs("button", {
							onClick: () => setEditing({
								id: Date.now(),
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }), " Add Category"]
						})
					]
				})]
			}),
						...
						/* @__PURE__ */ jsxs("div", { children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("label", {
									...
									title: !editing.name?.trim() ? "Enter Category Name first" : "Generate an SEO-friendly news description with AI",
									children: isGeneratingAi ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin text-indigo-600" }), /* @__PURE__ */ jsx("span", { children: "Generating with AI..." })] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-indigo-600" }), /* @__PURE__ */ jsx("span", { children: "Generate with AI" })] })
								})]
							}),
							...
							/* @__PURE__ */ jsx("p", {
								...
								children: "SEO-friendly summary used across category headers, archive feeds, and Google search snippets."
							})
						] }),
						/* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=admin.categories-CcAiC2da.js.map