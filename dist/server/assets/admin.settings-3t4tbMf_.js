import { A as saveSettings, _ as loadSettings } from "./site-content-C32CLrYw.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-_kyf5hYF.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BEDE5BTT.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-rw2jjoMU.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-hOzhXNle.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-C6L75fhc.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DCp3zVnK.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CrqGOV3h.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DImKWaiB.js").then((m) => ({ default: m.BackupRestoreTab })));
