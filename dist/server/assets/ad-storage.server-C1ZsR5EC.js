...
function persistBase64Image(dataUrl, prefix = "ad") {
	...
	const filename = `${prefix.replace(/[^a-zA-Z0-9_-]/g, "_").replace(/ads?/gi, "prm").slice(0, 30)}_${hash}${ext}`;
...
//#endregion
export { persistAllAdConfiguration, persistBase64Image };

//# sourceMappingURL=ad-storage.server-C1ZsR5EC.js.map