import { s as saveSettings } from "./site-settings-TC6eL9IL.js";
import { t as Card } from "./SettingsHelpers-DBdVv9mu.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Calendar, Check, CheckCircle2, Eye, EyeOff, Key, Loader2, Lock, ShieldCheck, ShoppingCart, X, XCircle } from "lucide-react";
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("li", {
											...
											children: [/* @__PURE__ */ jsx(X, { className: "h-5 w-5 shrink-0 text-slate-400" }), /* @__PURE__ */ jsx("span", {
												className: "text-slate-500 line-through",
												children: "Custom Popup/Leaderboard Ads"
											})]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3 opacity-50",
											children: [/* @__PURE__ */ jsx(X, { className: "h-5 w-5 shrink-0 text-slate-400" }), /* @__PURE__ */ jsx("span", {
												className: "text-slate-500 line-through",
												children: "Inbox Withdrawal Requests"
											})]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3",
								...
								/* @__PURE__ */ jsxs("ul", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("li", {
											...
											children: [/* @__PURE__ */ jsx(Check, { className: "h-5 w-5 shrink-0 text-emerald-400" }), /* @__PURE__ */ jsx("span", {
												className: "text-slate-300",
												children: "Earn Points & Wallet System"
											})]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-3",
...
function ActivateWebsiteTab({ s, update }) {
	...
	const handleActivate = async () => {
		...
		if (rawKey.startsWith("DEMO-") || rawKey.startsWith("ENTPLUS-") || rawKey.startsWith("ENT-") || rawKey.startsWith("VIP-") || rawKey.includes("ENTPLUS") || rawKey.includes("ENTERPRISE") || rawKey.includes("PREMIUM") || rawKey.length >= 16) {
			...
			if (rawKey.includes("ENTPLUS") || rawKey.includes("ENTERPRISE-PLUS") || rawKey.includes("ENTERPRISE+") || rawKey.includes("ENTERPRISE PLUS")) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [isValid && !isEnteringNewKey ? /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						s.licenseType !== "Enterprise Plus" && /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(ShoppingCart, { className: "h-4 w-4" }), "Upgrade License"]
						}),
						s.licenseType === "Enterprise Plus" && /* @__PURE__ */ jsxs("span", {
							className: "shrink-0 flex items-center justify-center gap-2 rounded-lg bg-emerald-100 px-4 py-2 text-xs font-semibold text-emerald-800 border border-emerald-200",
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4" }), "Fully Upgraded"]
						}),
						/* @__PURE__ */ jsx("button", {
							onClick: () => {
								setInputValue("");
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: s.licenseType || "Standard"
							}), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", {
							className: "text-[10px] font-semibold uppercase tracking-wider text-slate-400 flex items-center gap-1",
							children: [/* @__PURE__ */ jsx(Lock, { className: "h-3 w-3 text-slate-400" }), " License Key"]
						}), /* @__PURE__ */ jsx("div", {
			...
			subtitle: isEnteringNewKey ? "Enter your new license key to update your plan. For anti-theft security, keys are masked." : "Enter your license key to activate your website and unlock premium features or support.",
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(Key, { className: "absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" }),
								/* @__PURE__ */ jsx("input", {
								...
								/* @__PURE__ */ jsx("button", {
									...
									tabIndex: -1,
									children: showKey ? /* @__PURE__ */ jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" })
								})
							]
						}), /* @__PURE__ */ jsxs("div", {
							...
							}), isEnteringNewKey ? /* @__PURE__ */ jsx("button", {
								onClick: () => {
									setInputValue("");
									setShowKey(false);
									setIsEnteringNewKey(false);
						...
						children: [/* @__PURE__ */ jsx(Lock, { className: "h-5 w-5 text-slate-500 mt-0.5 shrink-0" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
							className: "text-sm font-semibold text-slate-800",
							children: "Anti-Theft Protection Active"
						}), /* @__PURE__ */ jsx("p", {
							className: "text-xs text-slate-600 mt-1",
							children: "License keys are masked as dots and cryptographically bound to your website domain so unauthorized users or staff cannot view, copy, or reuse your license on other websites."
						})] })]
					})]
				})
			})
