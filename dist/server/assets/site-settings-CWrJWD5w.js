...
//#region src/lib/site-content/site-settings.ts
...
var defaultSettings = {
	...
	copyright: `© ${(/* @__PURE__ */ new Date()).getFullYear()} News Theme. All rights reserved.`,
...
function loadSettings() {
	...
	try {
		...
		if (res.licenseType) res.licenseType = normalizeLicenseType(res.licenseType);
		return res;
	} catch {
...
var getSiteSettingsServer = createServerFn({ method: "GET" }).handler(createSsrRpc("c78294774cd3e4bb1c4a1b90ba325c5a3e4378da96a7efd13255241950559fc2"));
var saveSiteSettingsServer = createServerFn({ method: "POST" }).middleware([requireAdmin]).validator((settings) => settings).handler(createSsrRpc("d5830d251ab2f9747dda53ce45f1285e09274b9a75417b75378eaeb555e1b2f2"));
//#endregion
export { saveSettings as a, loadSettings as i, defaultSettings as n, getSiteSettingsServer as r, cleanCopyright as t };

//# sourceMappingURL=site-settings-CWrJWD5w.js.map