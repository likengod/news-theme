import { _ as loadSettings } from "./site-content-BLphzo5E.js";
import { a as useSiteSettings } from "./AdSettingsContext-ECeaZyI4.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-CEq0Ctu9.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-B7dGIF3d.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-PfNv11Uu.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BWzGJv1s.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-7PCbsrsf.js").then((m) => ({ default: m.PopupAd })));
