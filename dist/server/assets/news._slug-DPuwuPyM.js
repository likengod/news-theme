import { i as loadSettings } from "./site-settings-D521lAA0.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-RA_Kqgth.js";
...
var RelatedNews = lazy(() => import("./RelatedNews-B30nktEo.js").then((m) => ({ default: m.RelatedNews })));
var CommentsSection = lazy(() => import("./CommentsSection-DJhKm7UC.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BIVnLHRy.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-G240Jua_.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-DPuwuPyM.js.map