import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-huzqzZ3V.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-B-OdZPbl.js";
import { t as Route } from "./admin.settings-CU7JtEQ0.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-k91UJTxA.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-CZ7fs-E5.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-YJ-Ywr-_.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BikdZQCh.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-CnSZuMfk.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BO5t5AKx.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-BkqQi5Xe.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-ZAzxJHwW.js.map