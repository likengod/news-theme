import { a as isEnterprisePlusLicense, i as isEnterpriseLicense } from "./site-settings-TC6eL9IL.js";
import { C as savePopupConfig, S as saveAds, _ as purgeFromTrash, b as saveAdSlotMode, d as loadAdSlotMode, f as loadAdSlotScript, g as processExpiredAds, h as loadTrash, m as loadPopupConfig, o as defaultPopupConfig, p as loadAds, s as deleteAdStaticFilesServer, u as loadAdRotation, v as restoreFromTrash, w as trashAds, x as saveAdSlotScript, y as saveAdRotation } from "./ads-storage-DzvZ8vdI.js";
import { a as useSiteSettings } from "./AdSettingsContext-BkhFbsEU.js";
import { r as trackUpload } from "./media-library-AbOW9FVQ.js";
import { t as LibraryPicker } from "./MediaField-Weur-U_g.js";
import { t as Switch } from "./switch-C_mzcXif.js";
import { t as Label } from "./label-BPuF5-mq.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { useNavigate, useRouter } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowDown, ArrowUp, Clock, Code, ExternalLink, Film, FolderOpen, Image as Image$1, Info, Lock, Plus, RotateCcw, Save, Sparkles, Star, Timer, Trash, Trash2, Upload, X } from "lucide-react";
import { toast } from "sonner";
//#region src/components/admin/advertisements/PopupTimingCard.tsx
function PopupTimingCard({ popupConfig, setPopupConfig, rotation, setRotation }) {
...
//#endregion
//#region src/components/admin/advertisements/ScriptAdEditor.tsx
function ScriptAdEditor({ slotScript, setSlotScript, onSave, sampleAdSense }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(Save, { className: "h-4 w-4 text-emerald-400" }), " Save"]
			})
		})]
	});
}
//#endregion
//#region src/components/admin/advertisements/AdTrashDrawer.tsx
function AdTrashDrawer({ trash, slots, onRestore, onPurge }) {
	if (trash.length === 0) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "text-xs",
					children: [/* @__PURE__ */ jsx("div", {
						className: "font-semibold text-slate-900 truncate w-48 sm:w-64 md:w-96",
						children: ad.type === "script" ? "3rd Party Script Ad" : ad.image ? ad.image.split("/").pop() : "(no image set)"
					}), /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/admin/advertisements/ReelAdsGuidanceCard.tsx
function ReelAdsGuidanceCard() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "text-sm font-bold text-slate-900",
					children: "Reel Ads — Responsive Auto-Injection"
				}), /* @__PURE__ */ jsxs("p", {
					className: "text-xs text-slate-500",
					children: [
						"Recommended Size:",
				...
				children: "Mobile: After 1 Reel • Desktop: Every 3 Reels"
			})]
		}), /* @__PURE__ */ jsxs("p", {
			...
			children: [
				...
				" ",
				/* @__PURE__ */ jsx("strong", { children: "1 reel on mobile devices" }),
				", and after",
				" ",
				/* @__PURE__ */ jsx("strong", { children: "every 3 reels on desktop" }),
				" in both the",
				" ",
				/* @__PURE__ */ jsx("strong", { children: "Homepage Watch Carousel" }),
				" and the ",
				/* @__PURE__ */ jsx("strong", { children: "/reels Grid" }),
				". On small screens, sponsor branding is cleanly optimized with single compact badges to prevent text overflow. When users click on the ad card, they are directed to the Click-Through URL."
			]
		})]
	});
}
...
async function convertDataUrlToWebp(dataUrl) {
	if (!dataUrl || dataUrl.startsWith("data:image/webp") || dataUrl.toLowerCase().endsWith(".webp")) return dataUrl;
	return new Promise((resolve) => {
		const img = new Image();
...
function SingleSlotImagePicker({ label, badgeColor, value, aspectClass, emptyText, recSize, onChange }) {
	...
	const handleDeviceUpload = async (f) => {
		...
		try {
			...
			onChange((await trackUpload(webpFile, "advertisement")).dataUrl);
			if (isConverted) toast.success(`${label} image converted to WebP and uploaded`);
			else toast.success(`${label} WebP image uploaded`);
		} catch {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("span", {
						className: "rounded bg-emerald-50 border border-emerald-200 px-1 py-0.2 text-[7.5px] font-extrabold uppercase tracking-wider text-emerald-700",
						children: "WebP"
					}),
					/* @__PURE__ */ jsx("span", {
			...
			menuOpen && /* @__PURE__ */ jsxs("div", {
				className: "absolute left-1/2 top-full z-50 mt-1.5 w-56 -translate-x-1/2 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-xl animate-in fade-in-50 zoom-in-95",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "border-b border-slate-100 bg-slate-50/80 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-600 flex items-center justify-between",
						children: [/* @__PURE__ */ jsxs("span", { children: [
							...
							className: "text-[8px] font-extrabold text-emerald-600 bg-emerald-100/70 px-1 rounded",
							children: "WEBP ONLY"
						})]
					}),
					/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Upload, { className: "h-4 w-4 shrink-0 text-slate-500" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							...
							children: "Upload WebP image"
						}), /* @__PURE__ */ jsx("div", {
							className: "text-[10px] text-slate-400",
							children: "Select .webp from device (auto-converts)"
						})] })]
					}),
					/* @__PURE__ */ jsxs("button", {
						type: "button",
						...
						children: [/* @__PURE__ */ jsx(FolderOpen, { className: "h-4 w-4 shrink-0 text-slate-500" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							...
							className: "text-[10px] text-slate-400",
							children: "Select image (auto-converts to .webp)"
						})] })]
					})
				]
			}),
			pickerOpen && /* @__PURE__ */ jsx(LibraryPicker, {
				...
				onPick: async (item) => {
					try {
						...
						onChange(webpData);
						setPickerOpen(false);
						if (isConverted) toast.success(`${label} image converted to WebP and selected`);
						else toast.success(`${label} WebP image selected`);
					} catch {
...
function DualImageCell({ ad, slot, onUpdate }) {
	...
	if (slot === "home1" || slot === "ad3") return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(SingleSlotImagePicker, {
			...
			value: ad.imagePortrait || (ad.orientation === "portrait" ? ad.image : !ad.imageLandscape ? ad.image : "") || "",
	...
	if (slot === "home2") return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(SingleSlotImagePicker, {
			...
			value: ad.imageLandscape || (ad.orientation === "landscape" ? ad.image : !ad.imagePortrait ? ad.image : "") || "",
	...
	if (slot === "hero_showcase") return /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/admin/advertisements/AdItemCard.tsx
function AdItemCard({ ad, indexOnPage, page, itemsPerPage, totalAdsCount, slot, isEnterprise, isJustAdded, onUpdate, onMove, onToggleFeatured, onRemove, formatExpiresAt }) {
	const i = (page - 1) * itemsPerPage + indexOnPage;
	const isFeatured = !!ad.isFeatured;
	return /* @__PURE__ */ jsxs("div", {
		className: `rounded-xl border bg-white p-3 shadow-xs transition-colors ${isFeatured ? "border-amber-300 ring-1 ring-amber-300 bg-amber-50/15" : isJustAdded ? "bg-emerald-50/40 border-emerald-300 ring-1 ring-emerald-300" : "border-slate-200 hover:border-slate-300"}`,
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-3",
			children: [/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2.5",
				children: [
					...
					isFeatured && /* @__PURE__ */ jsxs("span", {
						className: "inline-flex items-center gap-1.5 rounded-full bg-amber-100 border border-amber-300 px-2 py-0.5 text-[10px] font-bold text-amber-900",
						children: [/* @__PURE__ */ jsx(Star, { className: "h-3 w-3 fill-amber-500 text-amber-600" }), " FEATURED"]
					}),
					/* @__PURE__ */ jsx("input", {
						type: "text",
						value: ad.label || "",
				...
				children: [
					/* @__PURE__ */ jsxs("button", {
						...
						title: !isEnterprise ? "Requires Enterprise license" : isFeatured ? "Currently Featured: shows first before other ads. Click to unfeature." : "Click to feature this ad: featured ads always show first before regular ads.",
						className: `inline-flex items-center gap-1 sm:gap-1.5 rounded-lg px-2 sm:px-2.5 py-1 text-[11px] sm:text-xs font-bold transition shadow-2xs ${isFeatured ? "bg-amber-500 text-white hover:bg-amber-600" : "border border-slate-200 bg-white text-slate-600 hover:border-amber-400 hover:text-amber-700 hover:bg-amber-50/50"} ${!isEnterprise && "opacity-50 cursor-not-allowed"}`,
						children: [
							/* @__PURE__ */ jsx(Star, { className: `h-3 w-3 sm:h-3.5 sm:w-3.5 ${isFeatured ? "fill-white" : "text-amber-500"}` }),
							/* @__PURE__ */ jsx("span", { children: isFeatured ? "Featured (First)" : "Mark Featured" }),
							!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-2.5 w-2.5 sm:h-3 sm:w-3 ml-0.5 text-slate-400" })
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(ArrowUp, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5" })
							}),
							/* @__PURE__ */ jsx("div", { className: "w-[1px] h-3.5 sm:h-4 bg-slate-200" }),
							/* @__PURE__ */ jsx("button", {
								type: "button",
								...
								className: "p-1 sm:p-1.5 text-slate-600 hover:bg-slate-100 hover:text-slate-900 disabled:opacity-30 disabled:hover:bg-transparent transition",
								children: /* @__PURE__ */ jsx(ArrowDown, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5" })
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("input", {
								...
								onChange: (e) => onUpdate(ad.id, { expiresAt: e.target.value ? new Date(e.target.value).toISOString() : null }),
							...
							!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-2.5 w-2.5 sm:h-3 sm:w-3 text-slate-300" })
						]
					}),
					/* @__PURE__ */ jsx("button", {
						type: "button",
...
//#endregion
//#region src/components/admin/advertisements/AdSlotsNavBar.tsx
function AdSlotsNavBar({ tab, setTab, slots, slotCounts, trashCount, isTrash, slotMode, onSlotModeChange, isEnterprise, isEnterprisePlus }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 border-b border-slate-200 pb-1.5 sm:pb-px",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex flex-wrap items-center gap-1 sm:gap-1.5",
			children: [slots.map((s) => {
				if ((s.key === "hero_showcase" || s.key === "reel_ads") && !isEnterprisePlus) return null;
				const isActive = tab === s.key;
				const count = slotCounts[s.key] || 0;
				return /* @__PURE__ */ jsxs("button", {
					onClick: () => setTab(s.key),
					className: `group flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-b-none sm:rounded-t-lg border-b-0 sm:border-b-2 px-2.5 sm:px-4 py-1.5 sm:py-2.5 text-xs sm:text-sm font-semibold transition-all ${isActive ? "border-slate-900 bg-slate-900 text-white shadow-xs" : "border-transparent text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
					children: [/* @__PURE__ */ jsx("div", {
						className: "flex items-center gap-1",
						children: /* @__PURE__ */ jsx("span", { children: s.label })
					}), /* @__PURE__ */ jsx("span", {
						className: `rounded-full px-1.5 sm:px-2 py-0.2 sm:py-0.5 text-[9.5px] sm:text-[10.5px] font-bold ${isActive ? "bg-slate-700 text-slate-200" : "bg-slate-200 text-slate-600 group-hover:bg-slate-300"}`,
						children: count
					})]
				}, s.key);
			}), /* @__PURE__ */ jsxs("button", {
				onClick: () => setTab("trash"),
				className: `group flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-b-none sm:rounded-t-lg border-b-0 sm:border-b-2 px-2.5 sm:px-4 py-1.5 sm:py-2.5 text-xs sm:text-sm font-semibold transition-all ${tab === "trash" ? "border-slate-900 bg-slate-900 text-white shadow-xs" : "border-transparent text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-1",
					children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }), /* @__PURE__ */ jsx("span", { children: "Trash" })]
				}), /* @__PURE__ */ jsx("span", {
					className: `rounded-full px-1.5 sm:px-2 py-0.2 sm:py-0.5 text-[9.5px] sm:text-[10.5px] font-bold ${tab === "trash" ? "bg-slate-700 text-slate-200" : "bg-slate-200 text-slate-600 group-hover:bg-slate-300"}`,
					children: trashCount
				})]
			})]
		}), !isTrash && /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Label, {
						htmlFor: "mode-switch",
						className: `text-xs font-semibold select-none ${(tab === "popup" || tab === "leaderboard") && !isEnterprise ? "text-slate-400 cursor-not-allowed" : "text-slate-900 cursor-pointer"}`,
						children: ["Custom Ads", (tab === "popup" || tab === "leaderboard") && !isEnterprise && /* @__PURE__ */ jsx("span", {
							className: "ml-1.5 inline-flex items-center rounded-full bg-amber-100 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-amber-800",
							children: "Enterprise"
						})]
					})
				]
...
//#endregion
//#region src/components/admin/advertisements/AdSlotToolbar.tsx
function AdSlotToolbar({ adsCount, slotLabel, tab, isEnterprise, rotation, setRotation, searchQuery, setSearchQuery, onAddAd, onClearSearch }) {
	if (adsCount === 0) return null;
	return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 rounded-xl bg-slate-900 p-3 sm:px-4 sm:py-3 text-white shadow-xs",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4 text-amber-400 shrink-0" }), /* @__PURE__ */ jsxs("span", {
					className: "truncate",
					children: [
						/* @__PURE__ */ jsx("strong", { children: adsCount }),
						" active ad slide",
						adsCount === 1 ? "" : "s",
						" in",
						" ",
						/* @__PURE__ */ jsx("strong", { children: slotLabel })
					]
				})]
			}), /* @__PURE__ */ jsxs("button", {
				type: "button",
				...
				className: `sm:hidden inline-flex items-center gap-1 rounded-lg bg-emerald-600 px-2.5 py-1 text-xs font-bold text-white shadow-xs transition shrink-0 ${!isEnterprise && adsCount >= 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-emerald-500 active:scale-98"}`,
			...
			children: [
				tab !== "popup" && /* @__PURE__ */ jsxs("div", {
					...
					title: !isEnterprise ? "Requires Enterprise license" : "",
					children: [
						/* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5 text-amber-400 shrink-0" }),
						/* @__PURE__ */ jsx("label", {
							htmlFor: `rotation-speed-${tab}`,
							className: "text-[11px] sm:text-xs whitespace-nowrap",
							children: "Rotate every:"
						}),
						/* @__PURE__ */ jsx("input", {
						...
						!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-3 w-3 ml-0.5 text-slate-400 shrink-0" })
					]
				}),
				/* @__PURE__ */ jsxs("div", {
					className: "relative flex-1 sm:w-48 min-w-[120px]",
					children: [/* @__PURE__ */ jsx("input", {
						type: "text",
				...
				/* @__PURE__ */ jsxs("button", {
					...
					disabled: !isEnterprise && adsCount >= 1,
					title: !isEnterprise && adsCount >= 1 ? "Enterprise license required for multiple ads" : "",
					className: `hidden sm:inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-xs transition shrink-0 ${!isEnterprise && adsCount >= 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-emerald-500 active:scale-98"}`,
...
//#endregion
//#region src/components/admin/advertisements/AdSlotEmptyState.tsx
function AdSlotEmptyState({ label, shownOn, onAddAd }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(Image$1, { className: "h-6 w-6" })
			}),
			/* @__PURE__ */ jsxs("h3", {
...
//#endregion
//#region src/components/admin/advertisements/types.ts
var SLOTS = [
	{
		key: "home1",
		label: "Home 1",
...
function AdvertisementsPage() {
	...
	useEffect(() => {
		if (tab === "trash") setTrash(loadTrash());
			...
			if ((tab === "popup" || tab === "leaderboard") && !isEnterprise) mode = "script";
			setSlotMode(mode);
	...
	const filteredAds = useMemo(() => {
		...
		return ads.filter((ad) => ad.label && ad.label.toLowerCase().includes(q) || ad.href && ad.href.toLowerCase().includes(q));
	}, [ads, searchQuery]);
	...
	const onPurge = async (id) => {
		...
		if (item) {
			const urlsToDelete = [
				...
				item.imagePortrait,
				item.imageLandscape
			].filter((url) => !!url && typeof url === "string" && (url.startsWith("/uploads/ads/") || url.startsWith("/uploads/promos/")));
			if (urlsToDelete.length > 0) try {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-3.5 sm:space-y-5 pb-12",
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					className: "mt-1 text-sm text-slate-500 hidden sm:block",
			...
			/* @__PURE__ */ jsxs("div", {
				className: "hidden sm:flex items-start sm:items-center gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50/80 p-3 sm:px-4 sm:py-2.5 text-xs text-emerald-950 shadow-2xs",
				children: [/* @__PURE__ */ jsx("span", {
					className: "rounded-md bg-emerald-600 px-2 py-0.5 text-[9.5px] sm:text-[10px] font-extrabold uppercase tracking-wider text-white shadow-xs shrink-0 whitespace-nowrap mt-0.5 sm:mt-0",
					children: "WebP Only"
				}), /* @__PURE__ */ jsxs("span", {
					className: "text-[11px] sm:text-xs font-medium text-emerald-900 leading-relaxed",
					children: [
						"All banner and reel advertisements support ",
						/* @__PURE__ */ jsx("strong", { children: "WebP (.webp)" }),
						" images for maximum Google PageSpeed performance. Uploaded images are automatically verified and converted to WebP."
					]
				})]
			}),
			/* @__PURE__ */ jsx(AdSlotsNavBar, {
				tab,
				setTab,
				slots: SLOTS,
				slotCounts,
			...
			(tab === "hero_showcase" || tab === "reel_ads") && !isEnterprisePlus ? /* @__PURE__ */ jsxs("div", {
				className: "flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center",
				children: [
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("p", {
						...
						children: [
							...
							" advertisement slot is exclusively available on Enterprise Plus licenses. Please upgrade your license to unlock this slot."
						]
					}),
					/* @__PURE__ */ jsx("button", {
						onClick: () => navigate({
			...
			}) : isTrash ? /* @__PURE__ */ jsx(AdTrashDrawer, {
				trash,
				slots: SLOTS,
				onRestore,
				onPurge
			}) : slotMode === "script" ? /* @__PURE__ */ jsx(ScriptAdEditor, {
				slotScript,
				setSlotScript,
				onSave,
				...
				className: "space-y-4",
				children: [
					tab === "popup" && /* @__PURE__ */ jsx(PopupTimingCard, {
						popupConfig,
						setPopupConfig,
						rotation,
						setRotation
					}),
					tab === "reel_ads" && /* @__PURE__ */ jsx(ReelAdsGuidanceCard, {}),
					/* @__PURE__ */ jsx(AdSlotToolbar, {
						adsCount: ads.length,
					...
					ads.length === 0 ? /* @__PURE__ */ jsx(AdSlotEmptyState, {
						...
						ref: tableRef,
						className: "space-y-4",
						children: paginatedAds.map((ad, indexOnPage) => /* @__PURE__ */ jsx(AdItemCard, {
							ad,
							indexOnPage,
							page,
					...
					!isTrash && totalPages > 1 && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							...
							children: [
								...
								" -",
								" ",
								Math.min(page * ITEMS_PER_PAGE, filteredAds.length),
								" of ",
								filteredAds.length,
								" ads"
							]
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center justify-center min-w-8 text-xs font-bold text-slate-900",
									children: [
										page,
										" / ",
										totalPages
