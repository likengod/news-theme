...
import { t as Footer } from "./Footer-CjNhTL68.js";
import { t as Header } from "./Header-CjwteYAC.js";
...
function VerifyImagePage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Header, {}),
			/* @__PURE__ */ jsxs("main", {
				className: "mx-auto max-w-5xl px-4 py-8 sm:px-6 flex-1 w-full space-y-6",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "text-center max-w-2xl mx-auto space-y-2.5 pb-2",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 text-xs font-semibold tracking-wide",
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Digital Provenance & Copyright Guard" })]
						}),
						/* @__PURE__ */ jsx("h1", {
							className: "text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-foreground font-serif",
							children: "Forensic Image Authentication"
						}),
						/* @__PURE__ */ jsx("p", {
							className: "text-xs sm:text-sm text-muted-foreground leading-relaxed",
							children: "Scan any photograph, article image, or screenshot to authenticate its cryptographic EXIF signature and forensic pixel steganography DNA."
						})
					]
				}), !imageSrc ? /* @__PURE__ */ jsxs("div", {
					className: "space-y-5",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "rounded-2xl sm:rounded-3xl border border-border bg-card shadow-sm p-4 sm:p-6 space-y-5",
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center justify-center p-1 bg-muted/60 rounded-xl max-w-sm mx-auto border border-border/40",
								children: [/* @__PURE__ */ jsxs("button", {
									type: "button",
									onClick: () => setActiveTab("upload"),
									className: `flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-xs sm:text-sm font-semibold transition-all ${activeTab === "upload" ? "bg-background text-foreground shadow-xs ring-1 ring-border/40 font-bold" : "text-muted-foreground hover:text-foreground"}`,
									children: [/* @__PURE__ */ jsx(Upload, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Upload Image" })]
								}), /* @__PURE__ */ jsxs("button", {
									type: "button",
									onClick: () => setActiveTab("url"),
									className: `flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-xs sm:text-sm font-semibold transition-all ${activeTab === "url" ? "bg-background text-foreground shadow-xs ring-1 ring-border/40 font-bold" : "text-muted-foreground hover:text-foreground"}`,
									children: [/* @__PURE__ */ jsx(Globe, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Image Web Link" })]
								})]
							}),
							activeTab === "upload" && /* @__PURE__ */ jsxs("div", {
								...
								className: `group relative cursor-pointer rounded-2xl border-2 border-dashed p-8 sm:p-12 text-center transition-all ${isDragging ? "border-primary bg-primary/5 scale-[1.005]" : "border-border/80 hover:border-primary/60 bg-muted/20 hover:bg-muted/35"}`,
								children: [
									/* @__PURE__ */ jsx("input", {
										ref: fileInputRef,
									...
									/* @__PURE__ */ jsx("div", {
										className: "mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 text-primary mb-3.5 group-hover:scale-105 transition-transform",
									...
									/* @__PURE__ */ jsxs("h3", {
										...
										children: [
											...
											" ",
											/* @__PURE__ */ jsx("span", {
												className: "text-primary underline underline-offset-4 decoration-primary/40 group-hover:decoration-primary",
									...
									/* @__PURE__ */ jsxs("p", {
										...
										children: [
											...
											" ",
											/* @__PURE__ */ jsx("kbd", {
												className: "px-1.5 py-0.5 font-mono text-[11px] font-bold bg-background border border-border rounded text-foreground",
												children: "Ctrl+V"
											}),
											" ",
											"anywhere"
									...
									/* @__PURE__ */ jsxs("div", {
										className: "mt-5 flex flex-wrap items-center justify-center gap-1.5 text-[11px] text-muted-foreground font-medium",
										children: [
											/* @__PURE__ */ jsx("span", {
												className: "px-2.5 py-1 rounded-md bg-background border border-border/60",
												children: "JPEG"
											}),
											/* @__PURE__ */ jsx("span", {
												className: "px-2.5 py-1 rounded-md bg-background border border-border/60",
											...
											/* @__PURE__ */ jsxs("span", {
												className: "px-2.5 py-1 rounded-md bg-primary/10 text-primary border border-primary/20 flex items-center gap-1 font-semibold",
												children: [/* @__PURE__ */ jsx(Clipboard, { className: "h-3 w-3" }), " Clipboard Ready"]
											})
										]
									})
								]
							}),
							activeTab === "url" && /* @__PURE__ */ jsxs("form", {
								onSubmit: handleUrlSubmit,
								className: "rounded-2xl border border-border/60 bg-muted/20 p-6 sm:p-10 space-y-4 text-center",
								children: [
									/* @__PURE__ */ jsx("div", {
										className: "mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 text-primary mb-2",
										children: /* @__PURE__ */ jsx(Globe, { className: "h-6 w-6" })
									}),
									/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
										className: "text-base sm:text-lg font-bold text-foreground",
										children: "Verify Remote Image by Web Link"
									}), /* @__PURE__ */ jsx("p", {
										className: "mt-1 text-xs text-muted-foreground max-w-md mx-auto",
										children: "Paste any direct image URL from news articles, social media posts, or CDNs to inspect its forensic provenance."
									})] }),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: isFetchingUrl ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 animate-spin" }), /* @__PURE__ */ jsx("span", { children: "Fetching..." })] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Verify Link" })] })
										})]
									}),
									urlError && /* @__PURE__ */ jsxs("div", {
										className: "max-w-xl mx-auto flex items-center gap-2 rounded-xl border border-red-500/20 bg-red-500/10 p-3 text-xs text-red-600 dark:text-red-400 font-medium text-left",
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-start gap-3 rounded-2xl border border-border/70 bg-card p-4 shadow-2xs",
								children: [/* @__PURE__ */ jsx("div", {
									className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-500/10 text-blue-600 dark:text-blue-400",
									children: /* @__PURE__ */ jsx(Layers, { className: "h-5 w-5" })
								}), /* @__PURE__ */ jsxs("div", {
									className: "space-y-0.5",
									children: [/* @__PURE__ */ jsx("h4", {
										className: "text-xs font-bold text-foreground",
										children: "Layer 1: EXIF Metadata"
									}), /* @__PURE__ */ jsx("p", {
										className: "text-[11px] text-muted-foreground leading-relaxed",
										children: "Cryptographic signature linking digital certificate, domain ownership, and timestamp."
									})]
								})]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-start gap-3 rounded-2xl border border-border/70 bg-card p-4 shadow-2xs",
								children: [/* @__PURE__ */ jsx("div", {
									className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-purple-500/10 text-purple-600 dark:text-purple-400",
									children: /* @__PURE__ */ jsx(Dna, { className: "h-5 w-5" })
								}), /* @__PURE__ */ jsxs("div", {
									className: "space-y-0.5",
									children: [/* @__PURE__ */ jsx("h4", {
										className: "text-xs font-bold text-foreground",
										children: "Layer 2: Pixel Stego DNA"
									}), /* @__PURE__ */ jsx("p", {
										className: "text-[11px] text-muted-foreground leading-relaxed",
										children: "Deep pixel steganography that survives metadata wiping, crops, and screenshot re-compression."
									})]
								})]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-start gap-3 rounded-2xl border border-border/70 bg-card p-4 shadow-2xs",
								children: [/* @__PURE__ */ jsx("div", {
									className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
									children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5" })
								}), /* @__PURE__ */ jsxs("div", {
									className: "space-y-0.5",
									children: [/* @__PURE__ */ jsx("h4", {
										className: "text-xs font-bold text-foreground",
										children: "In-Memory Privacy"
									}), /* @__PURE__ */ jsx("p", {
										className: "text-[11px] text-muted-foreground leading-relaxed",
										children: "Decoded in-memory on demand without storing or logging your media on external servers."
									})]
								})]
							})
						]
