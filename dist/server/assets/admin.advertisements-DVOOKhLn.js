import { A as savePopupConfig, C as restoreFromTrash, D as saveAds, E as saveAdSlotScript, F as trashAds, S as purgeFromTrash, T as saveAdSlotMode, a as deleteAdStaticFilesServer, b as loadTrash, g as loadAds, h as loadAdSlotScript, m as loadAdSlotMode, p as loadAdRotation, r as defaultPopupConfig, v as loadPopupConfig, w as saveAdRotation, x as processExpiredAds } from "./site-content-Jb87XQWv.js";
import { a as useSiteSettings } from "./AdSettingsContext-Du9rGTvT.js";
import { r as trackUpload } from "./media-library-Dpxo2VUb.js";
import { t as LibraryPicker } from "./MediaField-DRBqQJnm.js";
...
function AdvertisementsPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [SLOTS.map((s) => {
						if ((s.key === "featured_slide" || s.key === "reel_ads") && !isEnterprisePlus) return null;
			...
			(tab === "popup" || tab === "leaderboard") && !isPremium || (tab === "featured_slide" || tab === "reel_ads") && !isEnterprisePlus ? /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("p", {
						...
						children: [
							"The",
							" ",
							tab === "featured_slide" || tab === "reel_ads" ? SLOTS.find((s) => s.key === tab)?.label : tab === "popup" ? "Popup" : "Leaderboard",
							" ",
							"advertisement slot is exclusively available on",
							" ",
							tab === "featured_slide" || tab === "reel_ads" ? "Enterprise+" : "Premium",
...
//# sourceMappingURL=admin.advertisements-DVOOKhLn.js.map