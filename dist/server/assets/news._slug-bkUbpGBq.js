import { i as loadSettings } from "./site-settings-CqLQf8no.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C8wkh-Mz.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Bnr5yXVg.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CG_0-5wv.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BiWvFR-O.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-bkUbpGBq.js.map