import { y as loadSettings } from "./site-content-CbfOBwcS.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BfXvebCI.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-DUj2zvW0.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-k5grnKbw.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BEp0ePV4.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-CL5Uc7hu.js.map