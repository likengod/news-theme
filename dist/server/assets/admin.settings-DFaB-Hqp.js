import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-oAOxzZTh.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BxrM-ObY.js";
import { t as Route } from "./admin.settings-BzZle9tI.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BAAz70a6.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-CnZjHQKn.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-fFPT1k6k.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-tXDsTCUH.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-Bozgp5XM.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-Cgh1WMb_.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-B5ezrfTJ.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-DFaB-Hqp.js.map