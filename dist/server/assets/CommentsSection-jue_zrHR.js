				...
				children: [visibleTopLevel.map((c) => {
					...
					return /* @__PURE__ */ jsxs("li", {
						...
						children: [
							...
							isReplyingThis && commentFormFields(true, replyName, setReplyName, replyEmail, setReplyEmail, replyDraft, setReplyDraft, replySubmitting, (e) => submitComment(e, c.id), () => setReplyingTo(null), c.user)
						]
					}, c.id);
...
//# sourceMappingURL=CommentsSection-jue_zrHR.js.map