import { T as saveSettings, p as loadSettings } from "./site-content-CTdFps3N.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-C0rPTsmX.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-KOEnwLEq.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-Dz2CwCvh.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-Dsl1SmN4.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BSLPI7XI.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-CUnnG3VH.js").then((m) => ({ default: m.BackupRestoreTab })));
