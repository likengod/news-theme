import { a as saveSettings, i as loadSettings, t as cleanCopyright } from "./site-settings-Dzehx1jE.js";
import { a as useSiteSettings } from "./AdSettingsContext-Dzko-urs.js";
import { a as LogoUploader } from "./SettingsHelpers-r6OzPceB.js";
import { t as Route } from "./admin.settings-D4ptcz5j.js";
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-CWTf9-3D.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-xpGXQUDs.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BtnVFqiA.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-CHCTpnMc.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-Dia3Sx4H.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CbtEsaIY.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-Mw9EgRZl.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-ZP6ZRhET.js").then((m) => ({ default: m.SpeedOptimizationTab })));
...
//# sourceMappingURL=admin.settings-ChMI2fpO.js.map