...
function FestiveCorner({ className = "" }) {
	return /* @__PURE__ */ jsxs("svg", {
		viewBox: "0 0 40 40",
		fill: "none",
		xmlns: "http://www.w3.org/2000/svg",
...
function EventPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-gradient-to-b from-[#FFFDF9] via-[#FFF9F0] to-[#FFFDF9] text-[#1a1a1a] dark:from-[#0d0c0a] dark:via-[#16120b] dark:to-[#0d0c0a] dark:text-[#f3f3f3]",
		children: [
			/* @__PURE__ */ jsx(Header, {}),
			/* @__PURE__ */ jsxs("main", {
				className: "mx-auto max-w-5xl px-4 py-8 md:py-14",
				children: [
					/* @__PURE__ */ jsxs("section", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								className: "mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-b from-amber-100 to-amber-200 text-red-700 shadow-md border-2 border-amber-400/80 dark:from-[#2e1d09] dark:to-[#1a1005] dark:text-amber-400 dark:border-amber-600/60",
								children: /* @__PURE__ */ jsx(DurgaMotif, { className: "h-11 w-11 drop-shadow-sm" })
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("span", { children: "॥ শারদীয়া দুর্গোৎসব বিশেষ প্রতিযোগিতা ॥" }),
									/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-amber-600 dark:text-amber-400" })
								]
							}),
							/* @__PURE__ */ jsx("h1", {
					...
					/* @__PURE__ */ jsx(FestiveDivider, { title: "॥ প্রতিযোগী সম্মান ও মূল্যায়ন ॥" }),
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										}), /* @__PURE__ */ jsx("span", { children: "পুরস্কার ও সম্মাননা" })]
									}), /* @__PURE__ */ jsx("ul", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										}), /* @__PURE__ */ jsx("span", { children: "মূল্যায়নের মূল ভিত্তি" })]
									}), /* @__PURE__ */ jsxs("ul", {
										className: "space-y-2.5 text-xs sm:text-sm text-stone-700 dark:text-stone-300",
										children: [
											/* @__PURE__ */ jsxs("li", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											}), /* @__PURE__ */ jsx("span", { children: "অংশগ্রহণকারী নির্দেশিকা" })]
										}),
										/* @__PURE__ */ jsx("p", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-emerald-600 dark:text-emerald-400 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "অংশগ্রহণ সম্পূর্ণ বিনামূল্যে" })]
										})
									]
								})
							]
					...
					/* @__PURE__ */ jsx(FestiveDivider, { title: "॥ শারদ সম্মান আবেদন পত্র ॥" }),
					/* @__PURE__ */ jsx("section", {
						id: "register",
						className: "relative scroll-mt-10 my-6",
						children: /* @__PURE__ */ jsxs("div", {
							className: "relative rounded-3xl border-2 border-amber-400/60 bg-gradient-to-b from-amber-50/50 via-white to-amber-50/40 p-6 sm:p-10 md:p-12 shadow-sm dark:border-amber-700/50 dark:from-[#18130a] dark:via-[#100e0a] dark:to-[#18130a]",
							children: [
								/* @__PURE__ */ jsx(FestiveCorner, { className: "absolute top-3 left-3 h-8 w-8 text-amber-500/80 dark:text-amber-400/60" }),
								/* @__PURE__ */ jsx(FestiveCorner, { className: "absolute top-3 right-3 h-8 w-8 -scale-x-100 text-amber-500/80 dark:text-amber-400/60" }),
								/* @__PURE__ */ jsx(FestiveCorner, { className: "absolute bottom-3 left-3 h-8 w-8 -scale-y-100 text-amber-500/80 dark:text-amber-400/60" }),
								/* @__PURE__ */ jsx(FestiveCorner, { className: "absolute bottom-3 right-3 h-8 w-8 -scale-x-100 -scale-y-100 text-amber-500/80 dark:text-amber-400/60" }),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("h2", {
											className: "font-serif text-xl sm:text-2xl font-bold text-red-800 dark:text-red-400",
											children: "ইভেন্ট নিবন্ধন ফরম (Event Registration)"
										}),
										/* @__PURE__ */ jsx("p", {
											className: "mt-1 text-xs sm:text-sm text-stone-600 dark:text-stone-300",
											children: "শারদ সম্মানের জন্য আপনার ক্লাব বা পূজোর বিস্তারিত তথ্য প্রদান করুন"
										})
									]
								}),
...
//# sourceMappingURL=event-CPf5v3dX.js.map