import { C as hero_markets_default, S as news_fed_default, _ as news_trade_default, b as news_oil_default, c as formatViews, g as viewsFor, v as news_wallstreet_default, x as news_tech_default, y as news_crypto_default } from "./db.server-CLva-TlE.js";
import { m as loadAds, u as injectReelAds } from "./site-content-Cam4-nDq.js";
import { n as useAdSettings } from "./AdSettingsContext-CI0-3vTF.js";
...
import { t as Header } from "./Header-BiHxlIuL.js";
import { t as Route } from "./reels-JVvsleti.js";
								...
								return /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("a", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("span", {
												className: "absolute left-1 top-1 sm:left-2 sm:top-2 bg-amber-500 px-1 py-0.5 sm:px-2 sm:py-0.5 text-[7.5px] sm:text-[10px] font-extrabold text-black rounded shadow-sm flex items-center gap-0.5 sm:gap-1 whitespace-nowrap leading-none tracking-tight",
												children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-2 w-2 sm:h-2.5 sm:w-2.5 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "Sponsored" })]
											}),
											!isGenericLabel && /* @__PURE__ */ jsx("h3", {
												className: "hidden sm:block absolute bottom-8 sm:bottom-9 left-1.5 right-1.5 sm:left-2 sm:right-2 text-[9px] sm:text-xs font-bold leading-tight text-white drop-shadow line-clamp-2",
												children: ad.label
											}),
											/* @__PURE__ */ jsx("div", {
												className: "absolute bottom-1.5 left-1.5 sm:bottom-2 sm:left-2 flex items-center gap-1 sm:gap-1.5",
												children: /* @__PURE__ */ jsxs("span", {
													className: "inline-flex items-center gap-0.5 sm:gap-1 text-[8px] sm:text-[10px] font-semibold text-white/90 bg-white/20 backdrop-blur-md px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full border border-white/20 group-hover:bg-amber-500 group-hover:text-black group-hover:border-amber-400 transition-colors leading-none",
													children: [/* @__PURE__ */ jsx("span", { children: "Visit" }), /* @__PURE__ */ jsx(ExternalLink, { className: "h-2 w-2 sm:h-2.5 sm:w-2.5 shrink-0" })]
												})
											})
										]
									}), /* @__PURE__ */ jsx("div", {
										className: `mt-1 flex items-center gap-1 text-[9px] sm:text-[11px] text-muted-foreground truncate ${isGenericLabel ? "hidden sm:flex" : ""}`,
										children: /* @__PURE__ */ jsx("span", { children: ad.label || "Sponsored" })
									})]
								}, `reel-ad-${index}`);
							}
