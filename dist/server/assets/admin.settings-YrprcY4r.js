import { A as saveSettings, _ as loadSettings } from "./site-content-PKpTBymQ.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BJIYOCLZ.js";
import { t as Route } from "./admin.settings-BfPlyp0V.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DVFsMTHu.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DKLc7lI1.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BRW9BlSG.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-CspWG4e4.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BDvOJ6u6.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BszyxJzk.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-BdNEIEgM.js").then((m) => ({ default: m.BackupRestoreTab })));
