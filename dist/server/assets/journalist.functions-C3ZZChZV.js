...
import { o as query, r as hashPassword } from "./db.server-BbeveDGb.js";
...
var lookupJournalist = createServerFn({ method: "POST" }).inputValidator((data) => {
	...
	else profiles = await query("SELECT * FROM profiles WHERE REPLACE(journalist_id, '-', '') = ?", [q.toUpperCase().replace(/-/g, "")]);
...
//# sourceMappingURL=journalist.functions-C3ZZChZV.js.map