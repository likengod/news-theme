...
import { t as authClient } from "./auth-client-3cLBy4FK.js";
import { t as Route } from "./admin-DuAC1MFG.js";
import { useEffect, useState } from "react";
import { Link, Outlet, useNavigate, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { FileText, FolderOpen, FolderTree, Gift, Home, Inbox, LayoutDashboard, Lock, LogOut, Megaphone, Menu, MessageSquare, Newspaper, PenLine, Rocket, Search, Settings, ShieldCheck, Tag, Users, X } from "lucide-react";
						...
						/* @__PURE__ */ jsx("ul", {
							...
							children: nav.map((item) => {
								...
								return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, {
									...
									onClick: () => setOpen(false),
									className: `flex items-center justify-between rounded-md px-3 py-2 text-sm font-medium transition ${(item.exact ? pathname === item.to : pathname.startsWith(item.to)) ? "bg-slate-900 text-white" : isLocked ? "text-slate-400 hover:bg-slate-50" : "text-slate-700 hover:bg-slate-100"}`,
									children: [/* @__PURE__ */ jsxs("div", {
