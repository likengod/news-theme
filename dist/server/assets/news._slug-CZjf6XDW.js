import { y as loadSettings } from "./site-content-oAOxzZTh.js";
import { a as useSiteSettings } from "./AdSettingsContext-Dng1vMnx.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-Vtv3z4Bp.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DMub31KL.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-a4cnQdlu.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CD-ZFTJT.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-syik0bTq.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-CZjf6XDW.js.map