...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BIn2BTTm.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-RcpWBa56.js"),
		import("./start-Blm3CxyS.js"),
...
//# sourceMappingURL=server-BUoyDFHE.js.map