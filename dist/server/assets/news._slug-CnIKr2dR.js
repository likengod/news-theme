import { _ as loadSettings } from "./site-content-nbxAEYKA.js";
import { a as useSiteSettings } from "./AdSettingsContext-RTlmrqlq.js";
import { t as Views } from "./Views-BBSbqe8O.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DSVOvzT1.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DE2qz6qI.js";
...
var RelatedNews = lazy(() => import("./RelatedNews-BKk1eXXB.js").then((m) => ({ default: m.RelatedNews })));
var CommentsSection = lazy(() => import("./CommentsSection-Q-_vF1x6.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CJ_Gm3n9.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BNubmQwP.js").then((m) => ({ default: m.PopupAd })));
