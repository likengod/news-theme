import { _ as loadSettings } from "./site-content-CsN6nWHI.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-Dr88buY2.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Db1wIYgZ.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-9HSrW58L.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-QSqUTCFX.js").then((m) => ({ default: m.PopupAd })));
