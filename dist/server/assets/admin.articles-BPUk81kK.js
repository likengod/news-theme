...
import { a as getAllAdminArticles, l as importAdminArticles, n as deleteAdminArticlesBulk, r as getAdminArticles, t as deleteAdminArticle, u as saveAdminArticle } from "./articles.functions-nFJJXDGx.js";
...
function ArticlesStatusTabs({ status, setStatus, total }) {
...
function ArticlesFilterBar({ query, setQuery, debouncedQuery, category, setCategory, selectedCount, onRequestBulkDelete }) {
	return /* @__PURE__ */ jsxs("div", {
...
function ArticlesTable({ rows, loading, selected, allOnPageSelected, onTogglePage, onToggleOne, onEdit, onRequestDelete, page, totalPages, total, pageSize, onPageChange }) {
...
var ArticleEditor = lazy(() => import("./ArticleEditor-p8kn7sP5.js"));
var PAGE_SIZE = 20;
...
//# sourceMappingURL=admin.articles-BPUk81kK.js.map