import { _ as loadSettings } from "./site-content-D8xZkwj9.js";
import { a as useSiteSettings } from "./AdSettingsContext-DUnzcRrC.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-LPi2BFVR.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-_7oy8kNz.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Be-pdmNG.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-b0iv4iSS.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DTEYSZyT.js").then((m) => ({ default: m.PopupAd })));
