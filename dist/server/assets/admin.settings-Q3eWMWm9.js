import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-DkBgA5Av.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-C1qnU6un.js";
import { t as Route } from "./admin.settings-DKuat-RN.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BZpbvdqR.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DClKHsLy.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-KF3ugzTk.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-bvFlBDdq.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DrGWZz86.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-Cg-zIxXw.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DbKwAsc7.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-Q3eWMWm9.js.map