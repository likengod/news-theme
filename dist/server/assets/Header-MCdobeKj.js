...
import { p as loadSettings, t as defaultSettings } from "./site-content-C4QIhjym.js";
import { o as getTopTags } from "./taxonomy.functions-BKgVnHUa.js";
import { a as useSiteSettings, r as useCategories } from "./AdSettingsContext-Bf4mUIXt.js";
...
import { o as getHomepageArticles } from "./articles.functions-A6A9mKrl.js";
			...
			children: [/* @__PURE__ */ jsxs(Link, {
				...
				children: [
					...
					showText && /* @__PURE__ */ jsx("h1", {
						...
						children: s.logoText || "News Theme"
					})
				]
			}), /* @__PURE__ */ jsx("p", {
				className: "mt-3 hidden text-[11px] font-semibold uppercase tracking-[0.35em] md:block text-muted-foreground",
				children: s.tagline ? /* @__PURE__ */ jsx("span", { children: s.tagline }) : /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsx("span", {
						style: { color: "#2563eb" },
