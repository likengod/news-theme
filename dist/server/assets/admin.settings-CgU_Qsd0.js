import { A as saveSettings, _ as loadSettings } from "./site-content-D8xZkwj9.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BJIYOCLZ.js";
import { t as Route } from "./admin.settings-X7RuQmv5.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-B6_vfIb1.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DFyA6rqF.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab--2wIHjm0.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BVtTGhwr.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BDvOJ6u6.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-D3yCGjB-.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-C27XKHNb.js").then((m) => ({ default: m.BackupRestoreTab })));
