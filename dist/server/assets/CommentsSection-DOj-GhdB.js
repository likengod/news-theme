...
function CommentsSection({ articleSlug, articleTitle }) {
	...
	const commentFormFields = (isReply, n, setN, em, setEm, dr, setDr, sub, onSubmit, onCancel, replyToName) => isReply ? /* @__PURE__ */ jsxs("form", {
		onSubmit,
		className: "mt-2.5 ml-4 pl-3 border-l-2 border-[#141414]/30",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex items-center gap-2 mb-1.5 text-xs text-[#141414]",
			children: [
				/* @__PURE__ */ jsx(Reply, { className: "h-3.5 w-3.5 text-[#141414]" }),
			...
			children: [/* @__PURE__ */ jsx("div", {
				className: "flex items-center justify-center shrink-0 mt-1 text-[#141414]",
				...
				children: [/* @__PURE__ */ jsx("textarea", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						className: "text-[11px] text-[#141414]/60",
						children: [
							dr.length,
							" / 500 ",
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Reply, { className: "h-3.5 w-3.5 text-[#141414]" }), /* @__PURE__ */ jsx("span", { children: isReplyingThis ? "Cancel" : "Reply" })]
								})
							}),
							replies.length > 0 && /* @__PURE__ */ jsx("ul", {
								className: "mt-2.5 ml-4 space-y-2 border-l-2 border-[#141414]/20 pl-3",
								children: replies.map((r) => /* @__PURE__ */ jsxs("li", {
									className: "pt-0.5",
									children: [/* @__PURE__ */ jsx("div", {
										className: "text-xs font-semibold text-[#141414] leading-tight",
										children: r.user
									}), /* @__PURE__ */ jsx("p", {
										className: "mt-0.5 text-xs text-[#141414]/90 leading-relaxed whitespace-pre-line",
										children: r.body
									})]
								}, r.id))
							}),
...
//# sourceMappingURL=CommentsSection-DOj-GhdB.js.map