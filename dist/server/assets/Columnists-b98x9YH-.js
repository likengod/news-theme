						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("span", {
										className: "absolute left-2.5 top-2.5 bg-amber-500 px-2 py-0.5 text-[10px] font-bold text-black rounded flex items-center gap-1 shadow-sm",
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-2.5 w-2.5" }), "Sponsored"]
									}),
									ad.label && /* @__PURE__ */ jsx("h4", {
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsxs("span", {
											className: "inline-flex items-center gap-1 text-[11px] font-semibold text-white/90 bg-white/20 backdrop-blur-md px-2 py-1 rounded-full border border-white/20 group-hover/ad:bg-amber-500 group-hover/ad:text-black group-hover/ad:border-amber-400 transition-colors",
											children: [/* @__PURE__ */ jsx("span", { children: "Visit" }), /* @__PURE__ */ jsx(ExternalLink, { className: "h-2.5 w-2.5" })]
										})
									})
								]
							}), /* @__PURE__ */ jsx("div", {
								className: "mt-1.5 text-[11px] text-muted-foreground truncate",
								children: ad.label || "Advertisement"
							})]
						}, `reel-ad-${index}`);
					}
					const v = item.item;
