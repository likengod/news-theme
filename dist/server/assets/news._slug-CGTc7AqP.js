import { _ as loadSettings } from "./site-content-YCrIV7Zo.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DL-j36k7.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-COt0OjKy.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-SVabyR0A.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-H5K7HXco.js").then((m) => ({ default: m.PopupAd })));
