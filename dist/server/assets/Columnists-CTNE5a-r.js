import { c as formatViews, d as lead, g as viewsFor, h as top, u as grid } from "./db.server-CLva-TlE.js";
...
import { t as useHomepageConfig } from "./use-homepage-config-Cb3FuCmb.js";
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("span", {
										className: "absolute left-1.5 top-1.5 md:left-2.5 md:top-2.5 bg-amber-500 px-1 py-0.5 md:px-2 md:py-0.5 text-[7.5px] sm:text-[9px] md:text-[10px] font-extrabold text-black rounded flex items-center gap-0.5 md:gap-1 shadow-sm whitespace-nowrap leading-none tracking-tight",
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-2 w-2 md:h-2.5 md:w-2.5 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "Sponsored" })]
									}),
									!isGenericLabel && /* @__PURE__ */ jsx("h4", {
										className: "hidden md:block absolute bottom-11 left-2.5 right-2.5 text-xs font-bold leading-tight text-white drop-shadow line-clamp-2",
										children: ad.label
									}),
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsxs("span", {
											className: "inline-flex items-center gap-0.5 md:gap-1 text-[8px] sm:text-[9px] md:text-[11px] font-semibold text-white/90 bg-white/20 backdrop-blur-md px-1.5 py-0.5 md:px-2 md:py-1 rounded-full border border-white/20 group-hover/ad:bg-amber-500 group-hover/ad:text-black group-hover/ad:border-amber-400 transition-colors leading-none",
											children: [/* @__PURE__ */ jsx("span", { children: "Visit" }), /* @__PURE__ */ jsx(ExternalLink, { className: "h-2 w-2 md:h-2.5 md:w-2.5 shrink-0" })]
										})
									})
								]
							}), /* @__PURE__ */ jsx("div", {
								className: `mt-1.5 text-[9px] md:text-[11px] text-muted-foreground truncate ${isGenericLabel ? "hidden md:block" : ""}`,
								children: ad.label || "Sponsored"
							})]
						}, `reel-ad-${index}`);
					}
					const v = item.item;
