...
import { t as authClient } from "./auth-client-C7Y3G_4_.js";
import { t as Route } from "./admin-B5TjdBqv.js";
import { r as getGitStatus } from "./deploy.functions-BlbNx1_M.js";
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("header", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "flex items-center gap-3",
						children: [updateStatus.hasUpdate && !pathname?.startsWith("/admin/updates") && /* @__PURE__ */ jsxs(Link, {
							to: "/admin/updates",
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", {
											...
											children: ["Current: ", updateStatus.currentVersion || "v1.0.54"]
										}),
					...
					}) : /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Outlet, {}) })
				})]
			})
		]
	});
...
//# sourceMappingURL=admin-BYlpoSv3.js.map