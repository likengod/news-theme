import { E as saveSettings, m as loadSettings } from "./site-content-s03HcFGh.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-bbOfFpbn.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DYm1FiXe.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-Cc_yvXOB.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-10ubsYVZ.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-DXXS_2cn.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DCp3zVnK.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BheI7RVp.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-Xm0kyep1.js").then((m) => ({ default: m.BackupRestoreTab })));
