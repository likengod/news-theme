import { y as loadSettings } from "./site-content-Jb87XQWv.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-H0liIRJp.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-C29FLSIr.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-C679mKB7.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DO8pAGi4.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-DMX4p1ZQ.js.map