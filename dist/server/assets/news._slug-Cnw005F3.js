import { _ as loadSettings } from "./site-content-Dwgg51Ng.js";
import { a as useSiteSettings } from "./AdSettingsContext-Ber9ofue.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-D8Hhn-Re.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-CfIVuBPn.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CNY77pIz.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-D98RQJ-i.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BuW3RJLy.js").then((m) => ({ default: m.PopupAd })));
