...
import { i as setCached, n as clearCache, r as getCached } from "./server-cache-Jc7G8zPO.js";
...
var saveSiteSettingsServer = createServerFn({ method: "POST" }).middleware([requireAdmin]).validator((settings) => settings).handler(saveSiteSettingsServer_createServerFn_handler, async ({ data }) => {
	const cleanedData = {
		...data,
...
//# sourceMappingURL=site-settings-DGVQW2eD.js.map