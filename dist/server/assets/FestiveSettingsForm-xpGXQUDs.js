import { a as saveSettings, i as loadSettings } from "./site-settings-Dzehx1jE.js";
import { i as useFontConfig } from "./AdSettingsContext-Dzko-urs.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Check, Clock, Power, RefreshCw, RotateCcw, Save, Sparkles } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				...
				children: "Text Color (Default: Black)"
			}), /* @__PURE__ */ jsxs("div", {
				className: "flex flex-wrap items-center gap-2",
				children: [PRESET_COLORS.map((c) => {
					const isSelected = (settings.festiveCategoryTitleColor || settings.topBarTextColor || "#000000") === c.hex;
					return /* @__PURE__ */ jsxs("button", {
						...
						className: `flex items-center gap-1.5 rounded-md border px-2.5 py-1 text-xs font-medium transition-all ${isSelected ? "border-slate-900 bg-slate-900 text-white shadow-xs" : "border-slate-200 bg-white text-slate-700 hover:bg-slate-50"}`,
						children: [
							/* @__PURE__ */ jsx("span", {
							...
							c.name,
							isSelected && /* @__PURE__ */ jsx(Check, { className: "h-3 w-3 ml-0.5" })
						]
					}, c.hex);
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("input", {
						...
						children: settings.festiveCategoryTitleColor || settings.topBarTextColor || "#000000"
					})]
				})]
			})] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("label", {
					...
					children: "Or Apply Festive Gradient"
				}), (settings.topBarTextGradient || settings.festiveCategoryTitleGradient) && /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => {
						update("topBarTextGradient", "");
						update("festiveCategoryTitleGradient", "");
					...
					children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-3 w-3" }), " Clear Gradient"]
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-2 sm:grid-cols-3 gap-2",
				children: Object.entries(FESTIVE_GRADIENT_MAP).map(([key, grad]) => {
					const isSelected = (settings.topBarTextGradient || settings.festiveCategoryTitleGradient) === key;
					return /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => {
						...
						className: `relative flex items-center justify-between rounded-lg border p-2.5 text-left transition-all ${isSelected ? "border-slate-900 ring-2 ring-slate-900/10 shadow-xs" : "border-slate-200 hover:border-slate-300"}`,
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								className: "text-xs font-medium capitalize text-slate-800",
								children: key.replace("-", " ")
							})]
						}), isSelected && /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 text-slate-900" })]
					}, key);
				})
			})] }),
			/* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsx("label", {
					className: "mb-1 block text-xs font-semibold text-slate-700",
					children: "Rotation Animation Style (Smooth Motion)"
				}),
				...
				/* @__PURE__ */ jsx("p", {
					className: "mt-1 text-[11px] text-slate-400",
					children: "Controls the entry effect when the headline text alternates."
				})
			] }),
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
				className: "mb-1 block text-xs font-semibold text-slate-700",
				children: "Headline Font Family (Google Fonts & Uploaded)"
			}), /* @__PURE__ */ jsx("select", {
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("label", {
					className: "text-xs font-semibold text-slate-700",
					children: "Responsive Text Size (Custom Alert ONLY)"
				}), /* @__PURE__ */ jsxs("span", {
...
function FestivePreviewCard({ settings, isFestiveEnabled, showCustomText, animNonce, customAlertText, textStyle, badgeStyle, customAlertFontFamilyCss, rotationAnimStyle, triggerTestSwap }) {
	return /* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=FestiveSettingsForm-xpGXQUDs.js.map