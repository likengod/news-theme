...
import { u as getSiteSettingsServer } from "./site-content-CDp-F3e7.js";
...
var generateDummyCommentsFn = createServerFn({ method: "POST" }).middleware([requireAuth]).validator((d) => d).handler(generateDummyCommentsFn_createServerFn_handler, async ({ data }) => {
	...
	if (profiles.length === 0) throw new Error("User with that Public ID not found.");
...
//# sourceMappingURL=comments.functions-CWAaJCss.js.map