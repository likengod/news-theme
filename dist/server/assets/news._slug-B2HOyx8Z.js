import { _ as loadSettings } from "./site-content-BnO3C8zI.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BkNnao1j.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CpvaJ-0a.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-lrnUzoOQ.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DE-fLtwZ.js").then((m) => ({ default: m.PopupAd })));
