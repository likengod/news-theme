import { a as saveSettings, i as loadSettings, t as cleanCopyright } from "./site-settings-CqLQf8no.js";
import { a as useSiteSettings } from "./AdSettingsContext-DnVOjDQ9.js";
import { a as LogoUploader } from "./SettingsHelpers-CAQbk9NV.js";
import { r as getContrastRatio, t as ensureAccessibleColor } from "./color-utils-4ZE3UgVW.js";
import { t as Route } from "./admin.settings-CXa1OoY7.js";
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-Dd5UJc7Y.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CBW3GbSD.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-_bUqM81w.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-Dl-zVUte.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-C0UhU7OE.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-zhLDZMZq.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BqczgU8T.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-B6PF5jAX.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-JY-BDlfB.js").then((m) => ({ default: m.SpeedOptimizationTab })));
...
//# sourceMappingURL=admin.settings-CvWsGDv4.js.map