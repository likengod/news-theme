import { p as loadSettings } from "./site-content-D1ESx2fQ.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BAN6Lc3s.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-DQkQjwgn.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-NlGLOe0S.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BgklA8Dd.js").then((m) => ({ default: m.PopupAd })));
