import { _ as loadSettings } from "./site-content-CobQN-RG.js";
import { a as useSiteSettings } from "./AdSettingsContext-DWcgSxgG.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-D_N-v-0R.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-wl7KF0Ng.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CrWq0RM6.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BXHc1NX2.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CLM0Qfi3.js").then((m) => ({ default: m.PopupAd })));
