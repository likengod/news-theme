import { a as gitPull, i as getGitStatus, n as getDeployHistory, r as getDeployLog, t as buildProject } from "./deploy.functions-C4mzqGwy.js";
import { useEffect, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, ChevronDown, ChevronUp, Clock, Download, Hammer, Layers, Loader2, RefreshCw, Rocket, Terminal, XCircle, Zap } from "lucide-react";
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						updatesAvailable ? /* @__PURE__ */ jsxs("button", {
							...
							children: [pulling ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin text-white" }) : /* @__PURE__ */ jsx(Zap, { className: "h-4 w-4 fill-white text-white" }), /* @__PURE__ */ jsx("span", { children: pulling ? "Updating System..." : `Update to ${latestVersion}` })]
						}) : /* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [building ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin text-white" }) : /* @__PURE__ */ jsx(Hammer, { className: "h-4 w-4 text-white" }), /* @__PURE__ */ jsx("span", { children: building ? "Building..." : "Build Production" })]
						}),
						/* @__PURE__ */ jsx("button", {
							onClick: refresh,
							disabled: loading,
...
//# sourceMappingURL=admin.updates-CMy_dSrW.js.map