import { _ as loadSettings } from "./site-content-B0GnrEDb.js";
import { a as useSiteSettings } from "./AdSettingsContext-DMz3sC6c.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DU0XclB2.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BS04SG5H.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-DC6BUjvR.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-B6_uoPQt.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BzPpId4C.js").then((m) => ({ default: m.PopupAd })));
