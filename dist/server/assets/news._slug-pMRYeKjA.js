import { y as loadSettings } from "./site-content-C7dH4wQA.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DOjUaGr4.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-UdQGFLNB.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-56bBBWgz.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DA0tMSMx.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-pMRYeKjA.js.map