import { y as loadSettings } from "./site-content-C6jtkywk.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BcY2dzcH.js";
...
var RelatedNews = lazy(() => import("./RelatedNews-Ppi0LSVo.js").then((m) => ({ default: m.RelatedNews })));
var CommentsSection = lazy(() => import("./CommentsSection-BfOdlWam.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-Dv78ZHZL.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DwBgqwU7.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-DPG0DYPz.js.map