...
var generateBackupServer = createServerFn({ method: "GET" }).middleware([requireAdmin]).handler(createSsrRpc("04344fe1d3ab2fd1861f88f715beb7ef2db30b44e66ca36f7ba3e8404a815be0"));
var restoreBackupServer = createServerFn({ method: "POST" }).middleware([requireAdmin]).validator((d) => d).handler(createSsrRpc("3a38e185b3779aeaabf8e39bee398139af011d9319629d9d39100c41c4bc0595"));
//#endregion
...
//# sourceMappingURL=BackupRestoreTab-BPOf_WHb.js.map