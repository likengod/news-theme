import { _ as loadSettings } from "./site-content-Bsi3qYPj.js";
import { a as useSiteSettings } from "./AdSettingsContext-CT4DUJRS.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-ViY90LyJ.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BVRVP2Yj.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-DQxBlP42.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DwEb3xJe.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-aU8Sgb8w.js").then((m) => ({ default: m.PopupAd })));
