...
import { a as useSiteSettings } from "./AdSettingsContext-BSfCjYFc.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BGu0gDP0.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-CnT5x2Ek.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Ch9i6Zb7.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BENDILJn.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-C0S2VkCe.js").then((m) => ({ default: m.PopupAd })));
