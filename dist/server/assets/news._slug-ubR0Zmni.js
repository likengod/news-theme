import { p as loadSettings } from "./site-content-yAGe-jnq.js";
import { a as useSiteSettings } from "./AdSettingsContext-CBvU0gsM.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BK6fwG-Y.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C_6QBGXx.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-mX9Nsfid.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DIhg7CPG.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BGtf6zIx.js").then((m) => ({ default: m.PopupAd })));
