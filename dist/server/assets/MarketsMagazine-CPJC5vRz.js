import { C as hero_markets_default, S as news_fed_default, b as news_oil_default, l as getArticleImage, v as news_wallstreet_default, x as news_tech_default, y as news_crypto_default } from "./db.server-CLva-TlE.js";
import { c as loadAdRotation, d as loadAds, l as loadAdSlotMode, p as loadSettings, u as loadAdSlotScript } from "./site-content-BzPQwjRN.js";
import { n as useAdSettings } from "./AdSettingsContext-CAAj3cJ2.js";
import { t as ScriptAdRenderer } from "./ScriptAdRenderer-CHXwBV65.js";
import { t as useHomepageConfig } from "./use-homepage-config-BWPHeqzE.js";
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("span", {
					...
					children: showCustomText && settings.topBarWeatherCustomText ? settings.topBarWeatherCustomText : cfg.marketsMagazine.title
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [
							/* @__PURE__ */ jsx("p", {
								className: "max-w-[500px] font-sans text-[28px] font-extrabold leading-[1.14] tracking-normal text-foreground group-hover:underline md:text-[29px] line-clamp-2",
								children: leadArt ? leadArt.title : "Gen-Z Traders Go for Broke in Pursuit of a New American Dream"
							}),
							/* @__PURE__ */ jsx("p", {
								className: "mt-3 max-w-[440px] font-sans text-[16px] leading-[1.15] text-foreground line-clamp-6 [&::first-letter]:float-left [&::first-letter]:mr-2 [&::first-letter]:font-serif [&::first-letter]:text-[44px] [&::first-letter]:font-bold [&::first-letter]:leading-[0.85] [&::first-letter]:mt-1",
							...
							/* @__PURE__ */ jsxs("p", {
								className: "mt-1 font-sans text-[15px] leading-tight text-foreground",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Link, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("img", {
								...
								className: "font-sans text-[28px] font-extrabold leading-[1.16] tracking-normal text-foreground group-hover:underline line-clamp-2",
								children: p1 ? p1.title : "Market Insights and Analysis"
							}), /* @__PURE__ */ jsx("p", {
								className: "mt-2 max-w-[430px] font-sans text-[16px] leading-[1.12] text-foreground line-clamp-4",
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [
							/* @__PURE__ */ jsx("p", {
								className: "font-sans text-[16px] leading-none text-foreground",
								children: p2 ? p2.category : "Analysis"
							}),
							/* @__PURE__ */ jsx("p", {
								className: "mt-1 font-sans text-[17px] font-medium leading-[1.18] tracking-normal text-foreground group-hover:underline line-clamp-3",
								children: p2 ? p2.title : "Economic Trends and Growth Outlook"
							}),
							/* @__PURE__ */ jsx("p", {
								className: "mt-2 font-sans text-[16px] leading-[1.15] text-foreground line-clamp-3",
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx("p", {
							className: "font-sans text-[17px] font-extrabold leading-[1.18] tracking-normal text-foreground group-hover:underline line-clamp-2",
							children: p3 ? p3.title : "Global Financial Markets Review"
						}), /* @__PURE__ */ jsx("p", {
							className: "mt-2 font-sans text-[16px] leading-[1.15] text-foreground line-clamp-5",
