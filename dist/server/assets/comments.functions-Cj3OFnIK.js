...
import { o as query } from "./db.server-Bfe074Dx.js";
import { u as getSiteSettingsServer } from "./site-content-C7dH4wQA.js";
...
var getAllCommentsFn = createServerFn({ method: "GET" }).middleware([requireAuth]).handler(getAllCommentsFn_createServerFn_handler, async () => {
...
var importCommentsFn = createServerFn({ method: "POST" }).middleware([requireAuth]).validator((data) => data).handler(importCommentsFn_createServerFn_handler, async ({ data: rows }) => {
	let inserted = 0;
...
//#endregion
export { deleteAllCommentsFn_createServerFn_handler, deleteComment_createServerFn_handler, generateDummyCommentsFn_createServerFn_handler, getAdminComments_createServerFn_handler, getAllCommentsFn_createServerFn_handler, getArticleComments_createServerFn_handler, importCommentsFn_createServerFn_handler, postArticleComment_createServerFn_handler, updateCommentStatus_createServerFn_handler };

//# sourceMappingURL=comments.functions-Cj3OFnIK.js.map