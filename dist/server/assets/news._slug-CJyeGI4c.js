import { _ as loadSettings } from "./site-content-Cam4-nDq.js";
import { a as useSiteSettings } from "./AdSettingsContext-CI0-3vTF.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-D6YQdOTV.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C-SOYNpt.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Bbv5-V7Z.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DMp5Ki99.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DdLFHiNi.js").then((m) => ({ default: m.PopupAd })));
