import { A as saveSettings, _ as loadSettings } from "./site-content-Dwgg51Ng.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-tW7bw1cE.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-CcdeE4z4.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-B7tcU0UW.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-CDSI4nOu.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-DQxumo_W.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DCp3zVnK.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CyAYcVL4.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-BSYcmeN_.js").then((m) => ({ default: m.BackupRestoreTab })));
