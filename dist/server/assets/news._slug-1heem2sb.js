import { g as loadSettings } from "./site-content-B62E6PyF.js";
import { a as useSiteSettings } from "./AdSettingsContext-xGwxDTSv.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-vDYT6bWC.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BOCkqLJg.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Cj_6dPv-.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-dDXqMz1B.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DIrHqqRT.js").then((m) => ({ default: m.PopupAd })));
