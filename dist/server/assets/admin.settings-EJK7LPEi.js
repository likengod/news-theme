import { E as saveSettings, m as loadSettings } from "./site-content-lo-rUml2.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-BIto1RRw.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-CLO9yWty.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-05oVLYBe.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-5H_ibr_L.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-D3KFtZcw.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DCp3zVnK.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-Bkl6sIPE.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-iISwXN42.js").then((m) => ({ default: m.BackupRestoreTab })));
