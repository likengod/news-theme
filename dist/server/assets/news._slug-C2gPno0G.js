import { p as loadSettings } from "./site-content-CTdFps3N.js";
import { a as useSiteSettings } from "./AdSettingsContext-D8Sahcar.js";
import { t as Views } from "./Views-DEuQ6JxS.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-OWjZWPR5.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DTIiBaTs.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Dbdfnhml.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CD0X2JWU.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DVgG2C5m.js").then((m) => ({ default: m.PopupAd })));
