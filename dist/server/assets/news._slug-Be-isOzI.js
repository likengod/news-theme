import { o as loadSettings } from "./site-settings-TC6eL9IL.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-JdODFUhj.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-F6UQBp2l.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BP-PRf4U.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-Vd3T-Qgb.js").then((m) => ({ default: m.PopupAd })));
