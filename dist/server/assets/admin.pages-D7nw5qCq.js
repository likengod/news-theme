import { N as saveSiteSettingsServer, O as saveCustomPageServer, _ as loadPages, c as getCustomPagesServer, k as savePages, y as loadSettings } from "./site-content-J6c_9Nu1.js";
import { n as generateSectionHtmlServer } from "./ai.functions-DSrX6oxd.js";
import { n as Field, t as Card } from "./SettingsHelpers-CwO8EKeU.js";
...
var eventFields = [
	{
		key: "eventTitle",
		label: "Event Title (ইভেন্টের শিরোনাম)"
	},
	{
		key: "eventSubtitle",
...
function PagesPage() {
	...
	const onSave = async () => {
		if (activeSlug === "subscription" || activeSlug === "work-with-us" || activeSlug === "event") {
			...
			toast.success(`${activeSlug === "subscription" ? "Subscription" : activeSlug === "work-with-us" ? "Work With Us" : "Event"} settings saved!`);
		} else {
			savePages(pages);
...
//# sourceMappingURL=admin.pages-D7nw5qCq.js.map