import { i as IntegrationField, o as Toggle, r as GuideList, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import "react";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Card, {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 rounded-lg bg-gradient-to-r from-slate-900 to-slate-800 p-4",
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: "Pull → Build → Deploy from the admin panel"
							})] })]
						}),
						/* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsx("p", {
									...
									children: "HTTPS or SSH URL of your repository."
								})
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
								...
								/* @__PURE__ */ jsx("p", {
									className: "mt-1 text-[11px] text-slate-500",
									children: "Branch to pull from and deploy."
								})
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
								...
								/* @__PURE__ */ jsx("p", {
									className: "mt-1 text-[11px] text-slate-500",
									children: "Required for private repos. Generate from GitHub → Settings → Developer settings → Personal access tokens."
								})
							] })
						] }),
						/* @__PURE__ */ jsx(Toggle, {
