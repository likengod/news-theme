...
import { P as createSsrRpc } from "./site-content-CvnW9Ioy.js";
import { c as getPublicArticleBySlug } from "./articles.functions-B2Y46yAl.js";
...
var $$splitComponentImporter = () => import("./news._slug-5nqpYL8j.js");
...
var Route = createFileRoute("/news/$slug")({
	loader: async ({ params, context }) => {
		try {
			const [data, origin] = await Promise.all([context.queryClient.ensureQueryData(articleQueryOptions(params.slug)).catch(() => null), getRequestOrigin().catch(() => "")]);
			return {
				data,
				origin
			};
...
//# sourceMappingURL=news._slug-DyDvnRfo.js.map