import { _ as loadSettings } from "./site-content-Qu-YqMN0.js";
import { a as useSiteSettings } from "./AdSettingsContext-B4DdUeK3.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DZJABG_t.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-CEV7JJpq.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-BixYugW8.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BndK7B6l.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BJ2RvLYB.js").then((m) => ({ default: m.PopupAd })));
