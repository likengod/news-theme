import { p as loadSettings } from "./site-content-C2lyfs6Q.js";
import { a as useSiteSettings } from "./AdSettingsContext-D-RzTvSb.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BNzO1eWT.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-gGMlCBkk.js";
...
var CommentsSection = lazy(() => import("./CommentsSection--L5_Vb5i.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-Cq9GvBLZ.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CI73IRlG.js").then((m) => ({ default: m.PopupAd })));
