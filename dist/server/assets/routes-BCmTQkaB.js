import { c as formatViews, d as lead, g as viewsFor, h as top, l as getArticleImage, u as grid } from "./db.server-Chz3iTW3.js";
import { g as loadAds, h as loadAdSlotScript, m as loadAdSlotMode } from "./site-content-oAOxzZTh.js";
import { n as useAdSettings } from "./AdSettingsContext-Dng1vMnx.js";
import { t as ScriptAdRenderer } from "./ScriptAdRenderer-CHXwBV65.js";
import { t as Advertisement } from "./Advertisement-CD-ZFTJT.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { n as articlesByCategory } from "./homepage-config-rZX57EWW.js";
import { t as useHomepageConfig } from "./use-homepage-config-BhdnkhcC.js";
import { t as SocialIcons } from "./SocialIcons-n68DL3hs.js";
import { t as Header } from "./Header-3Qtbr78A.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Route } from "./routes-BAbRdcPC.js";
...
function LiveVideo() {
	...
	const src = useMemo(() => {
		if (liveVideo.provider === "youtube") return `https://www.youtube-nocookie.com/embed/live_stream?channel=${liveVideo.youtubeChannelId}&autoplay=1&mute=${muted ? 1 : 0}&controls=1&modestbranding=1&rel=0&playsinline=1&enablejsapi=1`;
	...
	leads.forEach((featured, index) => {
		...
		if (showMultiple) {
			if (featuredAdMode === "script" && featuredAdScript) carouselItems.push(/* @__PURE__ */ jsx(CarouselItem, { children: /* @__PURE__ */ jsxs("div", {
				...
				}), /* @__PURE__ */ jsx(ScriptAdRenderer, { script: featuredAdScript })]
			}) }, `ad-${index}`));
				...
				carouselItems.push(/* @__PURE__ */ jsx(CarouselItem, { children: /* @__PURE__ */ jsx("a", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("img", {
							...
							children: /* @__PURE__ */ jsx("span", {
								className: "inline-flex items-center rounded-md bg-black/80 px-2.5 py-1 text-[10px] md:text-xs font-bold uppercase tracking-wider text-white shadow-lg backdrop-blur-xs border border-white/20",
								children: ad.label ? ad.label.toUpperCase() : "SPONSORED"
							})
						})]
					})
				}) }, `ad-${index}`));
...
var HeroBoard = React.memo(function HeroBoard({ articles = [], tags = [], usedIds }) {
	...
	const { activeLeads, activeLeftItems, activeBottomItems, activePopularItems, activeOpinionItems, activeCultureItems } = React.useMemo(() => {
		...
		const leads = Array.from({ length: slideCount }).map((_, i) => {
		...
		const bottom = Array.from({ length: 6 }).map((_, i) => {
		...
		const popular = Array.from({ length: 4 }).map((_, i) => {
		...
		const opinion = Array.from({ length: 6 }).map((_, i) => {
		...
		return {
			...
			activeCultureItems: Array.from({ length: 4 }).map((_, i) => {
...
var Columnists = lazy(() => import("./Columnists-B7leD2-c.js").then((m) => ({ default: m.Columnists })));
var NewsGrid = lazy(() => import("./NewsGrid-BO3NlSyt.js").then((m) => ({ default: m.NewsGrid })));
var ReelsSection = lazy(() => import("./ReelsSection-kXJDiMmc.js").then((m) => ({ default: m.ReelsSection })));
var MarketsMagazine = lazy(() => import("./MarketsMagazine-CxgYtpgH.js").then((m) => ({ default: m.MarketsMagazine })));
var Footer = lazy(() => import("./Footer-CEkQVHJH.js").then((n) => n.n).then((m) => ({ default: m.Footer })));
function Home() {
...
//# sourceMappingURL=routes-BCmTQkaB.js.map