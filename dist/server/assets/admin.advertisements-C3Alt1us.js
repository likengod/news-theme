import { A as savePopupConfig, C as restoreFromTrash, D as saveAds, E as saveAdSlotScript, F as trashAds, S as purgeFromTrash, T as saveAdSlotMode, a as deleteAdStaticFilesServer, b as loadTrash, g as loadAds, h as loadAdSlotScript, m as loadAdSlotMode, p as loadAdRotation, r as defaultPopupConfig, v as loadPopupConfig, w as saveAdRotation, x as processExpiredAds } from "./site-content-D2ezJ40R.js";
import { a as useSiteSettings } from "./AdSettingsContext-DI_6VrNB.js";
import { r as trackUpload } from "./media-library-DRShNXju.js";
import { t as LibraryPicker } from "./MediaField-BHY-29Mu.js";
	...
	const onPurge = async (id) => {
		...
		if (item) {
			const urlsToDelete = [
				...
				item.imagePortrait,
				item.imageLandscape
			].filter((url) => !!url && typeof url === "string" && url.startsWith("/uploads/ads/"));
...
//# sourceMappingURL=admin.advertisements-C3Alt1us.js.map