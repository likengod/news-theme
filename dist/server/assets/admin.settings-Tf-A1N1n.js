...
import { t as Route } from "./admin.settings-BJwLNfCo.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-D6Ed5tCI.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-CBWA0JWb.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BeLbGOhv.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BoW3auvM.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-aJ_uq6nK.js").then((m) => ({ default: m.BackupRestoreTab })));
