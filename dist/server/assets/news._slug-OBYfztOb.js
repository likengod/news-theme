import { y as loadSettings } from "./site-content-J6c_9Nu1.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-C3Uwmsmy.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-LaipmE94.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-UCEXxtXk.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CFPbewly.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-OBYfztOb.js.map