import { a as buildGoogleFontsUrl, c as generateFontId, d as loadFontConfig, f as saveFontConfig, i as buildFontFaceCss, l as getFontById, n as FONT_SECTIONS, r as GOOGLE_FONTS_CATALOG } from "./font-config-DnWJuT-1.js";
...
//#region src/components/admin/settings/fonts/FontLibraryTable.tsx
function FontLibraryTable({ fonts, search, onSearchChange, previewText, onOpenCatalog, onOpenCustomModal, onUploadFont, onSetDefault, onDeleteFont }) {
	const filteredFonts = fonts.filter((f) => f.name.toLowerCase().includes(search.toLowerCase()) || f.family.toLowerCase().includes(search.toLowerCase()));
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(UploadButton, { onUpload: onUploadFont })
			]
		}),
		/* @__PURE__ */ jsxs("p", {
			...
			children: [
				...
				fonts.length !== 1 ? "s" : "",
				" registered",
				defaultFontEntry && /* @__PURE__ */ jsxs(Fragment, { children: [
					" ",
					"· Default: ",
					/* @__PURE__ */ jsx("strong", {
...
//#endregion
//#region src/components/admin/settings/fonts/FontSectionMapping.tsx
function FontSectionMapping({ config, previewText, onSectionChange }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: "Section Font Mapping"
				}), /* @__PURE__ */ jsx("p", {
					className: "text-xs text-slate-500 mt-0.5",
					children: "Assign different fonts to different sections of your website."
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "px-6 py-5",
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					className: "text-base font-bold text-slate-900",
					children: "Font Usage Map"
				}), /* @__PURE__ */ jsx("p", {
					className: "text-xs text-slate-500 mt-0.5",
					children: "Where each font section applies across frontend and backend."
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "px-6 py-5",
				children: /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/admin/settings/fonts/FontLivePreview.tsx
function FontLivePreview({ config, previewText, onPreviewTextChange }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "rounded-lg border border-slate-200 bg-white shadow-sm",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "border-b border-slate-100 px-6 py-4",
			children: [/* @__PURE__ */ jsx("h2", {
				className: "text-base font-bold text-slate-900",
				children: "Live Font Preview"
			}), /* @__PURE__ */ jsx("p", {
				className: "text-xs text-slate-500 mt-0.5",
				children: "See how your font selections look across different sections."
			})]
		}), /* @__PURE__ */ jsxs("div", {
			className: "px-6 py-5",
			children: [/* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/admin/settings/fonts/GoogleFontsCatalogModal.tsx
function GoogleFontsCatalogModal({ fonts, onAdd, onClose }) {
...
//#endregion
//#region src/components/admin/settings/fonts/CustomFontModal.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						className: "text-base font-bold text-slate-900",
						children: "Font Library"
					}), /* @__PURE__ */ jsx("p", {
						className: "text-xs text-slate-500 mt-0.5",
						children: "Manage all fonts available on your website. System fonts cannot be deleted."
					})]
				}), /* @__PURE__ */ jsx("div", {
					className: "px-6 py-5",
					children: /* @__PURE__ */ jsx(FontLibraryTable, {
						fonts: config.fonts,
						search,
			...
			/* @__PURE__ */ jsx(FontSectionMapping, {
				config,
				previewText,
				onSectionChange: handleSectionChange
			}),
			/* @__PURE__ */ jsx(FontLivePreview, {
				config,
				previewText,
				onPreviewTextChange: setPreviewText
			}),
			showCatalog && /* @__PURE__ */ jsx(GoogleFontsCatalogModal, {
				fonts: config.fonts,
...
//# sourceMappingURL=FontSettingsTab-BtnVFqiA.js.map