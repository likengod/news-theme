//#region src/lib/site-content/default-pages.ts
var defaultPages = [
	{
		slug: "about",
		title: "About Us",
	...
	},
	{
		...
		intro: "News Theme adheres to strict journalistic verification standards. This policy details how our newsroom checks facts, cross-references sources, and upholds factual accuracy across all coverage.",
		body: "",
		sections: [
			{
				heading: "Commitment to Truth & Accuracy",
				body: "<p>Accuracy is the foundation of our journalism. Every statement of fact, data point, quotation, and investigative disclosure is verified prior to publication. When unconfirmed breaking news occurs, we clearly identify information as provisional until official confirmation is obtained.</p>"
			},
			{
				heading: "Multi-Source Verification Standard",
				body: "<p>We require at least two independent primary or eyewitness sources to corroborate any factual claim that is not on the public record. Primary documentation — such as government notifications, court records, forensic reports, and official press briefings — is always preferred over secondary accounts.</p>"
			},
			{
				heading: "Verification of Social Media & Digital Media",
				body: "<p>User-generated photos, videos, and social media posts undergo strict verification prior to use. Our editorial desk utilizes reverse-image searches, EXIF metadata analysis, geolocation verification, and weather/shadow checks to ensure media has not been manipulated, miscaptioned, or generated via deepfake technology.</p>"
			},
			{
				heading: "Expert Review for Specialized Topics",
				body: "<p>For specialized beats including legal proceedings, economic data, scientific developments, and public health directives, reporters consult accredited subject-matter experts to ensure proper context and accurate interpretation.</p>"
			},
			{
				heading: "Transparency & Sourcing Disclosure",
				body: "<p>We inform readers of how we know what we report. Sources are named whenever possible. When safety or privacy requires source anonymity, the reason is disclosed to readers, and the source's identity and credentials must be vetted by an executive editor.</p>"
			},
			{
				heading: "Reader Corrections & Dispute Reporting",
				body: "<p>If you believe an assertion in any of our reports is factually incorrect, we welcome your dispute. Please visit our <a class=\"underline\" href=\"/contact\">contact page</a> or email <a class=\"underline\" href=\"mailto:corrections@todaytripura.com\">corrections@todaytripura.com</a> with supporting evidence. Our editorial desk investigates all substantiated claims within 24 hours.</p>"
			}
		]
	}
];
