import { d as loadAdSlotMode, f as loadAdSlotScript, m as loadPopupConfig, o as defaultPopupConfig, p as loadAds, u as loadAdRotation } from "./ads-storage-B_sJwqsS.js";
import { n as useAdSettings } from "./AdSettingsContext-BlB9C6Qc.js";
import { n as currentRoleSeesPopups } from "./roles-psIYcOWm.js";
...
function PopupAd() {
	...
	const isEnterprise = (ctx?.settings?.licenseType || ctx?.siteSettings?.licenseType || "").toLowerCase().includes("enterprise");
...
//# sourceMappingURL=PopupAd-qS53pngp.js.map