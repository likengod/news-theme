import { A as saveSettings, _ as loadSettings } from "./site-content-Qu-YqMN0.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BJIYOCLZ.js";
import { t as Route } from "./admin.settings-D6dIOANI.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DStAFOCZ.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DX78eXj0.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-CwM1afbP.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-C-13J0DM.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BDvOJ6u6.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CGeZrHeL.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DLVks3ma.js").then((m) => ({ default: m.BackupRestoreTab })));
