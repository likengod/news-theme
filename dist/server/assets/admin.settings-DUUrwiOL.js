import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-CG96yiVx.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-Twynzzrg.js";
import { t as Route } from "./admin.settings-B-erTBf7.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BTqzqTOq.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-Bc8vG3cz.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-DUn08NiI.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-D6zyFair.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BrmdOpWN.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CjLgEFQY.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-CXVA07Zm.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-DUUrwiOL.js.map