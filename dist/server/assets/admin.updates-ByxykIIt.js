import { i as gitPull, n as getDeployLog, r as getGitStatus, t as getDeployHistory } from "./deploy.functions-De5jJ0mU.js";
...
function UpdatesPage() {
	...
	const handlePullAndUpdate = async () => {
		...
		try {
			...
			if (Boolean(res?.updated || res?.data?.updated || res?.result?.updated || res?.success)) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "flex flex-wrap items-center justify-between gap-3 border-b border-slate-200/80 pb-3 sm:pb-4",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-600",
					children: [/* @__PURE__ */ jsx(Layers, { className: "h-4 w-4 text-slate-500 shrink-0" }), /* @__PURE__ */ jsx("span", { children: "System Core Update" })]
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [updatesAvailable ? /* @__PURE__ */ jsxs("button", {
						...
						children: [pulling ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin text-white shrink-0" }) : /* @__PURE__ */ jsx(Zap, { className: "h-3.5 w-3.5 fill-white text-white shrink-0" }), /* @__PURE__ */ jsx("span", { children: pulling ? "Updating System..." : `Update to ${latestVersion}` })]
					}) : /* @__PURE__ */ jsxs("div", {
						className: "inline-flex items-center gap-1.5 rounded-lg sm:rounded-xl bg-slate-100 px-3 py-1.5 sm:px-4 sm:py-2 text-[11px] sm:text-xs font-bold text-slate-600 border border-slate-200 whitespace-nowrap",
						children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5 text-emerald-500 shrink-0" }), /* @__PURE__ */ jsxs("span", { children: [
							"Updated (",
							currentVersion,
							")"
						] })]
			...
			/* @__PURE__ */ jsxs("div", {
				className: "rounded-xl sm:rounded-2xl border border-slate-200/80 bg-white shadow-xs overflow-hidden",
				children: [/* @__PURE__ */ jsx("div", {
					className: "border-b border-slate-100 px-4 py-3 sm:px-6 sm:py-4",
					...
					className: "flex flex-col items-center justify-center py-10 sm:py-12 text-slate-400",
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							className: "text-xs",
							children: "Click \"Update Now\" to create a record."
						})
					]
				}) : /* @__PURE__ */ jsx("ul", {
					...
					children: deployments.slice(0, 1).map((d) => {
						...
						return /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsx("span", {
												className: "rounded-full bg-slate-100 px-2 py-0.5 text-[9px] sm:text-[10px] font-medium text-slate-600",
												children: d.branch
											})
										]
									}), /* @__PURE__ */ jsx("p", {
								...
								isExpanded ? /* @__PURE__ */ jsx(ChevronUp, { className: "h-4 w-4 text-slate-400 shrink-0" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4 text-slate-400 shrink-0" })
							]
						}), isExpanded && /* @__PURE__ */ jsx("div", {
							className: "border-t border-slate-800 bg-slate-950 px-4 py-3 sm:px-6 sm:py-4",
