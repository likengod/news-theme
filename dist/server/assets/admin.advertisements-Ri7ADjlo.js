import { A as savePopupConfig, C as restoreFromTrash, D as saveAds, E as saveAdSlotScript, F as trashAds, S as purgeFromTrash, T as saveAdSlotMode, a as deleteAdStaticFilesServer, b as loadTrash, g as loadAds, h as loadAdSlotScript, m as loadAdSlotMode, p as loadAdRotation, r as defaultPopupConfig, v as loadPopupConfig, w as saveAdRotation, x as processExpiredAds } from "./site-content-CDp-F3e7.js";
import { a as useSiteSettings } from "./AdSettingsContext-BSMUGK-H.js";
import { r as trackUpload } from "./media-library-BZeF0HRk.js";
import { t as LibraryPicker } from "./MediaField-6cCFwcVa.js";
...
function AdvertisementsPage() {
	...
	(s.licenseRole || "").toLowerCase();
	(s.licenseKey || "").toUpperCase();
	planType.includes("premium") || planType.includes("enterprise");
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "flex flex-wrap items-center justify-between gap-3 rounded-xl border border-emerald-200 bg-emerald-50/80 px-4 py-2.5 text-xs text-emerald-950 shadow-2xs",
				children: /* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2.5",
					children: [/* @__PURE__ */ jsx("span", {
						className: "rounded-md bg-emerald-600 px-2 py-0.5 text-[10px] font-extrabold uppercase tracking-wider text-white shadow-xs",
						children: "WebP Format Only"
					}), /* @__PURE__ */ jsxs("span", {
						className: "font-medium text-emerald-900",
						children: [
							"All banner and reel advertisements support ",
							/* @__PURE__ */ jsx("strong", { children: "WebP (.webp)" }),
							" images for maximum Google PageSpeed performance. When you select or upload any image, it is automatically verified and converted to WebP."
						]
					})]
				})
			}),
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [SLOTS.map((s) => {
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							className: `group flex items-center gap-2 rounded-t-lg border-b-2 px-4 py-2.5 text-sm font-semibold transition-all ${isActive ? "border-slate-900 bg-slate-900 text-white shadow-xs" : "border-transparent text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx("span", { children: s.label }), isLocked]
							}), /* @__PURE__ */ jsx("span", {
						...
						className: `group flex items-center gap-2 rounded-t-lg border-b-2 px-4 py-2.5 text-sm font-semibold transition-all ${tab === "trash" ? "border-slate-900 bg-slate-900 text-white shadow-xs" : "border-transparent text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-1.5",
							children: [/* @__PURE__ */ jsx(Trash2, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Trash" })]
						}), /* @__PURE__ */ jsx("span", {
							className: `rounded-full px-2 py-0.5 text-[10.5px] font-bold ${tab === "trash" ? "bg-slate-700 text-slate-200" : "bg-slate-200 text-slate-600 group-hover:bg-slate-300"}`,
							children: trash.length
						})]
					})]
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Label, {
								htmlFor: "mode-switch",
								className: `text-xs font-semibold ${(tab === "popup" || tab === "leaderboard") && !isEnterprise ? "text-slate-400 cursor-not-allowed" : "text-slate-900 cursor-pointer"}`,
			...
			(tab === "hero_showcase" || tab === "reel_ads") && !isEnterprisePlus ? /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("p", {
						...
						children: [
							"The",
							" ",
							tab === "hero_showcase" || tab === "reel_ads" ? SLOTS.find((s) => s.key === tab)?.label : tab === "popup" ? "Popup" : "Leaderboard",
							" ",
							"advertisement slot is exclusively available on",
							" ",
							tab === "hero_showcase" || tab === "reel_ads" ? "Enterprise+" : "Premium",
							" licenses. Please upgrade your license to unlock this slot."
						]
					}),
					/* @__PURE__ */ jsx("button", {
						onClick: () => navigate({
				...
				children: [
							...
							children: [
								tab !== "popup" && /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-3.5 w-3.5 ml-1 text-slate-400" })
									]
								}),
								ads.length > 0 && /* @__PURE__ */ jsxs("div", {
									className: "relative",
								...
								/* @__PURE__ */ jsxs("button", {
									...
									className: `inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-xs transition ${!isEnterprise && ads.length >= 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-emerald-500 active:scale-98"}`,
					...
					ads.length === 0 ? /* @__PURE__ */ jsxs("div", {
						...
						ref: tableRef,
						className: "space-y-4",
						children: paginatedAds.map((ad, indexOnPage) => {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("button", {
												...
												className: `inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-xs font-bold transition shadow-2xs ${isFeatured ? "bg-amber-500 text-white hover:bg-amber-600" : "border border-slate-200 bg-white text-slate-600 hover:border-amber-400 hover:text-amber-700 hover:bg-amber-50/50"} ${!isEnterprise && "opacity-50 cursor-not-allowed"}`,
												children: [
													/* @__PURE__ */ jsx(Star, { className: `h-3.5 w-3.5 ${isFeatured ? "fill-white" : "text-amber-500"}` }),
													isFeatured ? "Featured (First)" : "Mark Featured",
													!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-3 w-3 ml-0.5 text-slate-400" })
												]
											}),
											/* @__PURE__ */ jsxs("div", {
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [
													...
													!isEnterprise && /* @__PURE__ */ jsx(Lock, { className: "h-3 w-3 text-slate-300" })
												]
											}),
											/* @__PURE__ */ jsx("button", {
												type: "button",
...
//# sourceMappingURL=admin.advertisements-Ri7ADjlo.js.map