import { o as loadSettings, s as saveSettings, t as cleanCopyright } from "./site-settings-TC6eL9IL.js";
import { a as useSiteSettings } from "./AdSettingsContext-BkhFbsEU.js";
import { a as LogoUploader } from "./SettingsHelpers-DBdVv9mu.js";
import { r as getContrastRatio, t as ensureAccessibleColor } from "./color-utils-4ZE3UgVW.js";
import { t as Route } from "./admin.settings-B15l6bkA.js";
		...
		children: [
					...
					/* @__PURE__ */ jsxs("div", { children: [
						...
						/* @__PURE__ */ jsxs("select", {
							...
							children: [
								/* @__PURE__ */ jsx("option", {
									value: "both",
									children: "Both: Logo + Text (Side-by-Side — Reference Style)"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "both_stacked",
									children: "Both: Logo + Text (Stacked Vertical)"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "logo_fit",
									children: "Logo: Fit Screen (Full Width Banner)"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "logo_only",
									children: "Logo Only (Standard)"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "text_only",
									children: "Text Only"
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("input", {
								...
								htmlFor: "logoFitScreen",
								className: "text-xs font-medium text-slate-700 cursor-pointer",
								children: "Logo must fit the screen (Responsive full-width scaling)"
							})]
						})
					] }),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						className: "mb-4 rounded-xl border border-slate-200 bg-slate-50/90 p-5 text-center shadow-inner overflow-hidden",
						children: [
							/* @__PURE__ */ jsx("span", {
								className: "text-[10px] uppercase font-bold tracking-widest text-slate-400 block mb-3",
								children: "Live Header Preview"
							}),
							(!settings.logoDisplayMode || settings.logoDisplayMode === "both") && /* @__PURE__ */ jsxs("div", {
								className: "inline-flex items-center justify-center gap-3 sm:gap-4 md:gap-5 text-left max-w-full",
								children: [/* @__PURE__ */ jsx("div", {
									className: "shrink-0 flex items-center justify-center",
									children: settings.logoLight ? /* @__PURE__ */ jsx("img", {
										...
										children: /* @__PURE__ */ jsx("span", {
											...
											children: (settings.logoTextPrimary || "N").charAt(0)
										})
									})
								}), /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										className: "mt-1 text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-500",
										children: settings.tagline || "BREAKING NEWS · FINANCE · BUSINESS · MARKETS"
									})]
								})]
							}),
							settings.logoDisplayMode === "both_stacked" && /* @__PURE__ */ jsxs("div", {
								className: "flex flex-col items-center justify-center text-center",
								children: [
									settings.logoLight ? /* @__PURE__ */ jsx("img", {
										src: settings.logoLight,
										alt: "Logo preview",
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("span", {
												style: { color: settings.logoColorPrimary || "#000000" },
												children: settings.logoTextPrimary || "NEWS"
											}),
											" ",
											/* @__PURE__ */ jsx("span", {
												style: { color: settings.logoColorSecondary || "#dc2626" },
												children: settings.logoTextSecondary || "THEME"
											})
										]
									}),
									/* @__PURE__ */ jsx("div", {
							...
							(settings.logoDisplayMode === "logo_fit" || settings.logoDisplayMode === "logo_only") && /* @__PURE__ */ jsx("div", {
								className: "flex items-center justify-center",
								children: settings.logoLight ? /* @__PURE__ */ jsx("img", {
									src: settings.logoLight,
									alt: "Logo preview",
									className: settings.logoDisplayMode === "logo_fit" || settings.logoFitScreen ? "w-full max-w-md h-auto max-h-24 object-contain mx-auto" : "h-14 object-contain mx-auto"
								}) : /* @__PURE__ */ jsxs("div", {
									className: "text-xs text-slate-400 italic py-2",
									children: ["Upload a logo image in Logo Uploaders to preview ", settings.logoDisplayMode === "logo_fit" ? "Fit Screen" : "Logo Only"]
								})
							}),
							settings.logoDisplayMode === "text_only" && /* @__PURE__ */ jsxs("div", {
								className: "flex flex-col items-center justify-center text-center",
								children: [/* @__PURE__ */ jsxs("div", {
									...
									className: "mt-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-500",
									children: settings.tagline || "BREAKING NEWS · FINANCE · BUSINESS · MARKETS"
								})]
							})
						]
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", { children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: priIsAccessible ? /* @__PURE__ */ jsxs("span", {
											className: "inline-flex items-center text-emerald-600 font-medium",
											children: [
												"✓ WCAG AA (",
												priContrastLight.toFixed(1),
												":1 contrast)"
											]
										}) : /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", { children: [
									...
									/* @__PURE__ */ jsx("div", {
										className: "mt-1.5 flex items-center justify-between text-[11px]",
										children: secIsAccessible ? /* @__PURE__ */ jsxs("span", {
											className: "inline-flex items-center text-emerald-600 font-medium",
											children: [
												"✓ WCAG AA (",
												secContrastLight.toFixed(1),
												":1 contrast)"
											]
										}) : /* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-1.5",
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-DpNyyj2c.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CBW3GbSD.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-ITP4LN4h.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-kPO4fA0p.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-IrwL7m8S.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BXjyQ43Y.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-Cxfq55IA.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DEDkPeWf.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-3afonx1f.js").then((m) => ({ default: m.SpeedOptimizationTab })));
