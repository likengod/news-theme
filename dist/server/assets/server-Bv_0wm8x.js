...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-1E-gKxo9.js";
import { a as getStartContext, c as safeObjectMerge, d as TSS_FORMDATA_CONTEXT, f as TSS_SERVER_FUNCTION, i as flattenMiddlewares, l as FrameType, m as X_TSS_SERIALIZED, n as getDefaultSerovalPlugins, o as runWithStartContext, p as X_TSS_RAW_RESPONSE, s as createNullProtoObject, t as mergeHeaders, u as TSS_CONTENT_TYPE_FRAMED_VERSIONED } from "./esm-B50dUWcE.js";
import { n as createCsrfMiddleware } from "./createStart-DwZhSttb.js";
import "react";
import { RouterProvider } from "@tanstack/react-router";
import { jsx } from "react/jsx-runtime";
import { defineHandlerCallback, renderRouterToStream } from "@tanstack/react-router/ssr/server";
import { createRawStreamRPCPlugin, createSerializationAdapter, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound as isNotFound$1, isRedirect as isRedirect$1, isResolvedRedirect, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-GfMGhGL5.js");
...
var handleServerAction = async ({ request, context, serverFnId }) => {
	...
	return await (async () => {
		try {
			...
			if (isNotFound$1(res)) res = isNotFoundResponse(res);
			...
			if (isNotFound$1(error)) return isNotFoundResponse(error);
			console.info();
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-H1bWpvnb.js"),
		import("./start-BwayRXN8.js"),
...
//# sourceMappingURL=server-Bv_0wm8x.js.map