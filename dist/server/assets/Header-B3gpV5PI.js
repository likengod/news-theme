import { a as isEnterprisePlusLicense, n as defaultSettings, o as loadSettings } from "./site-settings-TC6eL9IL.js";
import { a as useSiteSettings, r as useCategories } from "./AdSettingsContext-BkhFbsEU.js";
import { a as sections, s as tickers } from "./news-data-CFwG4BZ_.js";
import { o as getTopTags } from "./taxonomy.functions-CuyFiXig.js";
import { l as setCurrentRoleId } from "./roles-Bg4d9Faw.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DmIfwHIz.js";
import { r as useTheme } from "./theme-Dgo_akud.js";
...
function TopBar() {
	...
	const allItems = dbCats.length > 0 ? [...dbCats].sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0)).map((c) => c.name) : sections.filter((s) => s !== "Others").concat(otherCategories$1);
	useEffect(() => {
		...
		const timer = setTimeout(() => {
			...
			fetch("https://get.geojs.io/v1/ip/geo.json").then((res) => res.json()).then((data) => {
				if (data && data.city) {
					const aqiStr = `${data.city.substring(0, 3).toUpperCase()} ${Math.floor(Math.random() * 100) + 40} AQI`;
					setLocalAqi(aqiStr);
					try {
											...
											children: [/* @__PURE__ */ jsxs(SheetTitle, {
												...
												children: [
													/* @__PURE__ */ jsx("span", {
														...
														children: settings.logoTextPrimary !== void 0 && settings.logoTextPrimary !== "" ? settings.logoTextPrimary : settings.logoText ? settings.logoText.split(" ")[0] : "Today"
													}),
													" ",
													/* @__PURE__ */ jsx("span", {
														style: { color: getAccessibleLogoColor(settings.logoColorSecondary || "#dc2626", isDark, 4.5) },
														children: settings.logoTextSecondary !== void 0 && settings.logoTextSecondary !== "" ? settings.logoTextSecondary : settings.logoText && settings.logoText.split(" ").length > 1 ? settings.logoText.split(" ").slice(1).join(" ") : "Tripura"
													})
												]
											}), /* @__PURE__ */ jsx("p", {
...
function Masthead() {
	...
	if (dbCats.length > 0) {
		const explicitHeaderCats = dbCats.filter((c) => c.showInHeader).sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0)).map((c) => c.name);
		const dropdownCats = dbCats.filter((c) => !c.showInHeader).sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0)).map((c) => c.name);
		if (explicitHeaderCats.length > 0) {
			...
			const allCatNames = [...dbCats].sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0)).map((c) => c.name);
	...
	const primaryWord = s.logoTextPrimary !== void 0 && s.logoTextPrimary !== "" ? s.logoTextPrimary : s.logoText ? s.logoText.split(" ")[0] : "Today";
	const secondaryWord = s.logoTextSecondary !== void 0 && s.logoTextSecondary !== "" ? s.logoTextSecondary : s.logoText && s.logoText.split(" ").length > 1 ? s.logoText.split(" ").slice(1).join(" ") : "Tripura";
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("header", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("h1", {
								...
								className: "mt-1.5 sm:mt-2 text-[9px] sm:text-[11px] md:text-xs font-semibold uppercase tracking-[0.16em] sm:tracking-[0.24em] md:tracking-[0.32em] text-foreground/80 dark:text-foreground/85",
								children: taglineContent
							})]
						})]
					})
				}),
				(mode === "logo_fit" || mode === "logo_only" && isFitScreen) && !isSideBySide && /* @__PURE__ */ jsx(Link, {
					to: "/",
				...
				!isSideBySide && mode !== "logo_fit" && !(mode === "logo_only" && isFitScreen) && /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs(Link, {
					to: "/",
					className: "block",
					children: [
						...
						showText ? /* @__PURE__ */ jsxs("h1", {
							...
							className: "sr-only",
							children: s.logoText || "Today Tripura"
						})
					]
				}), showText && /* @__PURE__ */ jsx("p", {
					className: "mt-2.5 sm:mt-3 block text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.18em] sm:tracking-[0.25em] md:tracking-[0.35em] text-foreground/80 dark:text-foreground/85",
					children: taglineContent
				})] })
			]
		})
	}), /* @__PURE__ */ jsx("nav", {
		className: "hidden border-t border-border md:block md:sticky md:top-11 md:z-30 md:bg-background md:border-b h-11",
