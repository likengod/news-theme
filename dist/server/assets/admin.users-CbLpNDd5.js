...
function UserFilterBar({ q, onSearchChange, roleFilter, onRoleFilterChange, sort, onSortChange, roles, onCreateClick, isEnterprisePlus = false }) {
...
function UserTable({ users, currentUserId, roles, selectedIds, onToggleSelect, onToggleSelectAll, onBulkDelete, onBulkStatusChange, onClearSelection, onSetRole, onToggleBan, onDelete, onRegenId, onOpenModal, isEnterprisePlus = false }) {
...
function UserActionModal({ kind, row, onClose, onSavePoints, onSavePassword, onSaveDetails }) {
	...
	if (kind === "points" && !isEnterprisePlus) return null;
...
function UsersPage() {
	...
	const limit = 20;
	const effectiveSort = !isEnterprisePlus && (sort === "points_desc" || sort === "points_asc") ? "recent" : sort;
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					children: isEnterprisePlus ? "Server-paginated list of registered users, roles, public IDs, and points." : "Server-paginated list of registered users, roles, and public IDs."
				})] }), /* @__PURE__ */ jsxs("div", {
					className: "flex flex-wrap items-center gap-1.5 sm:gap-2",
					children: [/* @__PURE__ */ jsx(CsvImportExport, {
						data: rows,
						getData: async () => allUsers,
						filename: "users",
						onImport: handleImport
					}), /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-1.5 sm:gap-2 rounded-lg bg-slate-100 px-2.5 sm:px-3 py-1.5 text-xs font-bold text-slate-700 whitespace-nowrap",
						children: [
							/* @__PURE__ */ jsx(Users, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
							" Total Users: ",
							total
						]
					})]
...
//# sourceMappingURL=admin.users-CbLpNDd5.js.map