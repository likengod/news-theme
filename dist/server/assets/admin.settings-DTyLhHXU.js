import { T as saveSettings, p as loadSettings } from "./site-content-C4QIhjym.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-ROZIy_z_.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DMgOxfZm.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-r2cl7xmd.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-CwzMqzy0.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BZWqGowR.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-7wda6FU_.js").then((m) => ({ default: m.BackupRestoreTab })));
