import { y as loadSettings } from "./site-content-C7W_w-Y_.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BgpEI5it.js";
...
var RelatedNews = lazy(() => import("./RelatedNews-DbiDDfdc.js").then((m) => ({ default: m.RelatedNews })));
var CommentsSection = lazy(() => import("./CommentsSection-UjcLaREw.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-QU1IIBkX.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CQHsQlit.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-C7K0e88g.js.map