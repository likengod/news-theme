	...
	const commentFormFields = (isReply, n, setN, em, setEm, dr, setDr, sub, onSubmit, onCancel, replyToName) => isReply ? /* @__PURE__ */ jsxs("form", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				className: "w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center shrink-0 mt-0.5 text-xs font-bold text-primary uppercase",
				children: userDisplayName?.[0] || "?"
			}), /* @__PURE__ */ jsxs("div", {
				className: "flex-1",
...
//# sourceMappingURL=CommentsSection-DT3E9P9X.js.map