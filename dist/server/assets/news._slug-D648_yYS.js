import { m as loadSettings } from "./site-content-DZR5pktS.js";
import { a as useSiteSettings } from "./AdSettingsContext-Qxkw-Lxv.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-R057DNxr.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-B7gCWdq8.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DGPYD-Vv.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CJNTI-hz.js").then((m) => ({ default: m.PopupAd })));
