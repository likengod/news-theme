import { _ as loadSettings } from "./site-content-C32CLrYw.js";
import { a as useSiteSettings } from "./AdSettingsContext-C3xuSG6E.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-UHCJpkth.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-R7H7WCdH.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-B7DpBboi.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DG7atyoh.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CIkC8sdC.js").then((m) => ({ default: m.PopupAd })));
