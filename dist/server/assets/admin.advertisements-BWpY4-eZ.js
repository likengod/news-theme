import { C as saveAdSlotScript, D as savePopupConfig, M as trashAds, S as saveAdSlotMode, _ as loadTrash, b as restoreFromTrash, d as loadAdSlotMode, f as loadAdSlotScript, h as loadPopupConfig, n as defaultPopupConfig, p as loadAds, u as loadAdRotation, v as processExpiredAds, w as saveAds, x as saveAdRotation, y as purgeFromTrash } from "./site-content-C7PDzOFw.js";
import { a as useSiteSettings } from "./AdSettingsContext-Caoc-BwM.js";
...
import { ArrowDown, ArrowUp, Clock, Code, ExternalLink, FolderOpen, Image, Info, Lock, Plus, RotateCcw, Save, Sparkles, Star, Timer, Trash, Trash2, Upload, X } from "lucide-react";
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
											...
											children: slot === "home1" || slot === "ad3" ? "Upload Banner Image (Portrait 3:4)" : slot === "home2" ? "Upload Banner Image (Landscape ~2:1)" : "Upload Banner Images"
