import { a as saveSettings, i as loadSettings, t as cleanCopyright } from "./site-settings-CWrJWD5w.js";
import { a as useSiteSettings } from "./AdSettingsContext-CToAjqf3.js";
import { a as LogoUploader } from "./SettingsHelpers-yf0yG46B.js";
import { t as Route } from "./admin.settings-CbC7kcbW.js";
...
function GeneralSettingsForm() {
	...
	useEffect(() => {
		if (contextSettings && Object.keys(contextSettings).length > 0) setSettings((prev) => ({
			...prev,
			...contextSettings,
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-Bn5HQowS.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DPKmQZFm.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BWZiGN-U.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-D7Jf60r7.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-Bqx6MUe6.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-CFMURz66.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-BPOf_WHb.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-BI-rl_Bm.js").then((m) => ({ default: m.SpeedOptimizationTab })));
...
//# sourceMappingURL=admin.settings-0oV-pTD5.js.map