import { C as saveAdSlotMode, N as trashAds, O as savePopupConfig, S as saveAdRotation, T as saveAds, b as purgeFromTrash, d as loadAdRotation, f as loadAdSlotMode, g as loadPopupConfig, m as loadAds, n as defaultPopupConfig, p as loadAdSlotScript, v as loadTrash, w as saveAdSlotScript, x as restoreFromTrash, y as processExpiredAds } from "./site-content-CvnW9Ioy.js";
import { a as useSiteSettings } from "./AdSettingsContext-DxZAB1-M.js";
import { r as trackUpload } from "./media-library-BrJ3I-ff.js";
import { t as LibraryPicker } from "./MediaField-CzprwNd0.js";
...
function DualImageCell({ ad, slot, onUpdate }) {
	...
	if (slot === "home1" || slot === "ad3") return /* @__PURE__ */ jsx("div", {
		className: "flex justify-center py-4 w-full bg-slate-50/50 rounded-xl border border-slate-100",
	...
	if (slot === "leaderboard") return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col sm:flex-row items-center justify-center gap-6 py-4 w-full bg-slate-50/50 rounded-xl border border-slate-100",
		children: [/* @__PURE__ */ jsx(SingleSlotImagePicker, {
			label: "Mobile View",
...
//# sourceMappingURL=admin.advertisements-DduKbHZD.js.map