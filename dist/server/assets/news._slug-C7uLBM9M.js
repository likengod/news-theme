import { _ as loadSettings } from "./site-content-PKpTBymQ.js";
import { a as useSiteSettings } from "./AdSettingsContext-COZcMgmG.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-CG4G2S0t.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DKVY2Z5I.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-864pz6mm.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-D8ZwNnPm.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-CgtCfc9v.js").then((m) => ({ default: m.PopupAd })));
