import { n as mediaLibrary, r as trackUpload, t as formatBytes } from "./media-library-CDA86zOP.js";
import { t as CsvImportExport } from "./CsvImportExport-DBalmz2g.js";
import { useEffect, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Copy, Edit2, FileText, LayoutGrid, List, Trash2, Upload, Video, X } from "lucide-react";
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsx("div", {
										...
										children: m.url && m.url.match(/\.(mp4|webm)$/i) || m.type === "video" ? /* @__PURE__ */ jsx(Video, { className: "h-5 w-5 text-slate-400" }) : m.url && m.url.match(/\.(pdf|doc|docx)$/i) || m.type === "document" ? /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5 text-slate-400" }) : /* @__PURE__ */ jsx("img", {
											src: m.url || "",
											alt: m.name,
