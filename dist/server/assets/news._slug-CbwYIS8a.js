import { i as loadSettings } from "./site-settings-CWrJWD5w.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-B-KLB6g2.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Bsp73NR3.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-DsgUG1yp.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BBH_XZRD.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-CbwYIS8a.js.map