import { g as loadAds, h as loadAdSlotScript, m as loadAdSlotMode, p as loadAdRotation, r as defaultPopupConfig, v as loadPopupConfig } from "./site-content-J6c_9Nu1.js";
...
function PopupAd() {
	...
	const isEnterprise = (ctx?.siteSettings?.licenseType || "").toLowerCase().includes("enterprise");
	let initialMode = ctx?.adConfig ? ctx.adConfig.modes["popup"] || "image" : loadAdSlotMode("popup");
	if (!isEnterprise) initialMode = "script";
...
//# sourceMappingURL=PopupAd-CFPbewly.js.map