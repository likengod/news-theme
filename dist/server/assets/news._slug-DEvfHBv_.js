import { y as loadSettings } from "./site-content-TDicWjWm.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-BhjOBwwf.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CfODvszV.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-B--4GjUn.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-5QZqT6sR.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-DEvfHBv_.js.map