import { m as loadSettings } from "./site-content-s03HcFGh.js";
import { a as useSiteSettings } from "./AdSettingsContext-_GukefZs.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-B2701YDJ.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DnbphUU_.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-B5XbfWiy.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-CQmKU3rW.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DjabfDKG.js").then((m) => ({ default: m.PopupAd })));
