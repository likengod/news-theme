import { y as loadSettings } from "./site-content-DSE9ENJP.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DI_tbUrK.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Dpk81qRp.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BhDmj1a6.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-DtL282ED.js").then((m) => ({ default: m.PopupAd })));
...
//# sourceMappingURL=news._slug-CTzpuc-R.js.map