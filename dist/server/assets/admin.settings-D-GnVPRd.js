import { M as saveSettings, n as clearAllCachesServer, y as loadSettings } from "./site-content-mpmAaJjd.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BTzpztKH.js";
import { t as Route } from "./admin.settings-DDRlvEb3.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BVHa6QMf.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-BKLQpfZu.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BIe0oRFA.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-8MoGe3JW.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-xIu5rKrH.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-8fy4je9V.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-Dpf1tRGB.js").then((m) => ({ default: m.BackupRestoreTab })));
...
//# sourceMappingURL=admin.settings-D-GnVPRd.js.map