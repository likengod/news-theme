...
import { a as getAdminComments, c as importCommentsFn, d as updateCommentStatus, f as generateDummyCommentsFn, i as formatCommentTimeAgo, l as lookupArticleByUrlOrSlugFn, n as deleteComment, o as getAllCommentsFn, r as extractSlugFromUrl, t as deleteAllCommentsFn } from "./comments.functions-BukFoXXF.js";
import { t as CsvImportExport } from "./CsvImportExport-cj5FA8rJ.js";
import { useEffect, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertCircle, Check, CheckCircle2, ChevronLeft, ChevronRight, Clock, ExternalLink, Flame, Link, Loader2, MessageSquare, Search, Sparkles, Trash2, X } from "lucide-react";
...
function CommentTable({ comments, onSetStatus, onDelete, onAiReply }) {
					...
					children: [
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: formatCommentTimeAgo(c.createdAt || c.date)
									}), c.parentId && /* @__PURE__ */ jsxs("span", {
										className: "text-[10px] text-slate-400 font-mono",
										children: ["↳ reply to #", c.parentId]
									})]
								})
							]
						}),
						/* @__PURE__ */ jsx("td", {
							className: "px-5 py-3 text-xs text-slate-700 max-w-sm whitespace-pre-line",
							children: c.body
						}),
						/* @__PURE__ */ jsx("td", {
						...
						/* @__PURE__ */ jsx("td", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									onAiReply && /* @__PURE__ */ jsxs("button", {
										onClick: () => onAiReply(c),
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3 text-blue-600" }), /* @__PURE__ */ jsx("span", { children: "AI Reply" })]
									}),
...
function AiGenerateModal({ isOpen, onClose, onSuccess, replyTarget }) {
	...
	const [targetReplyComment, setTargetReplyComment] = useState(replyTarget || null);
	...
	useEffect(() => {
		if (isOpen && replyTarget) {
			...
			setAiCount(2);
		} else if (isOpen && !replyTarget) setTargetReplyComment(null);
	}, [isOpen, replyTarget]);
	...
	const handleGenerateAi = async (e) => {
		...
		try {
			...
			toast.success(`Successfully generated ${res.count} realistic ${targetReplyComment ? "replies" : "comments"}!`);
			resetForm();
			onClose();
			onSuccess();
		} catch (err) {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-5 w-5 text-blue-600" }), targetReplyComment ? `Generate AI Reply to Comment #${targetReplyComment.id}` : "Generate AI Comments"]
				}), /* @__PURE__ */ jsx("p", {
				...
				children: [
					targetReplyComment && /* @__PURE__ */ jsxs("div", {
						className: "rounded-xl border border-sky-200 bg-sky-50/80 p-3 flex items-start justify-between gap-3 animate-in fade-in duration-150",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-start gap-2.5",
							children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4 text-sky-600 mt-0.5 shrink-0" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsxs("span", {
									className: "text-[10px] font-bold uppercase tracking-wider text-sky-800 bg-sky-100 px-2 py-0.5 rounded-full",
									children: ["Replying to #", targetReplyComment.id]
								}), /* @__PURE__ */ jsx("span", {
									className: "text-xs font-bold text-slate-800",
									children: targetReplyComment.user || "Anonymous"
								})]
							}), /* @__PURE__ */ jsxs("p", {
								className: "text-xs text-slate-700 mt-1 line-clamp-2 italic bg-white/80 p-1.5 rounded border border-sky-100",
								children: [
									"\"",
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("label", {
							...
							children: ["Number of ", targetReplyComment ? "Replies" : "Comments"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "text-xs font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full",
							children: [
								aiCount,
								" ",
								targetReplyComment ? "Replies" : "Comments"
							]
						})]
					}), /* @__PURE__ */ jsx("input", {
						id: "ai-comment-count",
					...
					/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("label", {
							className: "mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center justify-between",
							children: [/* @__PURE__ */ jsxs("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5 text-blue-600" }), "Comment Timing / Age Spread"]
							}), /* @__PURE__ */ jsx("span", {
								className: "text-[10px] text-blue-600 font-semibold bg-blue-50 px-2 py-0.5 rounded-full",
								children: "Realistic Timestamps"
							})]
						}),
						/* @__PURE__ */ jsxs("select", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("option", {
									value: "past_24_hours",
									children: "⏱️ Last 24 Hours"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "past_3_days",
									children: "📅 Last 3 Days [Recommended]"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "past_7_days",
									children: "🗓️ Last 7 Days"
								}),
								/* @__PURE__ */ jsx("option", {
									value: "past_30_days",
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Staggers timestamps naturally across the past so comments show as \"1 day ago\", \"8 hours ago\", or \"20 mins ago\" instead of all at the exact same minute."
						})
					] }),
					!targetReplyComment && aiCount >= 2 && /* @__PURE__ */ jsxs("div", {
						className: "rounded-xl border border-indigo-200 bg-indigo-50/70 p-3.5 space-y-3",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-start justify-between gap-3",
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
								...
								children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4 text-indigo-600 shrink-0" }), "Include Conversational Replies (Threaded Comments)"]
							}), /* @__PURE__ */ jsx("p", {
								className: "text-[11px] text-indigo-800 mt-0.5 leading-relaxed",
								children: "AI will generate realistic replies between readers debating or following up on earlier comments."
							})] }), /* @__PURE__ */ jsx("button", {
								type: "button",
								onClick: () => setAiIncludeReplies(!aiIncludeReplies),
								className: `relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition mt-0.5 ${aiIncludeReplies ? "bg-indigo-600" : "bg-slate-300"}`,
								children: /* @__PURE__ */ jsx("span", { className: `pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow transition ${aiIncludeReplies ? "translate-x-4" : "translate-x-0"}` })
							})]
						}), aiIncludeReplies && /* @__PURE__ */ jsxs("div", {
							className: "pt-2.5 border-t border-indigo-200/80 space-y-2.5 animate-in fade-in duration-150",
							children: [
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center justify-between",
									children: [/* @__PURE__ */ jsx("label", {
										className: "text-xs font-bold text-indigo-950 flex items-center gap-1.5",
										children: "How Many Comments Should Be Replies?"
									}), /* @__PURE__ */ jsxs("span", {
										className: "text-[11px] font-bold text-indigo-700 bg-indigo-100/90 px-2 py-0.5 rounded-md",
										children: [
											effectiveReplyCount,
											" ",
								...
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center justify-between text-[11px] text-indigo-900 bg-white/90 rounded-lg px-3 py-2 border border-indigo-200 font-medium shadow-xs",
									children: [
										/* @__PURE__ */ jsxs("span", { children: ["💬 Main Comments: ", /* @__PURE__ */ jsx("strong", {
											className: "text-indigo-950 font-bold",
											children: aiCount - effectiveReplyCount
										})] }),
										/* @__PURE__ */ jsxs("span", { children: ["↳ Nested Replies: ", /* @__PURE__ */ jsx("strong", {
											className: "text-indigo-950 font-bold",
											children: effectiveReplyCount
										})] }),
										/* @__PURE__ */ jsxs("span", { children: ["Total: ", /* @__PURE__ */ jsx("strong", {
											className: "text-indigo-950 font-bold",
											children: aiCount
										})] })
									]
					...
					/* @__PURE__ */ jsxs("div", { children: [
						...
						/* @__PURE__ */ jsx("p", {
							className: "mt-1 text-[11px] text-slate-500",
							children: aiLanguage === "random_mix" ? "Randomly distributes comments: one in Bengali script, one in Banglish, one in Indian English, and one code-mixed for total realism." : "Generates comments in this specific linguistic style."
						})
					] }),
					/* @__PURE__ */ jsxs("div", {
