import { m as loadSettings } from "./site-content-lo-rUml2.js";
import { a as useSiteSettings } from "./AdSettingsContext-BVHtqjX_.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BF8wccVN.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-CbpGi7zp.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-Dy1k5-lT.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-B52hypSL.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-C_7b8i1U.js").then((m) => ({ default: m.PopupAd })));
