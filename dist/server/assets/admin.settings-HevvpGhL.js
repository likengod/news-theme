import { A as saveSettings, _ as loadSettings } from "./site-content-DwDF0O3P.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-BJIYOCLZ.js";
import { t as Route } from "./admin.settings-Dn35BMTB.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-CT2NlykP.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-D5d18PPv.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-DJ3MV4ad.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BpyrvrVr.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-BDvOJ6u6.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-X2E2Pjdi.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-Bzzfp1EC.js").then((m) => ({ default: m.BackupRestoreTab })));
