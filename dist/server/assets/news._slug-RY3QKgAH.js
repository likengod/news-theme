import { g as loadSettings } from "./site-content-C7PDzOFw.js";
import { a as useSiteSettings } from "./AdSettingsContext-Caoc-BwM.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-BjFib2SV.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-t6MWuRzZ.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-nuZq1UaA.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-Bofq9q-n.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BjbFxZGs.js").then((m) => ({ default: m.PopupAd })));
