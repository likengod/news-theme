...
import { a as loadHomepageConfig, i as getHomepageConfigServer, r as defaultHomepageConfig, s as saveHomepageConfig, t as ALL_CATEGORY_OPTIONS } from "./homepage-config-B1KRaVKx.js";
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
					...
					children: "Turn off when you are not actively broadcasting live to streamline the homepage."
				})] }), /* @__PURE__ */ jsxs("label", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
					...
					className: "block text-[11px] text-slate-500",
					children: "Automatically start playing live video on page load (starts muted per browser rules)."
				})] }), /* @__PURE__ */ jsxs("label", {
					className: "relative inline-flex items-center cursor-pointer",
					children: [/* @__PURE__ */ jsx("input", {
						type: "checkbox",
			...
			/* @__PURE__ */ jsxs("div", {
				className: "rounded-md bg-emerald-50 p-2.5 text-xs text-emerald-800 border border-emerald-200 flex items-start gap-2",
				children: [/* @__PURE__ */ jsx("span", {
					className: "font-bold",
					children: "⚡ High Performance:"
				}), /* @__PURE__ */ jsxs("span", { children: [
					"Uses a modular click-to-play Lite Facade. YouTube's ~900KB scripts will ",
					/* @__PURE__ */ jsx("b", { children: "never" }),
					" slow down initial page loads or Google PageSpeed scores. The stream only loads when clicked."
				] })]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "grid gap-3 sm:grid-cols-2",
			...
			/* @__PURE__ */ jsxs("label", {
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						className: "mb-1 block text-[11px] font-medium text-slate-500",
						children: "Custom Poster / Thumbnail Image URL (Optional)"
					}),
					/* @__PURE__ */ jsx("input", {
						type: "url",
					...
					/* @__PURE__ */ jsx("span", {
						className: "mt-1 block text-[11px] text-slate-500",
						children: "Displayed as the preview poster before the user clicks to start playing."
					})
				]
			})
		]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					children: [/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), dirty ? "Save" : "Saved"]
					})]
				})]
			}),
			/* @__PURE__ */ jsx(Group, {
...
//# sourceMappingURL=admin.homepage-9LBQrnGF.js.map