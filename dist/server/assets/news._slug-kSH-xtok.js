import { _ as loadSettings } from "./site-content-BfCnwcrG.js";
import { a as useSiteSettings } from "./AdSettingsContext-D203MnIQ.js";
import { t as Views } from "./Views-MJGDQohZ.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-CR3nHoTb.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-Da01fKPT.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-hGqyhXZO.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-Dd-qo3KE.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-yQL2YE38.js").then((m) => ({ default: m.PopupAd })));
