import { T as saveSettings, p as loadSettings } from "./site-content-CVkCGhTi.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-CIfMgTB9.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-BqXQNKeh.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-DW_JcIW-.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-C-KPS7N3.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-BZFNVs-n.js"));
...
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-CoYWUMzB.js").then((m) => ({ default: m.BackupRestoreTab })));
