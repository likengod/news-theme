import { p as loadSettings } from "./site-content-BzPQwjRN.js";
import { a as useSiteSettings } from "./AdSettingsContext-CAAj3cJ2.js";
import { t as Views } from "./Views-DEuQ6JxS.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-CXCGdDcX.js";
import { a as trackRead, o as trackShare } from "./user-actions-tracker-DJQ5cFC2.js";
import { t as Footer } from "./Footer-i4Uyfy5T.js";
import { t as Header } from "./Header-GXmwmltV.js";
import { n as articleQueryOptions, t as Route } from "./news._slug-CRFKaQ4Q.js";
...
function ArticleHeader({ title, author, date, views, category = "News", deck }) {
	...
	const badgeText = showCustomText && settings.topBarWeatherCustomText ? settings.topBarWeatherCustomText : category;
...
var ArticleBody = memo(function ArticleBody({ paragraphs, midImage }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "prose-article space-y-4 md:space-y-5 text-[15px] md:text-lg leading-relaxed md:leading-[1.85] text-foreground/90",
		children: [
			first && /* @__PURE__ */ jsx("p", {
				className: "first-letter:float-left first-letter:mr-2 first-letter:font-serif first-letter:text-6xl first-letter:font-bold first-letter:leading-none",
				children: first
			}),
...
var RelatedNews = lazy(() => import("./RelatedNews-5ds1gbQ8.js").then((m) => ({ default: m.RelatedNews })));
var CommentsSection = lazy(() => import("./CommentsSection-CZkdYzgT.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-BcvDlW6p.js").then((n) => n.n));
var TRENDING = [
...
function ArticleQrCard({ url }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
			...
			style: scanMeStyle,
			children: showCustomText && settings.topBarWeatherCustomText ? settings.topBarWeatherCustomText : settings.festiveScanMeCustomText || "SCAN ME"
...
var PopupAd = lazy(() => import("./PopupAd-DkTpCyTg.js").then((m) => ({ default: m.PopupAd })));
