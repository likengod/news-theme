...
function CommentsSection({ articleSlug, articleTitle }) {
	...
	const commentFormFields = (isReply, n, setN, em, setEm, dr, setDr, sub, onSubmit, onCancel, replyToName) => isReply ? /* @__PURE__ */ jsxs("form", {
		onSubmit,
		className: "mt-2 ml-5 pl-3 border-l-2 border-primary/30",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex items-center gap-2 mb-1.5 text-xs text-muted-foreground",
			children: [
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Reply, { className: "h-3 w-3" }), /* @__PURE__ */ jsx("span", { children: isReplyingThis ? "Cancel" : "Reply" })]
								})
							}),
							replies.length > 0 && /* @__PURE__ */ jsx("ul", {
								className: "mt-2 ml-5 space-y-2 border-l-2 border-border/70 pl-3",
								children: replies.map((r) => /* @__PURE__ */ jsxs("li", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "mt-0.5 text-xs text-muted-foreground leading-relaxed whitespace-pre-line",
										children: r.body
									})]
								}, r.id))
							}),
...
//# sourceMappingURL=CommentsSection-bY5qVgx4.js.map