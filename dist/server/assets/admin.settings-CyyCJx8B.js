import { E as saveSettings, m as loadSettings } from "./site-content-DZR5pktS.js";
import { o as Toggle, t as Card } from "./SettingsHelpers-OyiB6UV8.js";
import { t as Route } from "./admin.settings-D5usrKrH.js";
...
var GeneralSettingsForm = lazy(() => import("./GeneralSettingsForm-DfBJS_qs.js").then((m) => ({ default: m.GeneralSettingsForm })));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-DNZx5Kut.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-CCPhmMDt.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-BMmlRr8W.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-CBwBp_g-.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-DCp3zVnK.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BLsVuk48.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-CAgCDzjQ.js").then((m) => ({ default: m.BackupRestoreTab })));
