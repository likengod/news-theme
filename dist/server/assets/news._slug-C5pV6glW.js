...
import { a as useSiteSettings } from "./AdSettingsContext-DKYmdDmE.js";
import { t as Views } from "./Views-DEuQ6JxS.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-DKAl7TSk.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-B8utA5Is.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-CG3mkpfR.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-RFOpuZFy.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-B05OBmFh.js").then((m) => ({ default: m.PopupAd })));
