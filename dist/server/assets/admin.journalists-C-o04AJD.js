...
import { i as listJournalists, n as deleteJournalist, s as upsertJournalist } from "./journalist.functions-BH9d_YjK.js";
import { n as MediaField } from "./MediaField-DxROsovg.js";
import { t as Field } from "./Field-DPKVWHIh.js";
import { o as roleBadgeClass, u as slugify } from "./roles-psIYcOWm.js";
import { a as rankForCount, o as saveRanks, r as loadRanks } from "./journalist-ranks-CfPnz7Nh.js";
import { n as loadAuthorized, r as saveAuthorized, t as DEFAULT_AUTHORIZED } from "./authorized-settings-C6PPe013.js";
import { d as toggleAdminUserBan } from "./admin-users.functions-Bn_pkJNw.js";
import { Suspense, lazy, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Award, Building2, ChevronLeft, ChevronRight, Coins, Copy, ExternalLink, Eye, Loader2, Newspaper, Pencil, Plus, Save, Search, ShieldCheck, Trash2 } from "lucide-react";
...
//#endregion
//#region src/components/admin/journalists/JournalistsListTab.tsx
var PAGE_SIZE = 20;
function JournalistsListTab({ journalists, ranks, isLoading, isError, errorMessage, openNew, openEdit, removeOne, handleToggleBan, setViewTarget }) {
	...
	const [sort, setSort] = useState(isEnterprisePlus ? "points_desc" : "articles_desc");
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("select", {
							...
							title: "Sort",
							children: [
								isEnterprisePlus && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("option", {
									value: "points_desc",
			...
			isLoading ? /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), " Loading journalists..."]
			}) : isError ? /* @__PURE__ */ jsx("div", {
				className: "px-5 py-16 text-center text-sm text-red-600",
				children: errorMessage ?? "Failed to load"
			}) : /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: /* @__PURE__ */ jsxs("tr", { children: [
							...
							isEnterprisePlus && /* @__PURE__ */ jsx("th", {
								className: "px-5 py-3",
								children: /* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1",
						...
						children: [pageRows.map(({ j, published, rankId }) => {
							...
							return /* @__PURE__ */ jsxs("tr", {
								...
								children: [
									...
									isEnterprisePlus && /* @__PURE__ */ jsxs("td", {
							...
							children: journalists.length === 0 ? "No journalists yet. Assign the Journalist role to a user under Admin → Users." : "No results match your search."
						}) })]
					})]
				})
			}),
...
//#endregion
//#region src/components/admin/journalists/RanksTab.tsx
function RanksTab({ ranks, setEditing, setIsNew, onDelete, emptyRank }) {
	return /* @__PURE__ */ jsxs("section", {
		className: "overflow-hidden rounded-lg border border-slate-200 bg-white",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex items-center justify-between border-b border-slate-200 px-5 py-3",
...
var JournalistFormModal = lazy(() => import("./JournalistFormModal-DK5_wIJq.js").then((m) => ({ default: m.JournalistFormModal })));
var JournalistProfileModal = lazy(() => import("./JournalistProfileModal-D8YN1phg.js").then((m) => ({ default: m.JournalistProfileModal })));
var RankEditModal = lazy(() => import("./RankEditModal-DzkCACCH.js").then((m) => ({ default: m.RankEditModal })));
function emptyRank() {
	return {
		id: "",
		name: "",
...
function JournalistsPage() {
	...
	const submitForm = async () => {
		...
		try {
			await upsert({ data: {
				...
				husbandName: form.gender === "Female" && form.maritalStatus === "Married" ? form.husbandName.trim() : void 0,
				documentType: form.documentType || void 0,
				documentUrl: form.documentUrl || void 0,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h1", {
					...
					children: [/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Copy, { className: "h-3.5 w-3.5 text-slate-500" }), /* @__PURE__ */ jsx("span", { children: "Copy Public Form Link" })]
					}), /* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsx("span", { children: "Open Form" }), /* @__PURE__ */ jsx(ExternalLink, { className: "h-3.5 w-3.5" })]
					})]
				})]
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					return /* @__PURE__ */ jsxs("button", {
						onClick: () => setTab(t.id),
						className: `inline-flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition ${effectiveTab === t.id ? "bg-slate-900 text-white shadow" : "text-slate-600 hover:bg-slate-100"}`,
						children: [
			...
			effectiveTab === "journalists" && /* @__PURE__ */ jsx(JournalistsListTab, {
				journalists,
				ranks,
			...
			effectiveTab === "ranks" && isEnterprisePlus && /* @__PURE__ */ jsx(RanksTab, {
				ranks,
				setEditing,
				setIsNew,
				onDelete,
			...
			effectiveTab === "authorized" && /* @__PURE__ */ jsx(AuthorizedPanel, {
				value: authorized,
...
//# sourceMappingURL=admin.journalists-C-o04AJD.js.map