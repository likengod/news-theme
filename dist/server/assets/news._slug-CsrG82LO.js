import { _ as loadSettings } from "./site-content-DwDF0O3P.js";
import { a as useSiteSettings } from "./AdSettingsContext-CM0pC1d_.js";
import { t as Views } from "./Views-DJ1173PA.js";
import { i as getCurrentUserRole, t as authClient } from "./auth-client-C06SBZwq.js";
...
import { n as articleQueryOptions, t as Route } from "./news._slug-DRSkPjwp.js";
...
var CommentsSection = lazy(() => import("./CommentsSection-LUWGOJbq.js").then((m) => ({ default: m.CommentsSection })));
var DEFAULT_TAGS = [
	"Breaking",
	"Northeast",
	"Report",
...
var Advertisement = lazy(() => import("./Advertisement-Da8gy5zI.js").then((n) => n.n));
var TRENDING = [
...
var PopupAd = lazy(() => import("./PopupAd-BqXYmwf4.js").then((m) => ({ default: m.PopupAd })));
