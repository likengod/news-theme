import { a as saveSettings, i as loadSettings, t as cleanCopyright } from "./site-settings-J3w4WW_b.js";
import { a as useSiteSettings } from "./AdSettingsContext-DJiAqdeY.js";
import { a as LogoUploader } from "./SettingsHelpers-DKcjacb1.js";
import { t as Route } from "./admin.settings-CPpD_IPe.js";
...
var SeoSettingsTab = lazy(() => import("./SeoSettingsTab-Cn6brUs3.js"));
var ProtectionSettingsForm = lazy(() => import("./ProtectionSettingsForm-CYUXpMRK.js").then((m) => ({ default: m.ProtectionSettingsForm })));
var FestiveSettingsForm = lazy(() => import("./FestiveSettingsForm-BFYIdeGW.js").then((m) => ({ default: m.FestiveSettingsForm })));
var FontSettingsTab = lazy(() => import("./FontSettingsTab-DN9Vf21Y.js").then((m) => ({ default: m.FontSettingsTab })));
var RedirectsAndLinksTab = lazy(() => import("./RedirectsAndLinksTab-DJAlXpCd.js"));
var IntegrationsTab = lazy(() => import("./IntegrationsTab-C8JC2jW8.js").then((m) => ({ default: m.IntegrationsTab })));
var ActivateWebsiteTab = lazy(() => import("./ActivateWebsiteTab-BCytC9La.js").then((m) => ({ default: m.ActivateWebsiteTab })));
var BackupRestoreTab = lazy(() => import("./BackupRestoreTab-DxB46WiU.js").then((m) => ({ default: m.BackupRestoreTab })));
var SpeedOptimizationTab = lazy(() => import("./SpeedOptimizationTab-WR4Tl_-9.js").then((m) => ({ default: m.SpeedOptimizationTab })));
...
//# sourceMappingURL=admin.settings-1p57rS1o.js.map